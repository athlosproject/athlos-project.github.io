...
list.of.packages <- c("knitr", "haven", "sjmisc", "bitops", "RCurl", "rjson", "mime", "opalr", "tibble", "car", "labelled", "Hmisc", "scales", "dplyr", "lubridate", "stringi", "gridExtra", "pander", "tidyr", "stringr", "purrr")
