...
| **Table name** | `Demographic_Background_wave2` | `charls_w2_hd`\*|`charls_w2_hd`\*|`Weights_modif_albert_wave2`|`Weights_modif_albert_wave2`|
| **Description** |  |  |  |  |  |
...
opal.assign.table.tibble(o, 'CHARLS_w2_birth2','CHARLS_HD.charls_w2_hd', variables=list('mbirth','ybirth'), missings = TRUE)
