...
| **Name** | `age` |`da001`|`da002`|`da003`|`da004`|`da005_*_, *=1,...,5`|`da007_*_, *=1,...,14`|`da008_*_, *=1,5,11`|`db002`|`db003`|
|-|-|-|-|-|-|-|-|-|-|-|
| **Label** |`age`|`Self Comment of Your Health`|`Self Comment of Your Health`|`Pain on the Left Side of Your Chest`|`Chest Pains When Climbing Stairs/Uphill or Walking Quickly`|`Do you have one of the following disabilities?: Physical Disabilities; Brain Damage/Mental Retardation; Vision Problem; Hearing Problem; Speech Impediment`|`Have you been diagnosed by a doctor with: Hypertension; Dyslipidemia; Diabetes or High Blood Sugar; Cancer or Malignant Tumor; Chronic Lung Diseases; Liver Disease; Heart Problems; Stroke; Kidney Disease; Stomach or Other Digestive Disease; Emotional, Nervous, or Psychiatric Problems; Memory-Related Disease; Arthritis or Rheumatism; Asthma?`|`Do you know if you have: Hypertension; Chronic Lung Diseases; Emotional, Nervous,or Psychiatric Problems?`|`Have Difficulty Walking 1 KM`|`Have Difficulty Walking 100 metres`|
| **Table name** |`age`|`health_status_and_functioning_wave1`|`health_status_and_functioning_wave1`|`health_status_and_functioning_wave1`|`health_status_and_functioning_wave1`|`health_status_and_functioning_wave1`|`health_status_and_functioning_wave1`|`health_status_and_functioning_wave1`|`health_status_and_functioning_wave1`|`health_status_and_functioning_wave1`|
| **Categories** | `continuous` |`1 Excellent` <br/>`2 Very good` <br/>`3 Good` <br/>`4 Fair` <br/>`5 Poor`|`1 Very good` <br/>`2 Good` <br/>`3 Fair` <br/>`4 Poor` <br/>`5 Very poor`|`1 Yes` <br/>`2 No`|`1 Yes` <br/>`2 No`|`1 Yes` <br/>`2 No`|`1 Yes` <br/>`2 No`|`1 Yes` <br/>`2 No`|`1 = No, I don't have any difficulty` <br/>`2 = I have difficulty but can still do it` <br/>`3 = Yes, I have difficulty and need help` <br/>`4 = I can not do it` |`1 = No, I don't have any difficulty` <br/>`2 = I have difficulty but can still do it` <br/>`3 = Yes, I have difficulty and need help` <br/>`4 = I can not do it` |
| **Missings** |`999 Missing`|`NA`|`NA`|`NA`|`3 Not applicable; NA`|`NA`|`NA`|`3 Don't know; NA`|`NA`|`NA`|
| **Description** |  |  |  |  |  |  |  |  |  |  |
...
kable(Categorical_summary(vari, missing_values = miss_values_vector)[3], caption = "Mobility - Walking")
...
|-|-|-|-|-|-|-|-|-|-|-|
| **Label** |`age`|`Self Comment of Your Health`|`Self Comment of Your Health`|`Pain on the Left Side of Your Chest`|`Chest Pains When Climbing Stairs/Uphill or Walking Quickly`|`Do you have one of the following disabilities?: Physical Disabilities; Brain Damage/Mental Retardation; Vision Problem; Hearing Problem; Speech Impediment`|`Have you been diagnosed by a doctor with: Hypertension; Dyslipidemia; Diabetes or High Blood Sugar; Cancer or Malignant Tumor; Chronic Lung Diseases; Liver Disease; Heart Problems; Stroke; Kidney Disease; Stomach or Other Digestive Disease; Emotional, Nervous, or Psychiatric Problems; Memory-Related Disease; Arthritis or Rheumatism; Asthma?`|`Do you know if you have: Hypertension; Chronic Lung Diseases; Emotional, Nervous,or Psychiatric Problems?`|`Have Difficulty Walking 1 KM`|`Have Difficulty Walking 100 metres`|
| **Table name** |`age`|`health_status_and_functioning_wave2`|`health_status_and_functioning_wave2`|`health_status_and_functioning_wave2`|`health_status_and_functioning_wave2`|`health_status_and_functioning_wave2`|`health_status_and_functioning_wave2`|`health_status_and_functioning_wave2`|`health_status_and_functioning_wave2`|`health_status_and_functioning_wave2`|
| **Categories** | `continuous` |`1 Excellent` <br/>`2 Very good` <br/>`3 Good` <br/>`4 Fair` <br/>`5 Poor`|`1 Very good` <br/>`2 Good` <br/>`3 Fair` <br/>`4 Poor` <br/>`5 Very poor`|`1 Yes` <br/>`2 No`|`1 Yes` <br/>`2 No`|`1 Yes` <br/>`2 No`|`1 Yes` <br/>`2 No`|`1 Yes` <br/>`2 No`|`1 = No, I don't have any difficulty` <br/>`2 = I have difficulty but can still do it` <br/>`3 = Yes, I have difficulty and need help` <br/>`4 = I can not do it` |`1 = No, I don't have any difficulty` <br/>`2 = I have difficulty but can still do it` <br/>`3 = Yes, I have difficulty and need help` <br/>`4 = I can not do it` |
| **Missings** |`999 Missing`|`NA`|`NA`|`NA`|`3 Not applicable; NA`|`NA`|`NA`|`3 Don't know; NA`|`NA`|`NA`|
| **Description** |  |  |  |  |  |  |  |  |  |  |
...
* Regarding high amount of missing values in the above variables: Cases in which "Respondent is younger than 50 (year of birth is after 1960) and If (DA001 =1 or 2 or DA002 =1 or 2) and DA003 =2 and DA004 =2 and DA005 =2. and DA007 =2 and DA008 =2 skip DB001 –DB015" should not be coded as "missing" but as 1: "no difficulties" (because of a skip in the questionnaire which does not ask functioning questions to healthy and young respondents".	
