...
CHARLS_ds_w1$n_vig_pa <- car::recode(CHARLS_w1$da052_1_*2, "NA = 999 ")
CHARLS_ds_w1$n_vig_pa[which(CHARLS_w1$vig_pa == 0)] <- 0
```

#### Statistical description of the new harmonised variable
```{r descript w1, echo=F}

vbl <- CHARLS_ds_w1$n_vig_pa
kable(Continuous_summary(var = vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(CHARLS_ds_w1, aes(n_vig_pa)) + geom_histogram(stat="count", fill="steelblue", data = .%>% filter(!vbl %in% miss_values_vector)) + xlab(ds_label) + ylab("Frequency")
```
...
CHARLS_ds_w2$n_vig_pa <- car::recode(CHARLS_w2$da052_1_*2, "NA = 999 ")
CHARLS_ds_w2$n_vig_pa[which(CHARLS_w2$vig_pa == 0)] <- 0
...
vbl <- CHARLS_ds_w2$n_vig_pa
kable(Continuous_summary(var = vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(CHARLS_ds_w2, aes(n_vig_pa)) + geom_histogram(stat="count", fill="steelblue", data = .%>% filter(!vbl %in% miss_values_vector)) + xlab(ds_label) + ylab("Frequency")
