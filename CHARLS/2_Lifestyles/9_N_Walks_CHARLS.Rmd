...
| **Name** | `da052_3_` |
|-|-|
| **Label** | `Days Walking At Least 10 Minutes Continuously (question was asked per usual week)` |
...
```{r assign w1, echo=F}
opal.assign.table.tibble(o, 'CHARLS_w1_2','CHARLS.health_status_and_functioning_wave1', variables=list('da052_3_'), missings = TRUE)
...
Add_indiv <- function(old, new){
  ...
  new_22 <- data.frame(id=new_2[,1], oldid=as.numeric(new_2[,3]), da052_3_=as.numeric(new_2[,2]))
  new_22
}
...
```{r local w1, echo=F}
vbl <- CHARLS_w1$da052_3_
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = "da052_3_") 
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
ggplot(CHARLS_w1, aes(da052_3_)) + geom_histogram(stat="count", fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")
```
...
CHARLS_ds_w1$n_walks <- car::recode(CHARLS_w1$da052_3_*4, "NA = 999 ")
```

#### Statistical description of the new harmonised variable
```{r descript w1, echo=F}
vbl <- CHARLS_ds_w1$n_walks
...
ggplot(CHARLS_ds_w1, aes(n_walks)) + geom_histogram(stat="count", fill="steelblue", data = .%>% filter(!vbl %in% miss_values_vector)) + xlab(ds_label) + ylab("Frequency")
```
...
| **Name** | `da052_3_` |
|-|-|
| **Label** | `Days Walking At Least 10 Minutes Continuously` |
...
```{r assign w2, echo=F}
opal.assign.table.tibble(o, 'CHARLS_w2_2','CHARLS.Health_Status_and_Functioning_wave2', variables=list('da052_3_'), missings = TRUE)
...
Add_indiv <- function(old, new){
  ...
  new_22 <- data.frame(id=new_2[,1], da052_3_=as.numeric(new_2[,2]))
  new_22
}
...
```{r local w2, echo=F}
vbl <- CHARLS_w2$da052_3_
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = "da052_3_") 
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
ggplot(CHARLS_w2, aes(da052_3_)) + geom_histogram(stat="count", fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")
```
...
CHARLS_ds_w2$n_walks <- car::recode(CHARLS_w2$da052_3_*4, "NA = 999 ")
```

#### Statistical description of the new harmonised variable
```{r descript w2, echo=F}
vbl <- CHARLS_ds_w2$n_walks
kable(Continuous_summary(var = vbl, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[3], caption = ds_label)
kable(Continuous_summary(vbl, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))$summary, caption = "Summary")
ggplot(CHARLS_ds_w2, aes(n_walks)) + geom_histogram(stat="count", fill="steelblue", data = .%>% filter(!vbl %in% miss_values_vector)) + xlab(ds_label) + ylab("Frequency")
```
