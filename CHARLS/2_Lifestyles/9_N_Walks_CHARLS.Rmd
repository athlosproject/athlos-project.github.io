...
ggplot(CHARLS_w1, aes(da052_3_)) + geom_histogram(stat="count", fill="steelblue") + xlab(label(vbl)) + ylab("Frequency") + xlim(0,7.5)
```
...
ggplot(CHARLS_ds_w1, aes(n_walks)) + geom_histogram(stat="count", fill="steelblue") + xlab(ds_label) + ylab("Frequency") + xlim(0,30) 
```
...
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = label(vbl)) 
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
ggplot(CHARLS_w2, aes(da052_3_)) + geom_histogram(stat="count", fill="steelblue") + xlab(label(vbl)) + ylab("Frequency") + xlim(0,7.5)
```
...
kable(Continuous_summary(vbl, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))$summary, caption = "Summary")
ggplot(CHARLS_ds_w2, aes(n_walks)) + geom_histogram(stat="count", fill="steelblue") + xlab(ds_label) + ylab("Frequency") + xlim(0,30)
```
