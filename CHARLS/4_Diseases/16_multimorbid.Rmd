...
| **Name** |`h_diabetes`|`h_asthma`|`h_hypertension`|`h_joint_disorders`|`h_cpd`| `cvd_all`|
|-|-|-|-|-|-|-|
| **Label** |`History of diabetes mellitus`|`History of asthma`|`History of hypertension`|`History of arthritis, rheumatism or osteoarthritis`|`History of chronic pulmonary disorders`| `History of all Cardiovascular diseases`|
| **Table name**  |`charls_w1_hd`|`charls_w1_hd`|`charls_w1_hd`|`charls_w1_hd`|`charls_w1_hd`| `charls_w1_hd` |
...
opal.assign.table.tibble(o, 'charls_w1','CHARLS_HD.charls_w1_hd',variables=list('h_diabetes','h_hypertension','h_asthma','h_joint_disorders','h_cpd','cvd_all'), missings = T)
...
CHARLS_ds_w1 <- charls_w1 %>% 
  mutate(dead = purrr::pmap(mutate_at(., vars(-id), `==`, 996) %>% select(., -id), all) %>% unlist()) %>%
  mutate_at(names(charls_w1[,-1]), ~replace(., list = which(. %in% 991:999), values = NA))
CHARLS_ds_w1 <- CHARLS_ds_w1 %>% 
...
vbl <- CHARLS_ds_w1$multimorbid
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(CHARLS_ds_w1, aes(x=factor(vbl))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
...
|-|-|-|-|-|-|-|
| **Label** |`History of diabetes mellitus`|`History of asthma`|`History of hypertension`|`History of arthritis, rheumatism or osteoarthritis`|`History of chronic pulmonary disorders`| `History of all Cardiovascular diseases`|
| **Table name**  |`charls_w2_hd`|`charls_w2_hd`|`charls_w2_hd`|`charls_w2_hd`|`charls_w2_hd`| `charls_w2_hd` |
| **Categories** |`0 = No`<br/>`1 = Yes`|`0 = No`<br/>`1 = Yes`|`0 = No`<br/>`1 = Yes`|`0 = No`<br/>`1 = Yes`|`0 = No`<br/>`1 = Yes`| `0 = No`<br/>`1 = Yes` |
| **Missings** |`999 = Missing` |`999 = Missing` |`999 = Missing` |`999 = Missing` |`999 = Missing` |`999 = Missing` |
| **Description** |  |  |  |  |  |  |
...
opal.assign.table.tibble(o, 'charls_w2','CHARLS_HD.charls_w2_hd',variables=list('h_diabetes','h_hypertension','h_asthma','h_joint_disorders','h_cpd','cvd_all'), missings = T)
...
vbl <- charls_w2$h_hypertension
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = "h_hypertension")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
ggplot(charls_w2, aes(x=factor(vbl))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")

vbl <- charls_w2$h_joint_disorders
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = "h_joint_disorders")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
ggplot(charls_w2, aes(x=factor(vbl))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")

vbl <- charls_w2$cvd_all
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = "cvd_all")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
ggplot(charls_w2, aes(x=factor(vbl))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")
...
CHARLS_ds_w2 <- charls_w2 %>% 
  mutate(dead = purrr::pmap(mutate_at(., vars(-id), `==`, 996) %>% select(., -id), all) %>% unlist()) %>%
  mutate_at(names(charls_w2[,-1]), ~replace(., list = which(. %in% 991:999), values = NA))
CHARLS_ds_w2 <- CHARLS_ds_w2 %>% 
  mutate(multimorbid_score = rowSums(select(., -1, -dead), na.rm = T)) %>%
  mutate(cardNA = rowSums(!is.na(select(., -1, -dead, -multimorbid_score)))) %>%
  mutate(cardNA = cardNA/cardNA) %>%
  mutate(multimorbid_score = multimorbid_score * cardNA) %>%
...
vbl <- CHARLS_ds_w2$multimorbid
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(CHARLS_ds_w2, aes(x=factor(vbl))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
