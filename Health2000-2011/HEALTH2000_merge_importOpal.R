...
setwd("M:/WPs/WP1/Maelstrom/data_process/athlos-project.github.io/Health2000-2011")
# Load some useful packages and Opal session
source("../setup.r")

# Load data base with 'athlos_id' and 'athlos_id2' for id's in current study
load("M:/WPs/WP1/Maelstrom/data_process/ATHLOS_cohort/ids2/ids_athlos_ds_HEALTH2000.Rdata")
...
for (i in 1:length(lhd)) {
  ...
  ds <- left_join(ds, ids_athlos_ds_HEALTH2000, by = 'id')
  ...
  opal.symbol_import(o, lhd[[i]], project='Health2000-2011_HD')
  
  # Remove all objects but the listed in the vector.
  rm(list=setdiff(ls(), c("o","lf", "lhd", "integ.var", "text.var", "i","ids_athlos_ds_HEALTH2000","hs") )) 
}
