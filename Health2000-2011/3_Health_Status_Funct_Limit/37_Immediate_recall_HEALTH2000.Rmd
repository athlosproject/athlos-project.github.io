...
| **Name** | `TOKY_3OIKEIN1`|
|-|-|
| **Label** | `Wordlist learning sum, 1st attempt`|
...
opal.assign.table.tibble(o, 'HEALTH2000_w1','Health2000-2011.t00_athlos_2017_02_23', variables=list('TOKY_3OIKEIN1'), missings = TRUE)
...
vbl <- HEALTH2000_w1$TOKY_3OIKEIN1
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = "TOKY_3OIKEIN1")
...
Health20002011_ds_w1$cog_imm_c <- car::recode(HEALTH2000_w1$TOKY_3OIKEIN1, "NA = 999")

##cog_imm
Q <- quantile(car::recode(Health20002011_ds_w1$cog_imm_c, "999=NA"), probs = 1/4, na.rm = TRUE, names = FALSE)

Health20002011_ds_w1$cog_imm <- car::recode(Health20002011_ds_w1[[2]], "0:Q=0; (Q+1):10=1")
...
vbl <- Health20002011_ds_w1$cog_imm_c
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label_cog_imm_c)
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(Health20002011_ds_w1 %>% filter(!vbl %in% miss_values_vector), aes(x=cog_imm_c)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")

vbl <- Health20002011_ds_w1$cog_imm
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label_cog_imm)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(Health20002011_ds_w1, aes(x=factor(cog_imm))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
...
opal.assign.table.tibble(o, 'HEALTH2000_w2','Health2000-2011.t11_athlos_2017_02_27', variables=list('TOKY_3OIKEIN1'), missings = TRUE)
...
vbl <- HEALTH2000_w2$TOKY_3OIKEIN1
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = "TOKY_3OIKEIN1")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
...
Health20002011_ds_w2$cog_imm_c <- car::recode(HEALTH2000_w2$TOKY_3OIKEIN1, "NA = 999")

##cog_imm
Q <- quantile(car::recode(Health20002011_ds_w2$cog_imm_c, "999=NA"), probs = 1/4, na.rm = TRUE, names = FALSE)

Health20002011_ds_w2$cog_imm <- car::recode(Health20002011_ds_w2[[2]], "0:Q=0; (Q+1):10=1")
...
vbl <- Health20002011_ds_w2$cog_imm_c
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label_cog_imm_c)
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(Health20002011_ds_w2 %>% filter(!vbl %in% miss_values_vector), aes(x=cog_imm_c)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")

vbl <- Health20002011_ds_w2$cog_imm
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label_cog_imm)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(Health20002011_ds_w2, aes(x=factor(cog_imm))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
