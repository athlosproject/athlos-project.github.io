...
| **Missings** | `997 = Refuse`<br/>`998 = Do not know`<br/>`999 = Missing` |
| **Description** |  |
...
SHARE_ds_w1$cd_all <- SHARE_w1$mi_ha
...
vbl <- SHARE_ds_w1$cd_all
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(SHARE_ds_w1, aes(x=factor(cd_all))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
...
AfterH <- table(SHARE_ds_w1$cd_all)
BeforeH <- table(SHARE_w1$mi_ha, useNA = "ifany")
...
SHARE_ds_w2$cd_all <- SHARE_w2$mi_ha
...
vbl <- SHARE_ds_w2$cd_all
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(SHARE_ds_w2, aes(x=factor(cd_all))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
...
AfterH <- table(SHARE_ds_w2$cd_all)
BeforeH <- table(SHARE_w2$mi_ha, useNA = "ifany")
C <- rbind(BeforeH,AfterH)
kable(C)
...
SHARE_ds_w4$cd_all <- SHARE_w4$mi_ha
...
vbl <- SHARE_ds_w4$cd_all
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(SHARE_ds_w4, aes(x=factor(cd_all))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
...
AfterH <- table(SHARE_ds_w4$cd_all)
BeforeH <- table(SHARE_w4$mi_ha, useNA = "ifany")
C <- rbind(BeforeH,AfterH)
kable(C)
...
SHARE_ds_w5$cd_all <- SHARE_w5$mi_ha
...
vbl <- SHARE_ds_w5$cd_all
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(SHARE_ds_w5, aes(x=factor(cd_all))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
...
AfterH <- table(SHARE_ds_w5$cd_all)
BeforeH <- table(SHARE_w5$mi_ha, useNA = "ifany")
C <- rbind(BeforeH,AfterH)
kable(C)
...
dbb <- merge(SHARE_m_ds_w1[,c("id","cd_all")], SHARE_m_ds_w2[,c("id","cd_all")], by="id", suffixes = c(".w1",".w2"), all=T)
dbb <- merge(dbb,SHARE_m_ds_w4[,c("id","cd_all")], by="id", all=T)
dbb <- merge(dbb, SHARE_m_ds_w5[,c("id","cd_all")], by="id", suffixes = c(".w4",".w5"), all=T)
...
It is based on the harmonized myocardial infarction variable
