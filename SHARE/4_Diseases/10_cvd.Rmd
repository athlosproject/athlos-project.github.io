...
dbb <- merge(SHARE_m_ds_w1[,c("id","cvd")], SHARE_m_ds_w2[,c("id","cvd")], by="id", suffixes = c(".w1",".w2"), all=T)
dbb <- merge(dbb,SHARE_m_ds_w4[,c("id","cvd")], by="id", all=T)
dbb <- merge(dbb, SHARE_m_ds_w5[,c("id","cvd")], by="id", suffixes = c(".w4",".w5"), all=T)
