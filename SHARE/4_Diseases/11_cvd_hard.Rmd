...
SHARE_ds_w1$cvd_hard <- rep(999,length(SHARE_w1$id))
SHARE_ds_w1$cvd_hard[which(SHARE_w1$mi_ha==998 | SHARE_w1$stroke==998)] <- 998
SHARE_ds_w1$cvd_hard[which(SHARE_w1$mi_ha==997 | SHARE_w1$stroke==997)] <- 997
SHARE_ds_w1$cvd_hard[which(SHARE_w1$mi_ha==0 & SHARE_w1$stroke==0)] <- 0
SHARE_ds_w1$cvd_hard[which(SHARE_w1$mi_ha==1 | SHARE_w1$stroke==1)] <- 1
...
vbl <- SHARE_ds_w1$cvd_hard
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(SHARE_ds_w1, aes(x=factor(cvd_hard))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
...
AfterH <- table(SHARE_ds_w1$cvd_hard)
X <- c(
...
SHARE_ds_w2$cvd_hard <- rep(999,length(SHARE_w2$id))
SHARE_ds_w2$cvd_hard[which(SHARE_w2$mi_ha==998 | SHARE_w2$stroke==998)] <- 998
SHARE_ds_w2$cvd_hard[which(SHARE_w2$mi_ha==997 | SHARE_w2$stroke==997)] <- 997
SHARE_ds_w2$cvd_hard[which(SHARE_w2$mi_ha==0 & SHARE_w2$stroke==0)] <- 0
SHARE_ds_w2$cvd_hard[which(SHARE_w2$mi_ha==1 | SHARE_w2$stroke==1)] <- 1
...
vbl <- SHARE_ds_w2$cvd_hard
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(SHARE_ds_w2, aes(x=factor(cvd_hard))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
...
AfterH <- table(SHARE_ds_w2$cvd_hard)
X <- c(
...
SHARE_ds_w4$cvd_hard <- rep(999,length(SHARE_w4$id))
SHARE_ds_w4$cvd_hard[which(SHARE_w4$mi_ha==998 | SHARE_w4$stroke==998)] <- 998
SHARE_ds_w4$cvd_hard[which(SHARE_w4$mi_ha==997 | SHARE_w4$stroke==997)] <- 997
SHARE_ds_w4$cvd_hard[which(SHARE_w4$mi_ha==0 & SHARE_w4$stroke==0)] <- 0
SHARE_ds_w4$cvd_hard[which(SHARE_w4$mi_ha==1 | SHARE_w4$stroke==1)] <- 1
...
vbl <- SHARE_ds_w4$cvd_hard
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(SHARE_ds_w4, aes(x=factor(cvd_hard))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
...
AfterH <- table(SHARE_ds_w4$cvd_hard)
X <- c(
...
SHARE_ds_w5$cvd_hard <- rep(999,length(SHARE_w5$id))
SHARE_ds_w5$cvd_hard[which(SHARE_w5$mi_ha==998 | SHARE_w5$stroke==998)] <- 998
SHARE_ds_w5$cvd_hard[which(SHARE_w5$mi_ha==997 | SHARE_w5$stroke==997)] <- 997
SHARE_ds_w5$cvd_hard[which(SHARE_w5$mi_ha==0 & SHARE_w5$stroke==0)] <- 0
SHARE_ds_w5$cvd_hard[which(SHARE_w5$mi_ha==1 | SHARE_w5$stroke==1)] <- 1
...
vbl <- SHARE_ds_w5$cvd_hard
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(SHARE_ds_w5, aes(x=factor(cvd_hard))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
...
AfterH <- table(SHARE_ds_w5$cvd_hard)
X <- c(
...
dbb <- merge(SHARE_m_ds_w1[,c("id","cvd_hard")], SHARE_m_ds_w2[,c("id","cvd_hard")], by="id", suffixes = c(".w1",".w2"), all=T)
dbb <- merge(dbb,SHARE_m_ds_w4[,c("id","cvd_hard")], by="id", all=T)
dbb <- merge(dbb, SHARE_m_ds_w5[,c("id","cvd_hard")], by="id", suffixes = c(".w4",".w5"), all=T)
...
It contains information from the myocardia infarction and stroke harmonized variables
