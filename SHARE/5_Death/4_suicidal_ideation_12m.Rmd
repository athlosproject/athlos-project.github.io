...
SHARE_ds_w1$suicidal_ideation_12m <- car::recode(SHARE_si_lm[[2]], "2=0; -2=997; -1=998; NA=999")
```
...
ggplot(SHARE_ds_w1, aes(x=factor(suicidal_ideation_12m))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
```

#### Validation

```{r importOPAL1, echo=FALSE}
suicidal_ideation_12m <- SHARE_ds_w1
save(suicidal_ideation_12m, file = "../RData/w1/suicidal_ideation_12m.RData")
```
...
SHARE_ds_w2$suicidal_ideation_12m <- car::recode(SHARE_si_lm[[2]], "2=0; -2=997; -1=998; NA=999")
```
...
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[1], caption = "Category")
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[2], caption = "Type of missing")
ggplot(SHARE_ds_w2, aes(x=factor(suicidal_ideation_12m))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
```

#### Validation

```{r importOPAL2, echo=FALSE}
suicidal_ideation_12m <- SHARE_ds_w2
save(suicidal_ideation_12m, file = "../RData/w2/suicidal_ideation_12m.RData")
```
...
SHARE_ds_w4$suicidal_ideation_12m <- car::recode(SHARE_si_lm[[2]], "2=0; -2=997; -1=998; NA=999")
```
...
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[1], caption = "Category")
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[2], caption = "Type of missing")
ggplot(SHARE_ds_w4, aes(x=factor(suicidal_ideation_12m))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
```
...
suicidal_ideation_12m <- SHARE_ds_w4
save(suicidal_ideation_12m, file = "../RData/w4/suicidal_ideation_12m.RData")
```
...
SHARE_ds_w5$suicidal_ideation_12m <- car::recode(SHARE_si_lm[[2]], "5=0; -2=997; -1=998; NA=999")
```
...
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[1], caption = "Category")
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[2], caption = "Type of missing")
ggplot(SHARE_ds_w5, aes(x=factor(suicidal_ideation_12m))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
```

#### Validation

```{r importOPAL5, echo=FALSE}
suicidal_ideation_12m <- SHARE_ds_w5
save(suicidal_ideation_12m, file = "../RData/w5/suicidal_ideation_12m.RData")
```
