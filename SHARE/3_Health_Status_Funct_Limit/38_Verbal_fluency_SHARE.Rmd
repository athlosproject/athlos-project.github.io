...
| **Measure** |`Continuous Variable 0-88`|
...
vbl_miss <- c(-1,-2)
kable(Continuous_summary(var = vari, missing_values = c(-1,-2))[3], caption = attr(vari,"spss::shortName"))
...
ggplot(SHARE_w1_cog_verb %>% filter(!vari %in% vbl_miss), aes(x=cf010_)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(label(vari)) + ylab("Frequency")
```
...
ggplot(SHARE_ds_w1 %>% filter(!vari %in% miss_values_vector), aes(cog_verb_c)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
...
ggplot(SHARE_ds_w1, aes(x=factor(cog_verb))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
```

#### Validation
```{r crosstabulation w1, echo=FALSE}
Continuous <- c(sum(na.omit(SHARE_ds_w1[[2]])<=Q), sum(na.omit(SHARE_ds_w1[[2]])>Q & na.omit(SHARE_ds_w1[[2]])<900), sum(na.omit(SHARE_ds_w1[[2]])==997), sum(na.omit(SHARE_ds_w1[[2]])==998), sum(na.omit(SHARE_ds_w1[[2]])==999))
...
| **Measure** |`Continuous Variable 0-100`|
| **Missings** |`-1 = Don't know; -2 = Refusal; NA`|
| **Description** |  |
...
kable(Continuous_summary(vari, missing_values = c(-1,-2))[2], caption = "Values")
pander(Continuous_summary(vari, missing_values = c(-1,-2))$summary, caption = "Summary")
ggplot(SHARE_w2_cog_verb %>% filter(!vari %in% vbl_miss), aes(x=(cf010_))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(label(vari)) + ylab("Frequency")
```
...
kable(Continuous_summary(vari, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vari, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(SHARE_ds_w2 %>% filter(!vari %in% miss_values_vector), aes(cog_verb_c)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")

vari <- SHARE_ds_w2$cog_verb
kable(Categorical_summary(vari, missing_values = miss_values_vector)[3], caption = ds_label_cog_verb) 
kable(Categorical_summary(vari, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vari, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(SHARE_ds_w2, aes(x=factor(cog_verb))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
```

#### Validation
```{r crosstabulation w2, echo=FALSE}
Continuous <- c(sum(na.omit(SHARE_ds_w2[[2]])<=Q), sum(na.omit(SHARE_ds_w2[[2]])>Q & na.omit(SHARE_ds_w2[[2]])<900), sum(na.omit(SHARE_ds_w2[[2]])==997), sum(na.omit(SHARE_ds_w2[[2]])==998), sum(na.omit(SHARE_ds_w2[[2]])==999))
...
kable(Continuous_summary(vari, missing_values = c(-1,-2))[2], caption = "Values")
pander(Continuous_summary(vari, missing_values = c(-1,-2))$summary, caption = "Summary")
ggplot(SHARE_w4_cog_verb %>% filter(!vari %in% vbl_miss), aes(x=cf010_)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(label(vari)) + ylab("Frequency")
```
...
kable(Continuous_summary(vari, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vari, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(SHARE_ds_w4 %>% filter(!vari %in% miss_values_vector), aes(cog_verb_c)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")

vari <- SHARE_ds_w4$cog_verb
kable(Categorical_summary(vari, missing_values = miss_values_vector)[3], caption = ds_label_cog_verb) 
kable(Categorical_summary(vari, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vari, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(SHARE_ds_w4, aes(x=factor(cog_verb))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
```

#### Validation
```{r crosstabulation w4, echo=FALSE}
Continuous <- c(sum(na.omit(SHARE_ds_w4[[2]])<=Q), sum(na.omit(SHARE_ds_w4[[2]])>Q & na.omit(SHARE_ds_w4[[2]])<900), sum(na.omit(SHARE_ds_w4[[2]])==997), sum(na.omit(SHARE_ds_w4[[2]])==998), sum(na.omit(SHARE_ds_w4[[2]])==999))
...
kable(Continuous_summary(vari, missing_values = c(-1,-2))[2], caption = "Values")
pander(Continuous_summary(vari, missing_values = c(-1,-2))$summary, caption = "Summary")
ggplot(SHARE_w5_cog_verb %>% filter(!vari %in% vbl_miss), aes(x=cf010_)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(label(vari)) + ylab("Frequency")
```
...
kable(Continuous_summary(vari, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vari, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(SHARE_ds_w5 %>% filter(!vari %in% miss_values_vector), aes(cog_verb_c)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")

vari <- SHARE_ds_w5$cog_verb
kable(Categorical_summary(vari, missing_values = miss_values_vector)[3], caption = ds_label_cog_verb) 
kable(Categorical_summary(vari, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vari, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(SHARE_ds_w5, aes(x=factor(cog_verb))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
```

#### Validation
```{r crosstabulation w5, echo=FALSE}
Continuous <- c(sum(na.omit(SHARE_ds_w5[[2]])<=Q), sum(na.omit(SHARE_ds_w5[[2]])>Q & na.omit(SHARE_ds_w5[[2]])<900), sum(na.omit(SHARE_ds_w5[[2]])==997), sum(na.omit(SHARE_ds_w5[[2]])==998), sum(na.omit(SHARE_ds_w5[[2]])==999))
