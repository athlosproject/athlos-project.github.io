...
SHARE_ds_w1$f_vig_pa <- car::recode(SHARE_w1$br015_, "1 = 3;2 = 1;3 = 1;4 = 0;-2 = 997;-1 = 998;NA = 999 ")
```

#### Statistical description of the new harmonised variable
```{r descript w1, echo=F}
vbl <- SHARE_ds_w1$f_vig_pa
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(SHARE_ds_w1, aes(x=factor(f_vig_pa))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
```


#### Validation
```{r crosstabulation w1, echo=F}
AfterH <- table(SHARE_ds_w1$f_vig_pa)
X<-table(SHARE_w1$br015_)
BeforeH <- c(X[6],sum(X[4:5]),X[c(3,1,2)],sum(is.na(SHARE_w1$br015_)))
...
SHARE_ds_w2$f_vig_pa <- car::recode(SHARE_w2$br015_, "1 = 3;2 = 1;3 = 1;4 = 0;-2 = 997;-1 = 998;NA = 999 ")
```

#### Statistical description of the new harmonised variable
```{r descript w2, echo=F}
vbl <- SHARE_ds_w2$f_vig_pa
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(SHARE_ds_w2, aes(x=factor(f_vig_pa))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
```


#### Validation
```{r crosstabulation w2, echo=F}
AfterH <- table(SHARE_ds_w2$f_vig_pa)
X<-table(SHARE_w2$br015_)
BeforeH <- c(X[6],sum(X[4:5]),X[c(3,1,2)],sum(is.na(SHARE_w2$br015_)))
C <- rbind(BeforeH,AfterH)
colnames(C) <- c("4->0","2,3->1","1->3","-2->997","-1->998","NA->999") 
kable(C)
```
...
SHARE_ds_w4$f_vig_pa <- car::recode(SHARE_w4$br015_, "1 = 3;2 = 1;3 = 1;4 = 0;-2 = 997;-1 = 998;NA = 999 ")
```

#### Statistical description of the new harmonised variable
```{r descript w4, echo=F}
vbl <- SHARE_ds_w4$f_vig_pa
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(SHARE_ds_w4, aes(x=factor(f_vig_pa))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
```


#### Validation
```{r crosstabulation w4, echo=F}
AfterH <- table(SHARE_ds_w4$f_vig_pa)
X<-table(SHARE_w4$br015_)
BeforeH <- c(X[6],sum(X[4:5]),X[c(3,1,2)],sum(is.na(SHARE_w4$br015_)))
C <- rbind(BeforeH,AfterH)
colnames(C) <- c("4->0","2,3->1","1->3","-2->997","-1->998","NA->999") 
kable(C)
```
...
SHARE_ds_w5$f_vig_pa <- car::recode(SHARE_w5$br015_, "1 = 3;2 = 1;3 = 1;4 = 0;-2 = 997;-1 = 998;NA = 999 ")
```

#### Statistical description of the new harmonised variable
```{r descript w5, echo=F}
vbl <- SHARE_ds_w5$f_vig_pa
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(SHARE_ds_w5, aes(x=factor(f_vig_pa))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
```


#### Validation
```{r crosstabulation w5, echo=F}
AfterH <- table(SHARE_ds_w5$f_vig_pa)
X<-table(SHARE_w5$br015_)
BeforeH <- c(X[6],sum(X[4:5]),X[c(3,1,2)],sum(is.na(SHARE_w5$br015_)))
C <- rbind(BeforeH,AfterH)
colnames(C) <- c("4->0","2,3->1","1->3","-2->997","-1->998","NA->999") 
kable(C)
```
