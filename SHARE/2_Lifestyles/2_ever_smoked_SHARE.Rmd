...
```{r assign w2, echo=F}
opal.assign.table.tibble(o, 'SHARE_w2','SHARE.sharew2_rel2-6-0_br', variables=list('br001_','br002_'), missings = TRUE)
...
#### Harmonisation algorithm
To compute `ever_smoked` from the study-specific variable `br001_` it has to be recoded as follows:
...
SHARE_ds_w2$ever_smoked[which(SHARE_w2$br002_==1)] <- 1
```
...
```{r assign w4, echo=F}
opal.assign.table.tibble(o, 'SHARE_w4','SHARE.sharew4_rel1-1-1_br', variables=list('br001_','br002_'), missings = TRUE)
...
SHARE_ds_w4$ever_smoked[which(SHARE_w4$br002_==1)] <- 1
```
...
```{r assign w5, echo=F}
opal.assign.table.tibble(o, 'SHARE_w5','SHARE.sharew5_rel1-0-0_br', variables=list('br001_','br002_'), missings = TRUE)
...
SHARE_ds_w5$ever_smoked[which(SHARE_w5$br002_==1)] <- 1
```
