...
SHARE_w4$height[which((is.na(SHARE_w4$height) | SHARE_w2$height<=59) & !SHARE_w4$height_pw %in% miss_values_vector)] <- SHARE_w4$height_pw[which((is.na(SHARE_w4$height) | SHARE_w2$height<=59) & !SHARE_w4$height_pw %in% miss_values_vector)]
