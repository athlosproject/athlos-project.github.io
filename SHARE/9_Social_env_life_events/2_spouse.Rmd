...
for(i in 1:dim(SHARE_w3_spouse)[1]){
  ...
  else if(SHARE_w3_spouse$sl_rp009_1[i] == 5 & 
     SHARE_w3_spouse$sl_rp009_2[i] == 5 & 
     SHARE_w3_spouse$sl_rp009_3[i] == 5 &
     SHARE_w3_spouse$sl_rp009_4[i] == 5 & 
     SHARE_w3_spouse$sl_rp009_5[i] == 5 & 
     SHARE_w3_spouse$sl_rp009_6[i] == 5 &
     SHARE_w3_spouse$sl_rp009_11[i] == 5 &
     SHARE_w3_spouse$sl_rp009_12[i] == 5 & 
     SHARE_w3_spouse$sl_rp009_13[i] == 5 &
     SHARE_w3_spouse$sl_rp009_14[i] == 5 &
     SHARE_w3_spouse$sl_rp009_15[i] == 5 & 
     SHARE_w3_spouse$sl_rp009_16[i] == 5 & 
     SHARE_w3_spouse$sl_rp009_17[i] == 5 &
     SHARE_w3_spouse$sl_rp009_18[i] == 5 & 
     SHARE_w3_spouse$sl_rp019_1[i] == 5 &
     SHARE_w3_spouse$sl_rp019_2[i] == 5 & 
     SHARE_w3_spouse$sl_rp019_3[i] == 5 &
     SHARE_w3_spouse$sl_rp019_4[i] == 5 & 
     SHARE_w3_spouse$sl_rp019_5[i] == 5) { 
