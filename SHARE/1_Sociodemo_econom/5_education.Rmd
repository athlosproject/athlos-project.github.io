...
SHARE_ds_w5$education[which(is.na(SHARE_w5_educ$isced2011_r) & SHARE_ds_w5$education==999)] <- car::recode(SHARE_w4_educ$education_w2[which(is.na(SHARE_w5_educ$isced2011_r) & SHARE_ds_w5$education==999)],"NA=999")
SHARE_ds_w5$education[which(is.na(SHARE_w5_educ$isced2011_r) & SHARE_ds_w5$education==999)] <- car::recode(SHARE_w4_educ$education_w1[which(is.na(SHARE_w5_educ$isced2011_r) & SHARE_ds_w5$education==999)],"NA=999")
