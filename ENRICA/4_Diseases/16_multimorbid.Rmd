...
| **Table name**  |`enrica_w1_hd`|`enrica_w1_hd`|`enrica_w1_hd`|`enrica_w1_hd`|`enrica_w1_hd`| `enrica_w1_hd` |
...
opal.assign.table.tibble(o, 'ENRICA_w1','ENRICA_HD.enrica_w1_hd',variables=list('h_diabetes','h_respiratory','h_hypertension','h_joint_disorders','stroke','mi_ha'), missings = T)
...
ENRICA_ds_w1 <- ENRICA_w1 %>% 
  mutate(dead = purrr::pmap(mutate_at(., vars(-id), `==`, 996) %>% select(., -id), all) %>% unlist()) %>%
  mutate_at(names(ENRICA_w1[,-1]), ~replace(., list = which(. %in% 991:999), values = NA)) %>% 
...
vbl <- ENRICA_ds_w1$multimorbid
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(ENRICA_ds_w1, aes(x=factor(vbl))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
...
|-|-|-|-|-|-|-|
| **Label** |`History of diabetes mellitus`|`Chronic respiratory diseases such respiratory, CPD, COPD, bronchitis, emphysema`|`History of hypertension`|`History of arthritis, rheumatism or osteoarthritis`| `Stroke` |`Myocardial infarction or heart attack`|
| **Table name**  |`enrica_w2_hd`|`enrica_w2_hd`|`enrica_w2_hd`|`enrica_w2_hd`|`enrica_w2_hd`| `enrica_w2_hd` |
| **Categories** |`0 = No`<br/>`1 = Yes`|`0 = No`<br/>`1 = Yes`|`0 = No`<br/>`1 = Yes`|`0 = No`<br/>`1 = Yes`|`0 = No`<br/>`1 = Yes`| `0 = No`<br/>`1 = Yes` |
...
opal.assign.table.tibble(o, 'ENRICA_w2','ENRICA_HD.enrica_w2_hd',variables=list('h_diabetes','h_respiratory','h_hypertension','h_joint_disorders','stroke','mi_ha'), missings = T)
...
vbl <- ENRICA_w2$h_diabetes
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = "h_diabetes")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
ggplot(ENRICA_w2, aes(x=factor(vbl))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")

vbl <- ENRICA_w2$h_respiratory
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = "h_respiratory")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
ggplot(ENRICA_w2, aes(x=factor(vbl))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")

vbl <- ENRICA_w2$h_hypertension
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = "h_hypertension")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
ggplot(ENRICA_w2, aes(x=factor(vbl))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")

vbl <- ENRICA_w2$h_joint_disorders
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = "h_joint_disorders")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
ggplot(ENRICA_w2, aes(x=factor(vbl))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")
...
ENRICA_ds_w2 <- ENRICA_w2 %>% 
  mutate(dead = purrr::pmap(mutate_at(., vars(-id), `==`, 996) %>% select(., -id), all) %>% unlist()) %>%
  mutate_at(names(ENRICA_w2[,-1]), ~replace(., list = which(. %in% 991:999), values = NA)) %>% 
  mutate(multimorbid_score = rowSums(select(., -1, -dead), na.rm = T)) %>%
  mutate(cardNA = rowSums(!is.na(select(., -1, -dead, -multimorbid_score)))) %>%
  mutate(cardNA = cardNA/cardNA) %>%
  mutate(multimorbid_score = multimorbid_score * cardNA) %>%
...
vbl <- ENRICA_ds_w2$multimorbid
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(ENRICA_ds_w2, aes(x=factor(vbl))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
...
|-|-|-|-|-|-|-|
| **Label** |`History of diabetes mellitus`|`Chronic respiratory diseases such respiratory, CPD, COPD, bronchitis, emphysema`|`History of hypertension`|`History of arthritis, rheumatism or osteoarthritis`| `Stroke` |`Myocardial infarction or heart attack`|
| **Table name**  |`enrica_w3_hd`|`enrica_w3_hd`|`enrica_w3_hd`|`enrica_w3_hd`|`enrica_w3_hd`| `enrica_w3_hd` |
| **Categories** |`0 = No`<br/>`1 = Yes`|`0 = No`<br/>`1 = Yes`|`0 = No`<br/>`1 = Yes`|`0 = No`<br/>`1 = Yes`|`0 = No`<br/>`1 = Yes`| `0 = No`<br/>`1 = Yes` |
...
opal.assign.table.tibble(o, 'ENRICA_w3','ENRICA_HD.enrica_w3_hd',variables=list('h_diabetes','h_respiratory','h_hypertension','h_joint_disorders','stroke','mi_ha'), missings = T)
...
vbl <- ENRICA_w3$h_diabetes
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = "h_diabetes")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
ggplot(ENRICA_w3, aes(x=factor(vbl))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")

vbl <- ENRICA_w3$h_respiratory
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = "h_respiratory")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
ggplot(ENRICA_w3, aes(x=factor(vbl))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")

vbl <- ENRICA_w3$h_hypertension
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = "h_hypertension")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
ggplot(ENRICA_w3, aes(x=factor(vbl))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")

vbl <- ENRICA_w3$h_joint_disorders
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = "h_joint_disorders")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
ggplot(ENRICA_w3, aes(x=factor(vbl))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")
...
ENRICA_ds_w3 <- ENRICA_w3 %>% 
  mutate(dead = purrr::pmap(mutate_at(., vars(-id), `==`, 996) %>% select(., -id), all) %>% unlist()) %>%
  mutate_at(names(ENRICA_w3[,-1]), ~replace(., list = which(. %in% 991:999), values = NA)) %>% 
  mutate(multimorbid_score = rowSums(select(., -1, -dead), na.rm = T)) %>%
  mutate(cardNA = rowSums(!is.na(select(., -1, -dead, -multimorbid_score)))) %>%
  mutate(cardNA = cardNA/cardNA) %>%
  mutate(multimorbid_score = multimorbid_score * cardNA) %>%
...
vbl <- ENRICA_ds_w3$multimorbid
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(ENRICA_ds_w3, aes(x=factor(vbl))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
