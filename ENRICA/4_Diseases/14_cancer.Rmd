...
ENRICA_ds_w2$cancer_age[which(ENRICA_ds_w2$cancer == 1 & ENRICA_w2$cancer==0)] <- floor((ENRICA_w2$yintw_w2[which(ENRICA_ds_w2$cancer == 1 & ENRICA_w2$cancer==0)]+ENRICA_w2$yintw_w1[which(ENRICA_ds_w2$cancer == 1 & ENRICA_w2$cancer==0)])/2-ENRICA_w2$ybirth[which(ENRICA_ds_w2$cancer == 1 & ENRICA_w2$cancer==0)])
...
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(ENRICA_ds_w2, aes(cancer_age)) + geom_bar(stat="count", width=0.4, fill="steelblue", data = .%>% filter(!vbl %in% miss_values_vector)) + xlab(ds_label_age) + ylab("Frequency")
...
ENRICA_ds_w3$cancer_age[which(ENRICA_ds_w3$cancer == 1 & ENRICA_w3$cancer==0)] <- floor((ENRICA_w3$yintw_w3[which(ENRICA_ds_w3$cancer == 1 & ENRICA_w3$cancer==0)]+ENRICA_w3$yintw_w2[which(ENRICA_ds_w3$cancer == 1 & ENRICA_w3$cancer==0)])/2-ENRICA_w3$ybirth[which(ENRICA_ds_w3$cancer == 1 & ENRICA_w3$cancer==0)])
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(ENRICA_ds_w3, aes(cancer_age)) + geom_bar(stat="count", width=0.4, fill="steelblue", data = .%>% filter(!vbl %in% miss_values_vector)) + xlab(ds_label_age) + ylab("Frequency")
