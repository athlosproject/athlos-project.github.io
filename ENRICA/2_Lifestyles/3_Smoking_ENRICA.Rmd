...
ENRICA_ds_w1$smoking <- ENRICA_w1$w1tobacco
```

#### Statistical description of the new harmonised variable
```{r descript w1, echo=F}
vbl <- ENRICA_ds_w1$smoking
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(ENRICA_ds_w1, aes(x=factor(smoking))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
```
...
ENRICA_ds_w2$smoking <- car::recode(ENRICA_w2$w2tobacco, "NA = 999 ")
```

#### Statistical description of the new harmonised variable
```{r descript w2, echo=F}
vbl <- ENRICA_ds_w2$smoking
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(ENRICA_ds_w2, aes(x=factor(smoking))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
```
...
ENRICA_ds_w3$smoking <- car::recode(ENRICA_w3$w3tobacco, "NA = 999 ")
```

#### Statistical description of the new harmonised variable
```{r descript w3, echo=F}
vbl <- ENRICA_ds_w3$smoking
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(ENRICA_ds_w3, aes(x=factor(smoking))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
```
...
dbb <- get(paste0("ENRICA_m_ds_",names(l.hds)[1]))[,c("id","smoking")]
for(ind in 2:length(l.hds)){
  dbb <- merge(dbb, get(paste0("ENRICA_m_ds_",names(l.hds)[ind]))[,c("id","smoking")], by = "id", suffixes = c("", paste0(".",names(l.hds)[ind])), all = T)
}
