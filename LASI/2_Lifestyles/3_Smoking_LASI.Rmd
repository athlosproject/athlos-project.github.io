...
LASI_ds_w1$smoking[LASI_w1$ht205==2] <- 0
LASI_ds_w1$smoking[LASI_w1$ht205==1&LASI_w1$ht206s3==3] <- 1
LASI_ds_w1$smoking[LASI_w1$ht205==1&(LASI_w1$ht206s1==1|LASI_w1$ht206s2==2)] <- 2
```
