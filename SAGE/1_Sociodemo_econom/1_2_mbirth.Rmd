...
```{r harmo1}
SAGE_SA_ds_w1 <- tibble(id=SAGE_SA_w1_mbirth$id)
SAGE_SA_ds_w1$mbirth <- car::recode(SAGE_SA_w1_mbirth$q1010_mm, "-8=998; NA=999")
SAGE_SA_ds_w1$mbirth <- labelled(SAGE_SA_ds_w1$mbirth, labels = c("january"=1, "february"=2, "march"=3, "april"=4, "may"=5, "june"=6, "july"=7, "august"=8, "september"=9, "october"=10, "november"=11, "december"=12, "Missing"=999, "Do not know"=998, "Refuse"=997, "Not applicable"=996, "Does not answer"=995,  "Not attempt not done"=994, "Disable to measure"=993, "Impute"=992, "CAPI interviewer error"=991))
```

#### Statistics of the new harmonised variable
```{r descript1, echo=F}
vari <- SAGE_SA_ds_w1$mbirth
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[3], caption = ds_label) 
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[1], caption = "Category")
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[2], caption = "Type of missing")
ggplot(SAGE_SA_ds_w1, aes(x=factor(mbirth))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab("Month of birth") + ylab("Frequency")
```

#### Validation
```{r crosstabulation1, echo=F}
BeforeH <- c(table(SAGE_SA_w1_mbirth$q1010_mm), sum(is.na(SAGE_SA_w1_mbirth$q1010_mm)))
AfterH <- table(SAGE_SA_ds_w1$mbirth)
...
```{r harmo_ghana}
SAGE_ghana_ds_w1 <- tibble(id=SAGE_ghana_w1_mbirth$id)
SAGE_ghana_ds_w1$mbirth <- car::recode(SAGE_ghana_w1_mbirth$q1010_mm, "-8=998; NA=999")
SAGE_ghana_ds_w1$mbirth <- labelled(SAGE_ghana_ds_w1$mbirth, labels = c("january"=1, "february"=2, "march"=3, "april"=4, "may"=5, "june"=6, "july"=7, "august"=8, "september"=9, "october"=10, "november"=11, "december"=12, "Missing"=999, "Do not know"=998, "Refuse"=997, "Not applicable"=996, "Does not answer"=995,  "Not attempt not done"=994, "Disable to measure"=993, "Impute"=992, "CAPI interviewer error"=991))
```

#### Statistics of the new harmonised variable
```{r descript_ghana, echo=F}
vari <- SAGE_ghana_ds_w1$mbirth
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[3], caption = ds_label) 
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[1], caption = "Category")
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[2], caption = "Type of missing")
ggplot(SAGE_ghana_ds_w1, aes(x=factor(mbirth))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab("Month of birth") + ylab("Frequency")
```
...
AfterH <- table(SAGE_ghana_ds_w1$mbirth)
C <- rbind(BeforeH,AfterH)
...
```{r harmo_china}
SAGE_china_ds_w1 <- tibble(id=SAGE_china_w1_mbirth$id)
SAGE_china_ds_w1$mbirth <- car::recode(SAGE_china_w1_mbirth$q1010_mm, "-8=998; NA=999; 0=999")
SAGE_china_ds_w1$mbirth <- labelled(SAGE_china_ds_w1$mbirth, labels = c("january"=1, "february"=2, "march"=3, "april"=4, "may"=5, "june"=6, "july"=7, "august"=8, "september"=9, "october"=10, "november"=11, "december"=12, "Missing"=999, "Do not know"=998, "Refuse"=997, "Not applicable"=996, "Does not answer"=995,  "Not attempt not done"=994, "Disable to measure"=993, "Impute"=992, "CAPI interviewer error"=991))
```

#### Statistics of the new harmonised variable
```{r descript_china, echo=F}
vari <- SAGE_china_ds_w1$mbirth
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[3], caption = ds_label) 
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[1], caption = "Category")
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[2], caption = "Type of missing")
ggplot(SAGE_china_ds_w1, aes(x=factor(mbirth))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab("Month of birth") + ylab("Frequency")
```
...
AfterH <- table(SAGE_china_ds_w1$mbirth)
C <- rbind(BeforeH,AfterH)
...
```{r harmo_india}
SAGE_india_ds_w1 <- tibble(id=SAGE_india_w1_mbirth$id)
SAGE_india_ds_w1$mbirth <- car::recode(SAGE_india_w1_mbirth$q1010_mm, "-8=998; NA=999")
SAGE_india_ds_w1$mbirth <- labelled(SAGE_india_ds_w1$mbirth, labels = c("january"=1, "february"=2, "march"=3, "april"=4, "may"=5, "june"=6, "july"=7, "august"=8, "september"=9, "october"=10, "november"=11, "december"=12, "Missing"=999, "Do not know"=998, "Refuse"=997, "Not applicable"=996, "Does not answer"=995,  "Not attempt not done"=994, "Disable to measure"=993, "Impute"=992, "CAPI interviewer error"=991))
```

#### Statistics of the new harmonised variable
```{r descript_india, echo=F}
vari <- SAGE_india_ds_w1$mbirth
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[3], caption = ds_label) 
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[1], caption = "Category")
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[2], caption = "Type of missing")
ggplot(SAGE_india_ds_w1, aes(x=factor(mbirth))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab("Month of birth") + ylab("Frequency")
```
...
AfterH <- table(SAGE_india_ds_w1$mbirth)
C <- rbind(BeforeH,AfterH)
...
```{r harmo_russia}
SAGE_russia_ds_w1 <- tibble(id=SAGE_russia_w1_mbirth$id)
SAGE_russia_ds_w1$mbirth <- car::recode(SAGE_russia_w1_mbirth$q1010_mm, "-8=998; NA=999")
SAGE_russia_ds_w1$mbirth <- labelled(SAGE_russia_ds_w1$mbirth, labels = c("january"=1, "february"=2, "march"=3, "april"=4, "may"=5, "june"=6, "july"=7, "august"=8, "september"=9, "october"=10, "november"=11, "december"=12, "Missing"=999, "Do not know"=998, "Refuse"=997, "Not applicable"=996, "Does not answer"=995,  "Not attempt not done"=994, "Disable to measure"=993, "Impute"=992, "CAPI interviewer error"=991))
```

#### Statistics of the new harmonised variable
```{r descript_russia, echo=F}
vari <- SAGE_russia_ds_w1$mbirth
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[3], caption = ds_label) 
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[1], caption = "Category")
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[2], caption = "Type of missing")
ggplot(SAGE_russia_ds_w1, aes(x=factor(mbirth))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab("Month of birth") + ylab("Frequency")
```
...
AfterH <- table(SAGE_russia_ds_w1$mbirth)
C <- rbind(BeforeH,AfterH)
colnames(C) <- c(names(AfterH)[1:12], "-8->998", "NA->999")
kable(C)
```
...
```{r harmo_Mexico}
SAGE_mexico_ds_w1 <- tibble(id=SAGE_mexico_w1_mbirth$id)
SAGE_mexico_ds_w1$mbirth <- car::recode(SAGE_mexico_w1_mbirth$q1010_mm, "-8=998; NA=999")
SAGE_mexico_ds_w1$mbirth <- labelled(SAGE_mexico_ds_w1$mbirth, labels = c("january"=1, "february"=2, "march"=3, "april"=4, "may"=5, "june"=6, "july"=7, "august"=8, "september"=9, "october"=10, "november"=11, "december"=12, "Missing"=999, "Do not know"=998, "Refuse"=997, "Not applicable"=996, "Does not answer"=995,  "Not attempt not done"=994, "Disable to measure"=993, "Impute"=992, "CAPI interviewer error"=991))
```

#### Statistics of the new harmonised variable
```{r descript_Mexico, echo=F}
vari <- SAGE_mexico_ds_w1$mbirth
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[3], caption = ds_label) 
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[1], caption = "Category")
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[2], caption = "Type of missing")
ggplot(SAGE_mexico_ds_w1, aes(x=factor(mbirth))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab("Month of birth") + ylab("Frequency")
```

#### Validation
```{r crosstabulation_Mexico, echo=F}
BeforeH <- c(table(SAGE_mexico_w1_mbirth$q1010_mm), sum(is.na(SAGE_mexico_w1_mbirth$q1010_mm)))
AfterH <- table(SAGE_mexico_ds_w1$mbirth)
C <- rbind(BeforeH,AfterH)
colnames(C) <- c(names(AfterH)[1:12], "NA->999")
kable(C)
```
