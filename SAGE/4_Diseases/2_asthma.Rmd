...
opal.assign.table.tibble(o, 'SAGE_SA_w1','SAGE.southAfricaINDdata',variables=list('q4033'), missings = T)
...
SAGE_ds_SA_w1$h_asthma <- car::recode(SAGE_SA_w1$q4033,"2=0;8=998;NA=999")
...
vbl <- SAGE_ds_SA_w1$h_asthma
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(SAGE_ds_SA_w1, aes(x=factor(h_asthma))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
...
AfterH <- table(SAGE_ds_SA_w1$h_asthma)
BeforeH <- table(SAGE_SA_w1$q4033,useNA = "ifany")[c(2,1,3,4)]
...
opal.assign.table.tibble(o, 'SAGE_ghana_w1','SAGE.ghanaINDData',variables=list('q4033'), missings = T)
...
SAGE_ds_ghana_w1$h_asthma <- car::recode(SAGE_ghana_w1$q4033,"2=0;8=998;NA=999")
...
vbl <- SAGE_ds_ghana_w1$h_asthma
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(SAGE_ds_ghana_w1, aes(x=factor(h_asthma))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
...
AfterH <- table(SAGE_ds_ghana_w1$h_asthma)
BeforeH <- table(SAGE_ghana_w1$q4033,useNA = "ifany")[c(2,1,3,4)]
C <- rbind(BeforeH,AfterH)
colnames(C) <- c("2->0","1->1","8->998","NA->999")
kable(C)
...
opal.assign.table.tibble(o, 'SAGE_china_w1','SAGE.chinaINDData',variables=list('q4033'), missings = T)
...
SAGE_ds_china_w1$h_asthma <- car::recode(SAGE_china_w1$q4033,"2=0;NA=999")
...
vbl <- SAGE_ds_china_w1$h_asthma
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(SAGE_ds_china_w1, aes(x=factor(h_asthma))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
...
AfterH <- table(SAGE_ds_china_w1$h_asthma)
BeforeH <- table(SAGE_china_w1$q4033,useNA = "ifany")[c(2,1,3)]
C <- rbind(BeforeH,AfterH)
...
opal.assign.table.tibble(o, 'SAGE_india_w1','SAGE.indiaINDData',variables=list('q4033'), missings = T)
...
SAGE_ds_india_w1$h_asthma <- car::recode(SAGE_india_w1$q4033,"2=0;9=996;NA=999")
...
vbl <- SAGE_ds_india_w1$h_asthma
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(SAGE_ds_india_w1, aes(x=factor(h_asthma))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
...
AfterH <- table(SAGE_ds_india_w1$h_asthma)
BeforeH <- table(SAGE_india_w1$q4033,useNA = "ifany")[c(2,1,3,4)]
C <- rbind(BeforeH,AfterH)
...
opal.assign.table.tibble(o, 'SAGE_russia_w1','SAGE.russiaINDdata',variables=list('q4033'), missings = T)
...
SAGE_ds_russia_w1$h_asthma <- car::recode(SAGE_russia_w1$q4033,"2=0;8=998;9=996;NA=999")
...
vbl <- SAGE_ds_russia_w1$h_asthma
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(SAGE_ds_russia_w1, aes(x=factor(h_asthma))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
...
AfterH <- table(SAGE_ds_russia_w1$h_asthma)
BeforeH <- table(SAGE_russia_w1$q4033,useNA = "ifany")[c(2,1,4,3,5)]
C <- rbind(BeforeH,AfterH)
...
opal.assign.table.tibble(o, 'SAGE_mexico_w1','SAGE.mexicoINDdata',variables=list('q4033'), missings = T)
...
SAGE_ds_mexico_w1$h_asthma <- car::recode(SAGE_mexico_w1$q4033,"2=0;NA=999")
...
vbl <- SAGE_ds_mexico_w1$h_asthma
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(SAGE_ds_mexico_w1, aes(x=factor(h_asthma))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
...
AfterH <- table(SAGE_ds_mexico_w1$h_asthma)
BeforeH <- table(SAGE_mexico_w1$q4033,useNA = "ifany")[c(2,1,3)]
C <- rbind(BeforeH,AfterH)
colnames(C) <- c("2->0","1->1","NA->999")
kable(C)
