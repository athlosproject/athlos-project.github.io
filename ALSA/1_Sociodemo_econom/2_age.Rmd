...
ggplot(ALSA_ds_w7, aes(age)) + geom_histogram(stat="count", fill="steelblue", data = .%>% filter(!vari %in% miss_values_vector)) + xlab("age") + ylab("Frequency") 
```
...
ggplot(ALSA_ds_w9, aes(age)) + geom_histogram(stat="count", fill="steelblue", data = .%>% filter(!vari %in% miss_values_vector)) + xlab("age") + ylab("Frequency")
