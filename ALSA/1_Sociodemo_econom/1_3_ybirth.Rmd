...
#Continuous_summary(var = ALSA_w1_ybirth$Year, missing_values = c(9999))
...
#Continuous_summary(var = ALSA_ds_w1$ybirth, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))
...
kable(Continuous_summary(vari, missing_values = c(9999))[2], caption = "Values")
pander(Continuous_summary(vari, missing_values = c(9999))$summary, caption = "Summary")
#Continuous_summary(var = ALSA_w2_ybirth$Year, missing_values = c(9999))
...
kable(Continuous_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[2], caption = "Values")
pander(Continuous_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))$summary, caption = "Summary")
#Continuous_summary(var = ALSA_ds_w2$ybirth, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))
...
kable(Continuous_summary(vari, missing_values = c(9999))[2], caption = "Values")
pander(Continuous_summary(vari, missing_values = c(9999))$summary, caption = "Summary")
#Continuous_summary(var = ALSA_w3_ybirth$Year, missing_values = c(9999))
...
kable(Continuous_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[2], caption = "Values")
pander(Continuous_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))$summary, caption = "Summary")
#Continuous_summary(var = ALSA_ds_w3$ybirth, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))
...
kable(Continuous_summary(vari, missing_values = c(9999))[2], caption = "Values")
pander(Continuous_summary(vari, missing_values = c(9999))$summary, caption = "Summary")
#Continuous_summary(var = ALSA_w4_ybirth$Year, missing_values = c(9, 99))
...
kable(Continuous_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[2], caption = "Values")
pander(Continuous_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))$summary, caption = "Summary")
#Continuous_summary(var = ALSA_ds_w4$ybirth, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))
...
kable(Continuous_summary(vari, missing_values = c(9999))[2], caption = "Values")
pander(Continuous_summary(vari, missing_values = c(9999))$summary, caption = "Summary")
#Continuous_summary(var = ALSA_w5_ybirth$Year, missing_values = c(9, 99))
...
kable(Continuous_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[2], caption = "Values")
pander(Continuous_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))$summary, caption = "Summary")
#Continuous_summary(var = ALSA_ds_w5$ybirth, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))
ggplot(ALSA_ds_w1, aes(ybirth)) + geom_histogram(stat="count", fill="steelblue") + xlab("Year of birth") + ylab("Frequency") 
```
...
kable(Continuous_summary(vari, missing_values = c(9999))[2], caption = "Values")
pander(Continuous_summary(vari, missing_values = c(9999))$summary, caption = "Summary")
#Continuous_summary(var = ALSA_w6_ybirth$Year, missing_values = c(9, 99))
...
kable(Continuous_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[2], caption = "Values")
pander(Continuous_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))$summary, caption = "Summary")
#Continuous_summary(var = ALSA_ds_w6$ybirth, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))
...
kable(Continuous_summary(vari, missing_values = c(9999))[2], caption = "Values")
pander(Continuous_summary(vari, missing_values = c(9999))$summary, caption = "Summary")
#Continuous_summary(var = ALSA_w7_ybirth$Year, missing_values = c(9, 99))
...
kable(Continuous_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[2], caption = "Values")
pander(Continuous_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))$summary, caption = "Summary")
#Continuous_summary(var = ALSA_ds_w7$ybirth, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))
...
kable(Continuous_summary(vari, missing_values = c(9999))[2], caption = "Values")
pander(Continuous_summary(vari, missing_values = c(9999))$summary, caption = "Summary")
#Continuous_summary(var = ALSA_w8_ybirth$Year, missing_values = c(9, 99))
...
kable(Continuous_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[2], caption = "Values")
pander(Continuous_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))$summary, caption = "Summary")
#Continuous_summary(var = ALSA_ds_w8$ybirth, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))
...
kable(Continuous_summary(vari, missing_values = c(9999))[2], caption = "Values")
pander(Continuous_summary(vari, missing_values = c(9999))$summary, caption = "Summary")
#Continuous_summary(var = ALSA_w9_ybirth$Year, missing_values = c(9999))
...
kable(Continuous_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[2], caption = "Values")
pander(Continuous_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))$summary, caption = "Summary")
#Continuous_summary(var = ALSA_ds_w9$ybirth, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))
...
#Continuous_summary(var = ALSA_w9_compr_ybirth$ybirth_w9, missing_values = NA)
...
kable(Continuous_summary(vari, missing_values = c(9999))[2], caption = "Values")
pander(Continuous_summary(vari, missing_values = c(9999))$summary, caption = "Summary")
#Continuous_summary(var = ALSA_w10_ybirth$Year, missing_values = c(9999))
...
kable(Continuous_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[2], caption = "Values")
pander(Continuous_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))$summary, caption = "Summary")
#Continuous_summary(var = ALSA_ds_w10$ybirth, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))
...
kable(Continuous_summary(vari, missing_values = c(9999))[2], caption = "Values")
pander(Continuous_summary(vari, missing_values = c(9999))$summary, caption = "Summary")
#Continuous_summary(var = ALSA_w11_ybirth$Year, missing_values = c(9999))
...
kable(Continuous_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[2], caption = "Values")
pander(Continuous_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))$summary, caption = "Summary")
#Continuous_summary(var = ALSA_ds_w11$ybirth, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))
...
kable(Continuous_summary(vari, missing_values = c(9999))[2], caption = "Values")
pander(Continuous_summary(vari, missing_values = c(9999))$summary, caption = "Summary")
#Continuous_summary(var = ALSA_w12_ybirth$Year, missing_values = c(9999))
...
kable(Continuous_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[2], caption = "Values")
pander(Continuous_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))$summary, caption = "Summary")
#Continuous_summary(var = ALSA_ds_w12$ybirth, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))
...
kable(Continuous_summary(vari, missing_values = c(9999))[2], caption = "Values")
pander(Continuous_summary(vari, missing_values = c(9999))$summary, caption = "Summary")
#Continuous_summary(var = ALSA_w13_ybirth$Year, missing_values = c(9999))
...
kable(Continuous_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[2], caption = "Values")
pander(Continuous_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))$summary, caption = "Summary")
#Continuous_summary(var = ALSA_ds_w13$ybirth, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))
