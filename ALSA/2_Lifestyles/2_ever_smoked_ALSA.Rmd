...
kable(Categorical_summary(vbl, missing_values = NA)[2], caption = names(ALSA_w1)[4])
kable(Categorical_summary(vbl, missing_values = NA)[1], caption = "Category")
...
ALSA_ds_w1$ever_smoked[ALSA_w1$SMOKER==2|ALSA_w1$REGSMKPS==2|ALSA_w1$REGPIPCG==2] <- 0
ALSA_ds_w1$ever_smoked[ALSA_w1$SMOKER==1|ALSA_w1$REGSMKPS==1|ALSA_w1$REGPIPCG==1] <- 1
```
