...
* Name: `DIFFIC7`
* Label: `Difficulty with: Moving about inside house`
* Categories:
...
opal.assign.table.tibble(o, 'ALSA_w1_adl_moving','ALSA.ALSA-Wave1', variables=list('DIFFIC7'), missings = TRUE)
```

```{r local w1,  echo=FALSE}
ALSA_w1_adl_moving <- opal.execute(o,'ALSA_w1_adl_moving')
vari <- ALSA_w1_adl_moving$DIFFIC7
kable(Categorical_summary(vari, missing_values = NA)[2], caption = attributes(vari)$`spss::shortName`)
kable(Categorical_summary(vari, missing_values = NA)[1], caption = "Category")
#Categorical_summary(ALSA_w1_adl_moving$DIFFIC7)
ggplot(ALSA_w1_adl_moving, aes(x=factor(DIFFIC7))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab("ADL - Moving around the home") + ylab("Frequency")
```
...
ALSA_ds_w1$adl_moving <- car::recode(ALSA_w1_adl_moving$DIFFIC7, "1 = '1';2 = '0';3 = '0';4 = '0';NA = '999' ")
...
#Categorical_summary(var = ALSA_ds_w1$adl_moving, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))
...
AfterH <- table(ALSA_ds_w1$adl_moving)
X<-table(ALSA_w1_adl_moving$DIFFIC7)
BeforeH <- c(sum(X[c(2:4)]),X[1],sum(is.na(ALSA_w1_adl_moving$DIFFIC7)))
...
label(ALSA_ds_w1$adl_moving) <- "Difficulties for moving around the home"
...
ALSA_m_ds_w1$adl_moving <- car::recode(ALSA_m_ds_w1$adl_moving, "c(991, 992, 993, 994, 995, 996, 997,998, 999)=NA")
#opal.assign.data(o, 'ALSA_m_ds_w1', ALSA_m_ds_w1)
#opal.symbol_import(o,'ALSA_m_ds_w1', project='_Athlos_Harm_Dataset')
```

```{r,  echo=FALSE}
adl_moving<- ALSA_ds_w1
...
opal.assign.table.tibble(o, 'ALSA_w2_adl_moving','ALSA.ALSA-Wave2', variables=list('Q34.7'), missings = TRUE)
```
...
kable(Categorical_summary(vari, missing_values = NA)[2], caption = attributes(vari)$`spss::shortName`)
kable(Categorical_summary(vari, missing_values = NA)[1], caption = "Category")
#Categorical_summary(ALSA_w2_adl_moving$Q34.7)
ggplot(ALSA_w2_adl_moving, aes(x=factor(Q34.7))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab("ADL - Moving around the home") + ylab("Frequency")
```
...
ALSA_ds_w2$adl_moving <- car::recode(ALSA_w2_adl_moving$Q34.7, "7 = '0';8 = '1';NA = '999' ")
ALSA_ds_w2$adl_moving <- labelled(ALSA_ds_w2$adl_moving, labels = c(Yes=0, No=1,Missing=999, Do_not_know=998, Refuse=997, Not_applicable=996, Does_not_answer=995,  Not_attempt_not_done=994, Disable_to_measure=993, Impute=992, CAPI_interviewer_error=991))
```
...
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[1], caption = "Category")
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[2], caption = "Type of missing")
#Categorical_summary(var = ALSA_ds_w2$adl_moving, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))
...
AfterH <- table(ALSA_ds_w2$adl_moving)
X<-table(ALSA_w2_adl_moving$Q34.7)
BeforeH <- c(X[1:2],sum(is.na(ALSA_w2_adl_moving$Q34.7)))
C <- rbind(BeforeH,AfterH)
colnames(C) <- c("7->0","8->1","NA->999") 
kable(C)
```
...
label(ALSA_ds_w2$adl_moving) <- "Difficulties for moving around the home"
...
ALSA_m_ds_w2$adl_moving <- car::recode(ALSA_m_ds_w2$adl_moving, "c(991, 992, 993, 994, 995, 996, 997,998, 999)=NA")
#opal.assign.data(o, 'ALSA_m_ds_w2', ALSA_m_ds_w2)
#opal.symbol_import(o,'ALSA_m_ds_w2', project='_Athlos_Harm_Dataset')
```

```{r,  echo=FALSE}
adl_moving<- ALSA_ds_w2
...
kable(Categorical_summary(vari, missing_values = NA)[2], caption = attributes(vari)$`spss::shortName`)
kable(Categorical_summary(vari, missing_values = NA)[1], caption = "Category")
#Categorical_summary(ALSA_w3_adl_moving$ADLDF7W3)
ggplot(ALSA_w3_adl_moving, aes(x=factor(ADLDF7W3))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab("ADL - Moving around the home") + ylab("Frequency")
```
...
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[1], caption = "Category")
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[2], caption = "Type of missing")
#Categorical_summary(var = ALSA_ds_w3$adl_moving, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))
...
label(ALSA_ds_w3$adl_moving) <- "Difficulties for moving around the home"
...
ALSA_m_ds_w3$adl_moving <- car::recode(ALSA_m_ds_w3$adl_moving, "c(991, 992, 993, 994, 995, 996, 997,998, 999)=NA")
#opal.assign.data(o, 'ALSA_m_ds_w3', ALSA_m_ds_w3)
#opal.symbol_import(o,'ALSA_m_ds_w3', project='_Athlos_Harm_Dataset')
```

```{r,  echo=FALSE}
adl_moving<- ALSA_ds_w3
...
kable(Categorical_summary(vari, missing_values = NA)[2], caption = attributes(vari)$`spss::shortName`)
kable(Categorical_summary(vari, missing_values = NA)[1], caption = "Category")
#Categorical_summary(ALSA_w4_adl_moving$ADLND7W4)
ggplot(ALSA_w4_adl_moving, aes(x=factor(ADLND7W4))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab("ADL - Moving around the home") + ylab("Frequency")
```
...
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[1], caption = "Category")
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[2], caption = "Type of missing")
#Categorical_summary(var = ALSA_ds_w4$adl_moving, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))
...
label(ALSA_ds_w4$adl_moving) <- "Difficulties for moving around the home"
...
ALSA_m_ds_w4$adl_moving <- car::recode(ALSA_m_ds_w4$adl_moving, "c(991, 992, 993, 994, 995, 996, 997,998, 999)=NA")
#opal.assign.data(o, 'ALSA_m_ds_w4', ALSA_m_ds_w4)
#opal.symbol_import(o,'ALSA_m_ds_w4', project='_Athlos_Harm_Dataset')
```

```{r,  echo=FALSE}
adl_moving<- ALSA_ds_w4
...
kable(Categorical_summary(vari, missing_values = NA)[2], caption = attributes(vari)$`spss::shortName`)
kable(Categorical_summary(vari, missing_values = NA)[1], caption = "Category")
#Categorical_summary(ALSA_w5_adl_moving$ADLND7W5)
ggplot(ALSA_w5_adl_moving, aes(x=factor(ADLND7W5))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab("ADL - Moving around the home") + ylab("Frequency")
```
...
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[1], caption = "Category")
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[2], caption = "Type of missing")
#Categorical_summary(var = ALSA_ds_w5$adl_moving, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))
...
label(ALSA_ds_w5$adl_moving) <- "Difficulties for moving around the home"
...
ALSA_m_ds_w5$adl_moving <- car::recode(ALSA_m_ds_w5$adl_moving, "c(991, 992, 993, 994, 995, 996, 997,998, 999)=NA")
#opal.assign.data(o, 'ALSA_m_ds_w5', ALSA_m_ds_w5)
#opal.symbol_import(o,'ALSA_m_ds_w5', project='_Athlos_Harm_Dataset')
```

```{r,  echo=FALSE}
adl_moving<- ALSA_ds_w5
...
kable(Categorical_summary(vari, missing_values = NA)[2], caption = attributes(vari)$`spss::shortName`)
kable(Categorical_summary(vari, missing_values = NA)[1], caption = "Category")
#Categorical_summary(ALSA_w6_adl_moving$ADLDF7W6)
ggplot(ALSA_w6_adl_moving, aes(x=factor(ADLDF7W6))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab("ADL - Moving around the home") + ylab("Frequency")
```
...
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[1], caption = "Category")
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[2], caption = "Type of missing")
#Categorical_summary(var = ALSA_ds_w6$adl_moving, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))
...
label(ALSA_ds_w6$adl_moving) <- "Difficulties for moving around the home"
...
ALSA_m_ds_w6$adl_moving <- car::recode(ALSA_m_ds_w6$adl_moving, "c(991, 992, 993, 994, 995, 996, 997,998, 999)=NA")
#opal.assign.data(o, 'ALSA_m_ds_w6', ALSA_m_ds_w6)
#opal.symbol_import(o,'ALSA_m_ds_w6', project='_Athlos_Harm_Dataset')
```

```{r,  echo=FALSE}
adl_moving<- ALSA_ds_w6
...
kable(Categorical_summary(vari, missing_values = NA)[2], caption = attributes(vari)$`spss::shortName`)
kable(Categorical_summary(vari, missing_values = NA)[1], caption = "Category")
#Categorical_summary(ALSA_w7_adl_moving$adldf7w7)
ggplot(ALSA_w7_adl_moving, aes(x=factor(adldf7w7))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab("ADL - Moving around the home") + ylab("Frequency")
```
...
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[1], caption = "Category")
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[2], caption = "Type of missing")
#Categorical_summary(var = ALSA_ds_w7$adl_moving, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))
...
label(ALSA_ds_w7$adl_moving) <- "Difficulties for moving around the home"
...
ALSA_m_ds_w7$adl_moving <- car::recode(ALSA_m_ds_w7$adl_moving, "c(991, 992, 993, 994, 995, 996, 997,998, 999)=NA")
#opal.assign.data(o, 'ALSA_m_ds_w7', ALSA_m_ds_w7)
#opal.symbol_import(o,'ALSA_m_ds_w7', project='_Athlos_Harm_Dataset')
```

```{r,  echo=FALSE}
adl_moving<- ALSA_ds_w7
...
* Name: `adlnd7w8`
* Label: `Difficulty moving aroud the home`
* Categories:
    + `1 = Yes ` 
    + `2 = No` 
* Missings
...
kable(Categorical_summary(vari, missing_values = NA)[2], caption = attributes(vari)$`spss::shortName`)
kable(Categorical_summary(vari, missing_values = NA)[1], caption = "Category")
#Categorical_summary(ALSA_w8_adl_moving$adlnd7w8)
ggplot(ALSA_w8_adl_moving, aes(x=factor(adlnd7w8))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab("ADL - Moving around the home") + ylab("Frequency")
```
...
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[1], caption = "Category")
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[2], caption = "Type of missing")
#Categorical_summary(var = ALSA_ds_w8$adl_moving, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))
...
label(ALSA_ds_w8$adl_moving) <- "Difficulties for moving around the home"
...
ALSA_m_ds_w8$adl_moving <- car::recode(ALSA_m_ds_w8$adl_moving, "c(991, 992, 993, 994, 995, 996, 997,998, 999)=NA")
#opal.assign.data(o, 'ALSA_m_ds_w8', ALSA_m_ds_w8)
#opal.symbol_import(o,'ALSA_m_ds_w8', project='_Athlos_Harm_Dataset')
```

```{r,  echo=FALSE}
adl_moving<- ALSA_ds_w8
save(adl_moving, file = paste0(datafolder, "/w8/adl_moving.RData"))
```
...
kable(Categorical_summary(vari, missing_values = NA)[2], caption = attributes(vari)$`spss::shortName`)
kable(Categorical_summary(vari, missing_values = NA)[1], caption = "Category")
#Categorical_summary(ALSA_w9_adl_moving$ADLDF7W9)
ggplot(ALSA_w9_adl_moving, aes(x=factor(ADLDF7W9))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab("ADL - Moving around the home") + ylab("Frequency")
```
...
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[1], caption = "Category")
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[2], caption = "Type of missing")
#Categorical_summary(var = ALSA_ds_w9$adl_moving, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))
...
label(ALSA_ds_w9$adl_moving) <- "Difficulties for moving around the home"
...
ALSA_m_ds_w9$adl_moving <- car::recode(ALSA_m_ds_w9$adl_moving, "c(991, 992, 993, 994, 995, 996, 997,998, 999)=NA")
#opal.assign.data(o, 'ALSA_m_ds_w9', ALSA_m_ds_w9)
#opal.symbol_import(o,'ALSA_m_ds_w9', project='_Athlos_Harm_Dataset')
```

```{r,  echo=FALSE}
adl_moving<- ALSA_ds_w9
save(adl_moving, file = paste0(datafolder, "/w9/adl_moving.RData"))
```
...
kable(Categorical_summary(vari, missing_values = NA)[2], caption = attributes(vari)$`spss::shortName`)
kable(Categorical_summary(vari, missing_values = NA)[1], caption = "Category")
#Categorical_summary(ALSA_w10_adl_moving$adlnd7w10)
ggplot(ALSA_w10_adl_moving, aes(x=factor(adlnd7w10))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab("ADL - Moving around the home") + ylab("Frequency")
```
...
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[1], caption = "Category")
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[2], caption = "Type of missing")
#Categorical_summary(var = ALSA_ds_w10$adl_moving, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))
...
label(ALSA_ds_w10$adl_moving) <- "Difficulties for moving around the home"
...
ALSA_m_ds_w10$adl_moving <- car::recode(ALSA_m_ds_w10$adl_moving, "c(991, 992, 993, 994, 995, 996, 997,998, 999)=NA")
#opal.assign.data(o, 'ALSA_m_ds_w10', ALSA_m_ds_w10)
#opal.symbol_import(o,'ALSA_m_ds_w10', project='_Athlos_Harm_Dataset')
```

```{r,  echo=FALSE}
adl_moving<- ALSA_ds_w10
save(adl_moving, file = paste0(datafolder, "/w10/adl_moving.RData"))
```
...
kable(Categorical_summary(vari, missing_values = NA)[2], caption = attributes(vari)$`spss::shortName`)
kable(Categorical_summary(vari, missing_values = NA)[1], caption = "Category")
#Categorical_summary(ALSA_w11_adl_moving$ADLDF7W11)
ggplot(ALSA_w11_adl_moving, aes(x=factor(ADLDF7W11))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab("ADL - Moving around the home") + ylab("Frequency")
```
...
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[1], caption = "Category")
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[2], caption = "Type of missing")
#Categorical_summary(var = ALSA_ds_w11$adl_moving, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))
...
label(ALSA_ds_w11$adl_moving) <- "Difficulties for moving around the home"
...
ALSA_m_ds_w11$adl_moving <- car::recode(ALSA_m_ds_w11$adl_moving, "c(991, 992, 993, 994, 995, 996, 997,998, 999)=NA")
#opal.assign.data(o, 'ALSA_m_ds_w11', ALSA_m_ds_w11)
#opal.symbol_import(o,'ALSA_m_ds_w11', project='_Athlos_Harm_Dataset')
```

```{r,  echo=FALSE}
adl_moving<- ALSA_ds_w11
save(adl_moving, file = paste0(datafolder, "/w11/adl_moving.RData"))
```
...
kable(Categorical_summary(vari, missing_values = NA)[2], caption = attributes(vari)$`spss::shortName`)
kable(Categorical_summary(vari, missing_values = NA)[1], caption = "Category")
#Categorical_summary(ALSA_w12_adl_moving$ADLDF7W12)
ggplot(ALSA_w12_adl_moving, aes(x=factor(ADLDF7W12))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab("ADL - Moving around the home") + ylab("Frequency")
```
...
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[1], caption = "Category")
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[2], caption = "Type of missing")
#Categorical_summary(var = ALSA_ds_w12$adl_moving, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))
...
label(ALSA_ds_w12$adl_moving) <- "Difficulties for moving around the home"
...
ALSA_m_ds_w12$adl_moving <- car::recode(ALSA_m_ds_w12$adl_moving, "c(991, 992, 993, 994, 995, 996, 997,998, 999)=NA")
#opal.assign.data(o, 'ALSA_m_ds_w12', ALSA_m_ds_w12)
#opal.symbol_import(o,'ALSA_m_ds_w12', project='_Athlos_Harm_Dataset')
```

```{r,  echo=FALSE}
adl_moving<- ALSA_ds_w12
save(adl_moving, file = paste0(datafolder, "/w12/adl_moving.RData"))
```
...
kable(Categorical_summary(vari, missing_values = NA)[2], caption = attributes(vari)$`spss::shortName`)
kable(Categorical_summary(vari, missing_values = NA)[1], caption = "Category")
#Categorical_summary(ALSA_w13_adl_moving$ADLDF7W13)
ggplot(ALSA_w13_adl_moving, aes(x=factor(ADLDF7W13))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab("ADL - Moving around the home") + ylab("Frequency")
```
...
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[1], caption = "Category")
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[2], caption = "Type of missing")
#Categorical_summary(var = ALSA_ds_w13$adl_moving, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))
...
label(ALSA_ds_w13$adl_moving) <- "Difficulties for moving around the home"
...
ALSA_m_ds_w13$adl_moving <- car::recode(ALSA_m_ds_w13$adl_moving, "c(991, 992, 993, 994, 995, 996, 997,998, 999)=NA")
#opal.assign.data(o, 'ALSA_m_ds_w13', ALSA_m_ds_w13)
#opal.symbol_import(o,'ALSA_m_ds_w13', project='_Athlos_Harm_Dataset')
```

```{r,  echo=FALSE}
adl_moving<- ALSA_ds_w13
save(adl_moving, file = paste0(datafolder, "/w13/adl_moving.RData"))
```
