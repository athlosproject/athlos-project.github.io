...
ALSA_w3 <- Add_indiv(old = ALSA_w3_yinter, new = ALSA_w3_id)
...
ALSA_ds_w3$yintw <- ALSA_w3$yinter
...
ALSA_ds_w7$yintw <- car::recode(ALSA_w7$yinter, "NA=2003")
...
BeforeH <- table(ALSA_w7$yinter, useNA = "ifany")
...
ALSA_ds_w9$yintw <- car::recode(ALSA_w9$Year, "NA=2008")
...
BeforeH <- table(ALSA_w9$Year, useNA = "ifany")
