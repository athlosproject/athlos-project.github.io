...
* Name: `STIL14W3`
* Label: `STILL MEMBER OF CHARITY GROUP?`
* Categories:
    + `1 = Yes`
    + `2 = No`
* Description:
...
#Categorical_summary(var = ALSA_w3_volun$MEMBER14, missing_values = NA)
...
kable(Categorical_summary(vari, missing_values = NA)[2], caption = attributes(vari)$`spss::shortName`)
kable(Categorical_summary(vari, missing_values = NA)[1], caption = "Category")
#Categorical_summary(var = ALSA_w3_volun$STIL14W3, missing_values = NA)
...
* `else if member=0 or STIL then 0` 
* `NA into 999`
...
#Categorical_summary(var = ALSA_ds_w3$volun, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))
...
It is not clear if the study-specific variables refer to an ever or current condition.
