...
ALSA_ds_w1$cvd_hard <- rep(999,length(ALSA_w1$id))
ALSA_ds_w1$cvd_hard[which(ALSA_w1$mi_ha==0 & ALSA_w1$stroke==0)] <- 0
ALSA_ds_w1$cvd_hard[which(ALSA_w1$mi_ha==1 | ALSA_w1$stroke==1)] <- 1
...
vbl <- ALSA_ds_w1$cvd_hard
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(ALSA_ds_w1, aes(x=factor(cvd_hard))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
...
AfterH <- table(ALSA_ds_w1$cvd_hard, useNA = "ifany")
X <- c(
...
ALSA_ds_w3$cvd_hard <- rep(999,length(ALSA_w3$id))
ALSA_ds_w3$cvd_hard[which(ALSA_w3$mi_ha==0 & ALSA_w3$stroke==0)] <- 0
ALSA_ds_w3$cvd_hard[which(ALSA_w3$mi_ha==1 | ALSA_w3$stroke==1)] <- 1
...
vbl <- ALSA_ds_w3$cvd_hard
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(ALSA_ds_w3, aes(x=factor(cvd_hard))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
...
AfterH <- table(ALSA_ds_w3$cvd_hard, useNA = "ifany")
X <- c(
...
ALSA_ds_w6$cvd_hard <- rep(999,length(ALSA_w6$id))
ALSA_ds_w6$cvd_hard[which(ALSA_w6$mi_ha==0 & ALSA_w6$stroke==0)] <- 0
ALSA_ds_w6$cvd_hard[which(ALSA_w6$mi_ha==1 | ALSA_w6$stroke==1)] <- 1
...
vbl <- ALSA_ds_w6$cvd_hard
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(ALSA_ds_w6, aes(x=factor(cvd_hard))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
...
AfterH <- table(ALSA_ds_w6$cvd_hard, useNA = "ifany")
X <- c(
  sum(ALSA_w6$mi_ha==0 & ALSA_w6$stroke==0,na.rm=T),
  sum(ALSA_w6$mi_ha==1 | ALSA_w6$stroke==1,na.rm=T)
)
...
ALSA_ds_w11$cvd_hard <- rep(999,length(ALSA_w11$id))
ALSA_ds_w11$cvd_hard[which(ALSA_w11$mi_ha==0 & ALSA_w11$stroke==0)] <- 0
ALSA_ds_w11$cvd_hard[which(ALSA_w11$mi_ha==1 | ALSA_w11$stroke==1)] <- 1
...
vbl <- ALSA_ds_w11$cvd_hard
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(ALSA_ds_w11, aes(x=factor(cvd_hard))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
...
AfterH <- table(ALSA_ds_w11$cvd_hard, useNA = "ifany")
X <- c(
  sum(ALSA_w11$mi_ha==0 & ALSA_w11$stroke==0,na.rm=T),
  sum(ALSA_w11$mi_ha==1 | ALSA_w11$stroke==1,na.rm=T)
)
...
ALSA_ds_w12$cvd_hard <- rep(999,length(ALSA_w12$id))
ALSA_ds_w12$cvd_hard[which(ALSA_w12$mi_ha==0 & ALSA_w12$stroke==0)] <- 0
ALSA_ds_w12$cvd_hard[which(ALSA_w12$mi_ha==1 | ALSA_w12$stroke==1)] <- 1
...
vbl <- ALSA_ds_w12$cvd_hard
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(ALSA_ds_w12, aes(x=factor(cvd_hard))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
...
AfterH <- table(ALSA_ds_w12$cvd_hard, useNA = "ifany")
X <- c(
  sum(ALSA_w12$mi_ha==0 & ALSA_w12$stroke==0,na.rm=T),
  sum(ALSA_w12$mi_ha==1 | ALSA_w12$stroke==1,na.rm=T)
)
...
```{r summ}
ALSA_ds_w1$cvd_hard <- labelled(ALSA_ds_w1$cvd_hard, labels = cat_label)
label(ALSA_ds_w1$cvd_hard) <- ds_label
ALSA_ds_w3$cvd_hard <- labelled(ALSA_ds_w3$cvd_hard, labels = cat_label)
label(ALSA_ds_w3$cvd_hard) <- ds_label
ALSA_ds_w6$cvd_hard <- labelled(ALSA_ds_w6$cvd_hard, labels = cat_label)
label(ALSA_ds_w6$cvd_hard) <- ds_label
ALSA_ds_w11$cvd_hard <- labelled(ALSA_ds_w11$cvd_hard, labels = cat_label)
label(ALSA_ds_w11$cvd_hard) <- ds_label
ALSA_ds_w12$cvd_hard <- labelled(ALSA_ds_w12$cvd_hard, labels = cat_label)
label(ALSA_ds_w12$cvd_hard) <- ds_label

ALSA_m_ds_w1 <- ALSA_ds_w1
ALSA_m_ds_w1$cvd_hard <- car::recode(ALSA_m_ds_w1$cvd_hard, "miss_values_vector=NA")
ALSA_m_ds_w3 <- ALSA_ds_w3
ALSA_m_ds_w3$cvd_hard <- car::recode(ALSA_m_ds_w3$cvd_hard, "miss_values_vector=NA")
ALSA_m_ds_w6 <- ALSA_ds_w6
ALSA_m_ds_w6$cvd_hard <- car::recode(ALSA_m_ds_w6$cvd_hard, "miss_values_vector=NA")
ALSA_m_ds_w11 <- ALSA_ds_w11
ALSA_m_ds_w11$cvd_hard <- car::recode(ALSA_m_ds_w11$cvd_hard, "miss_values_vector=NA")
ALSA_m_ds_w12 <- ALSA_ds_w12
ALSA_m_ds_w12$cvd_hard <- car::recode(ALSA_m_ds_w12$cvd_hard, "miss_values_vector=NA")

tt <-    frq(ALSA_ds_w1$cvd_hard)[[1]][,c(1:2,4)]
tt[4] <- frq(ALSA_ds_w3$cvd_hard)[[1]][,c(4)]
tt[5] <- frq(ALSA_ds_w6$cvd_hard)[[1]][,c(4)]
tt[6] <- frq(ALSA_ds_w11$cvd_hard)[[1]][,c(4)]
tt[7] <- frq(ALSA_ds_w12$cvd_hard)[[1]][,c(4)]
tt[13,] <- c("n", "sample size", 
             length(ALSA_ds_w1$cvd_hard), length(ALSA_ds_w3$cvd_hard), length(ALSA_ds_w6$cvd_hard), 
             length(ALSA_ds_w11$cvd_hard), length(ALSA_ds_w12$cvd_hard)
             )
names(tt)<-c("val", "label", "w1", "w3", "w6", "w11", "w12")
kable(tt)

dbb <- merge(ALSA_m_ds_w1[,c("id","cvd_hard")], ALSA_m_ds_w3[,c("id","cvd_hard")], by="id", suffixes = c(".w1",".w3"), all=T)
dbb <- merge(dbb, ALSA_m_ds_w6[,c("id","cvd_hard")], by="id", all=T)
dbb <- merge(dbb, ALSA_m_ds_w11[,c("id","cvd_hard")], by="id", suffixes = c(".w6",".w11"), all=T)
dbb <- merge(dbb, ALSA_m_ds_w12[,c("id","cvd_hard")], by="id", all=T)
...
The harmonized variable contains information about MI_HA and stroke. The harmonized variable has been built from the single disease variables. 
...
for(index in seq_along(l.ALSA)){
  cvd_hard <- l.ALSA[[index]]
  save(cvd_hard, file = paste0(datafolder,names(l.ALSA)[index],"/cvd_hard.RData"))
}
