...
opal.assign.table.tibble(o, 't1066_cuba_w1','10-66.1066-Cuba-Baseline', variables=list('PSMKNOW'), missings = TRUE)
...
X<-table(t1066_cuba_w1$PSMKNOW)
BeforeH <- c(X,sum(is.na(t1066_cuba_w1$PSMKNOW)))
...
opal.assign.table.tibble(o, 't1066_india_w1','10-66.1066-India-Baseline', variables=list('PSMKNOW'), missings = TRUE)
...
X<-table(t1066_india_w1$PSMKNOW)
BeforeH <- c(X,sum(is.na(t1066_india_w1$PSMKNOW)))
C <- rbind(BeforeH,AfterH)
colnames(C) <- c("0->0","1->1","NA->999") 
kable(C)
```
...
opal.assign.table.tibble(o, 't1066_UCh_w1','10-66.1066-UrbanChina-Baseline', variables=list('PSMKNOW'), missings = TRUE)
...
X<-table(t1066_UCh_w1$PSMKNOW)
BeforeH <- c(X,sum(is.na(t1066_UCh_w1$PSMKNOW)))
C <- rbind(BeforeH,AfterH)
colnames(C) <- c("0->0","1->1","NA->999") 
kable(C)
```
...
opal.assign.table.tibble(o, 't1066_RCh_w1','10-66.1066-RuralChina-Baseline', variables=list('PSMKNOW'), missings = TRUE)
...
X<-table(t1066_RCh_w1$PSMKNOW)
BeforeH <- c(X,sum(is.na(t1066_RCh_w1$PSMKNOW)))
C <- rbind(BeforeH,AfterH)
colnames(C) <- c("0->0","1->1","NA->999") 
kable(C)
```
...
opal.assign.table.tibble(o, 't1066_DR_w1','10-66.1066-DominicanRepublic-Baseline', variables=list('PSMKNOW'), missings = TRUE)
...
X<-table(t1066_DR_w1$PSMKNOW)
BeforeH <- c(X,sum(is.na(t1066_DR_w1$PSMKNOW)))
C <- rbind(BeforeH,AfterH)
colnames(C) <- c("0->0","1->1","NA->999") 
kable(C)
```
...
opal.assign.table.tibble(o, 't1066_Ven_w1','10-66.1066-Venezuela-Baseline', variables=list('PSMKNOW'), missings = TRUE)
...
X<-table(t1066_Ven_w1$PSMKNOW)
BeforeH <- c(X,sum(is.na(t1066_Ven_w1$PSMKNOW)))
C <- rbind(BeforeH,AfterH)
colnames(C) <- c("0->0","1->1","NA->999") 
kable(C)
```
...
opal.assign.table.tibble(o, 't1066_UP_w1','10-66.1066-UrbanPeru-Baseline', variables=list('PSMKNOW'), missings = TRUE)
...
X<-table(t1066_UP_w1$PSMKNOW)
BeforeH <- c(X,sum(is.na(t1066_UP_w1$PSMKNOW)))
C <- rbind(BeforeH,AfterH)
colnames(C) <- c("0->0","1->1","NA->999") 
kable(C)
```
...
opal.assign.table.tibble(o, 't1066_RP_w1','10-66.1066-RuralPeru-Baseline', variables=list('PSMKNOW'), missings = TRUE)
...
X<-table(t1066_RP_w1$PSMKNOW)
BeforeH <- c(X, sum(is.na(t1066_RP_w1$PSMKNOW)))
C <- rbind(BeforeH,AfterH)
colnames(C) <- c("0->0","1->1","NA->999") 
kable(C)
```
...
opal.assign.table.tibble(o, 't1066_UM_w1','10-66.1066-UrbanMexico-Baseline', variables=list('PSMKNOW'), missings = TRUE)
...
X<-table(t1066_UM_w1$PSMKNOW)
BeforeH <- c(X,sum(is.na(t1066_UM_w1$PSMKNOW)))
C <- rbind(BeforeH,AfterH)
colnames(C) <- c("0->0","1->1","NA->999") 
kable(C)
```
...
opal.assign.table.tibble(o, 't1066_RM_w1','10-66.1066-RuralMexico-Baseline', variables=list('PSMKNOW'), missings = TRUE)
...
X<-table(t1066_RM_w1$PSMKNOW)
BeforeH <- c(X,sum(is.na(t1066_RM_w1$PSMKNOW)))
C <- rbind(BeforeH,AfterH)
colnames(C) <- c("0->0","1->1","NA->999") 
kable(C)
```
...
opal.assign.table.tibble(o, 't1066_PR_w1','10-66.1066-PuertoRico-Baseline', variables=list('PSMKNOW'), missings = TRUE)
...
X<-table(t1066_PR_w1$PSMKNOW)
BeforeH <- c(X, sum(is.na(t1066_PR_w1$PSMKNOW)))
C <- rbind(BeforeH,AfterH)
colnames(C) <- c("0->0","1->1","NA->999") 
kable(C)
```
