...
```{r main, child='../../_DS_Rmd/anxietyDS.Rmd'}
```
```{r global, echo=F}
source('../../_DS_Rmd/anxietyDS.R')
```
...
ggplot(t1066_as, aes(x=factor(t1066_as[[2]]))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(label(vari)) + ylab("Frequency")
```
