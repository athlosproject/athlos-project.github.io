...
| **Name** | `h10i` |
|-|-|
| **Label** | `Diagnosed/hospitalised for asthma`|
...
opal.assign.table.tibble(o, 'HAPIEE_pol_w1','HAPIEE.Po_baseline_etic',variables=list('h10i'), missings = T)
...
HAPIEE_ds_pol_w1$h_asthma <- car::recode(HAPIEE_pol_w1$h10i, "yes_vector=1; 'No or do not know'=0;9=999;NA=999")
...
vbl <- HAPIEE_ds_pol_w1$h_asthma
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(HAPIEE_ds_pol_w1, aes(x=factor(h_asthma))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
...
AfterH <- table(HAPIEE_ds_pol_w1$h_asthma, useNA = "ifany")
X <- table(HAPIEE_pol_w1$h10i, useNA = "ifany")
...
opal.assign.table.tibble(o, 'HAPIEE_cz_w1','HAPIEE.Cz_baseline_etic',variables=list('h10i'), missings = T)
...
HAPIEE_ds_cz_w1$h_asthma <- car::recode(HAPIEE_cz_w1$h10i, "yes_vector=1; 'No or do not know'=0;9=999;NA=999")
...
vbl <- HAPIEE_ds_cz_w1$h_asthma
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(HAPIEE_ds_cz_w1, aes(x=factor(h_asthma))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
...
AfterH <- table(HAPIEE_ds_cz_w1$h_asthma, useNA = "ifany")
X <- table(HAPIEE_cz_w1$h10i, useNA = "ifany")
...
opal.assign.table.tibble(o, 'HAPIEE_li_w1','HAPIEE.Li_baseline_etic',variables=list('h10i'), missings = T)
...
HAPIEE_ds_li_w1$h_asthma <- car::recode(HAPIEE_li_w1$h10i, "yes_vector=1;'No or do not know'=0; NA=999")
...
vbl <- HAPIEE_ds_li_w1$h_asthma
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(HAPIEE_ds_li_w1, aes(x=factor(h_asthma))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
...
AfterH <- table(HAPIEE_ds_li_w1$h_asthma, useNA = "ifany")
X <- table(HAPIEE_li_w1$h10i, useNA = "ifany")
BeforeH <- c(X[1],sum(X[2:3]), X[4])
C <- rbind(BeforeH,AfterH)
colnames(C) <- c("No->0","some Yes->1","NA->999")
kable(C)
