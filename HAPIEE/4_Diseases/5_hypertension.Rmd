...
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(HAPIEE_ds_pol_w2 %>% filter(!vbl %in% miss_values_vector), aes(h_hypertension_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")
...
kable(frq(HAPIEE_pol_w2$h_hypertension[which(HAPIEE_pol_w2$w2h14=='no')]), align = 'c')
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(HAPIEE_ds_cz_w2 %>% filter(!vbl %in% miss_values_vector), aes(h_hypertension_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")
...
kable(frq(HAPIEE_cz_w2$h_hypertension[which(HAPIEE_cz_w2$w2h14=='no')]), align = 'c')
