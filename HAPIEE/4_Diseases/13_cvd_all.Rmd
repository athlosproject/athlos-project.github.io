...
HAPIEE_ds_pol_w1$cvd_all <- rep(999,length(HAPIEE_pol_w1$id))
HAPIEE_ds_pol_w1$cvd_all[which(HAPIEE_pol_w1$stroke==0 & HAPIEE_pol_w1$h_angina==0 & HAPIEE_pol_w1$mi_ha==0)] <- 0
HAPIEE_ds_pol_w1$cvd_all[which(HAPIEE_pol_w1$stroke==1 | HAPIEE_pol_w1$h_angina==1 | HAPIEE_pol_w1$mi_ha==1)] <- 1
...
vbl <- HAPIEE_ds_pol_w1$cvd_all
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(HAPIEE_ds_pol_w1, aes(x=factor(cvd_all))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
...
AfterH <- table(HAPIEE_ds_pol_w1$cvd_all, useNA = "ifany")
X <- c(
...
HAPIEE_ds_cz_w1$cvd_all <- rep(999,length(HAPIEE_cz_w1$id))
HAPIEE_ds_cz_w1$cvd_all[which(HAPIEE_cz_w1$stroke==0 & HAPIEE_cz_w1$h_angina==0 & HAPIEE_cz_w1$mi_ha==0)] <- 0
HAPIEE_ds_cz_w1$cvd_all[which(HAPIEE_cz_w1$stroke==1 | HAPIEE_cz_w1$h_angina==1 | HAPIEE_cz_w1$mi_ha==1)] <- 1
...
vbl <- HAPIEE_ds_cz_w1$cvd_all
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(HAPIEE_ds_cz_w1, aes(x=factor(cvd_all))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
...
AfterH <- table(HAPIEE_ds_cz_w1$cvd_all, useNA = "ifany")
X <- c(
...
HAPIEE_ds_li_w1$cvd_all <- rep(999,length(HAPIEE_li_w1$id))
HAPIEE_ds_li_w1$cvd_all[which(HAPIEE_li_w1$stroke==0 & HAPIEE_li_w1$h_angina==0)] <- 0
HAPIEE_ds_li_w1$cvd_all[which(HAPIEE_li_w1$stroke==1 | HAPIEE_li_w1$h_angina==1)] <- 1
...
vbl <- HAPIEE_ds_li_w1$cvd_all
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(HAPIEE_ds_li_w1, aes(x=factor(cvd_all))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
...
AfterH <- table(HAPIEE_ds_li_w1$cvd_all, useNA = "ifany")
X <- c(
