...
if(length(l.hds)>0){
  ...
  lmlist <- labelling(lmlist[[1]],lmlist[[2]],hd_freq_vbl,ds_label_freq)
...
if(length(l.hds)>0){
  ...
  # Printing table of categories
  print(knitr::kable(summaries(lmlist[[1]],lmlist[[2]],lapply(l.hds,function(x)x[[2]]),hd_freq_vbl),caption=ds_label_freq))
}
