...
HRS_ds_hrs_w2$h_cpd_age[which(HRS_ds_hrs_w2$h_cpd == 1 & HRS_hrs_w2$h_cpd==0 & !HRS_hrs_w2$ybirth %in% miss_values_vector)] <- (HRS_hrs_w2$yintw_hrs_w2[which(HRS_ds_hrs_w2$h_cpd == 1 & HRS_hrs_w2$h_cpd==0 & !HRS_hrs_w2$ybirth %in% miss_values_vector)]+HRS_hrs_w2$yintw_hrs_w1[which(HRS_ds_hrs_w2$h_cpd == 1 & HRS_hrs_w2$h_cpd==0 & !HRS_hrs_w2$ybirth %in% miss_values_vector)])/2-HRS_hrs_w2$ybirth[which(HRS_ds_hrs_w2$h_cpd == 1 & HRS_hrs_w2$h_cpd==0 & !HRS_hrs_w2$ybirth %in% miss_values_vector)]
...
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(HRS_ds_hrs_w2, aes(h_cpd_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")+xlim(35,80)
...
HRS_ds_hrs_w3$h_cpd_age[which(HRS_ds_hrs_w3$h_cpd == 1 & HRS_hrs_w3$h_cpd==0 & !HRS_hrs_w3$ybirth %in% miss_values_vector)] <- (HRS_hrs_w3$yintw_hrs_w3[which(HRS_ds_hrs_w3$h_cpd == 1 & HRS_hrs_w3$h_cpd==0 & !HRS_hrs_w3$ybirth %in% miss_values_vector)]+HRS_hrs_w3$yintw_hrs_w2[which(HRS_ds_hrs_w3$h_cpd == 1 & HRS_hrs_w3$h_cpd==0 & !HRS_hrs_w3$ybirth %in% miss_values_vector)])/2-HRS_hrs_w3$ybirth[which(HRS_ds_hrs_w3$h_cpd == 1 & HRS_hrs_w3$h_cpd==0 & !HRS_hrs_w3$ybirth %in% miss_values_vector)]
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(HRS_ds_hrs_w3, aes(h_cpd_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")+xlim(35,90)
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(HRS_ds_hrs_w4, aes(h_cpd_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")+xlim(25,90)
...
HRS_ds_hrs_w5$h_cpd_age[which(HRS_ds_hrs_w5$h_cpd == 1 & HRS_hrs_w5$h_cpd==0 & !HRS_hrs_w5$ybirth %in% miss_values_vector)] <- (HRS_hrs_w5$yintw_hrs_w5[which(HRS_ds_hrs_w5$h_cpd == 1 & HRS_hrs_w5$h_cpd==0 & !HRS_hrs_w5$ybirth %in% miss_values_vector)]+HRS_hrs_w5$yintw_hrs_w4[which(HRS_ds_hrs_w5$h_cpd == 1 & HRS_hrs_w5$h_cpd==0 & !HRS_hrs_w5$ybirth %in% miss_values_vector)])/2-HRS_hrs_w5$ybirth[which(HRS_ds_hrs_w5$h_cpd == 1 & HRS_hrs_w5$h_cpd==0 & !HRS_hrs_w5$ybirth %in% miss_values_vector)]
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(HRS_ds_hrs_w5, aes(h_cpd_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")+xlim(25,85)
...
HRS_ds_hrs_w6$h_cpd_age[which(HRS_ds_hrs_w6$h_cpd == 1 & HRS_hrs_w6$h_cpd==0 & !HRS_hrs_w6$ybirth %in% miss_values_vector)] <- (HRS_hrs_w6$yintw_hrs_w6[which(HRS_ds_hrs_w6$h_cpd == 1 & HRS_hrs_w6$h_cpd==0 & !HRS_hrs_w6$ybirth %in% miss_values_vector)]+HRS_hrs_w6$yintw_hrs_w5[which(HRS_ds_hrs_w6$h_cpd == 1 & HRS_hrs_w6$h_cpd==0 & !HRS_hrs_w6$ybirth %in% miss_values_vector)])/2-HRS_hrs_w6$ybirth[which(HRS_ds_hrs_w6$h_cpd == 1 & HRS_hrs_w6$h_cpd==0 & !HRS_hrs_w6$ybirth %in% miss_values_vector)]
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(HRS_ds_hrs_w6, aes(h_cpd_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")+xlim(25,85)
...
HRS_ds_hrs_w7$h_cpd_age[which(HRS_ds_hrs_w7$h_cpd == 1 & HRS_hrs_w7$h_cpd==0 & !HRS_hrs_w7$ybirth %in% miss_values_vector)] <- (HRS_hrs_w7$yintw_hrs_w7[which(HRS_ds_hrs_w7$h_cpd == 1 & HRS_hrs_w7$h_cpd==0 & !HRS_hrs_w7$ybirth %in% miss_values_vector)]+HRS_hrs_w7$yintw_hrs_w6[which(HRS_ds_hrs_w7$h_cpd == 1 & HRS_hrs_w7$h_cpd==0 & !HRS_hrs_w7$ybirth %in% miss_values_vector)])/2-HRS_hrs_w7$ybirth[which(HRS_ds_hrs_w7$h_cpd == 1 & HRS_hrs_w7$h_cpd==0 & !HRS_hrs_w7$ybirth %in% miss_values_vector)]
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(HRS_ds_hrs_w7, aes(h_cpd_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")+xlim(30,90)
...
HRS_ds_hrs_w8$h_cpd_age[which(HRS_ds_hrs_w8$h_cpd == 1 & HRS_hrs_w8$h_cpd==0 & !HRS_hrs_w8$ybirth %in% miss_values_vector)] <- (HRS_hrs_w8$yintw_hrs_w8[which(HRS_ds_hrs_w8$h_cpd == 1 & HRS_hrs_w8$h_cpd==0 & !HRS_hrs_w8$ybirth %in% miss_values_vector)]+HRS_hrs_w8$yintw_hrs_w7[which(HRS_ds_hrs_w8$h_cpd == 1 & HRS_hrs_w8$h_cpd==0 & !HRS_hrs_w8$ybirth %in% miss_values_vector)])/2-HRS_hrs_w8$ybirth[which(HRS_ds_hrs_w8$h_cpd == 1 & HRS_hrs_w8$h_cpd==0 & !HRS_hrs_w8$ybirth %in% miss_values_vector)]
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(HRS_ds_hrs_w8, aes(h_cpd_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")+xlim(30,90)
...
HRS_ds_hrs_w9$h_cpd_age[which(HRS_ds_hrs_w9$h_cpd == 1 & HRS_hrs_w9$h_cpd==0 & !HRS_hrs_w9$ybirth %in% miss_values_vector)] <- (HRS_hrs_w9$yintw_hrs_w9[which(HRS_ds_hrs_w9$h_cpd == 1 & HRS_hrs_w9$h_cpd==0 & !HRS_hrs_w9$ybirth %in% miss_values_vector)]+HRS_hrs_w9$yintw_hrs_w8[which(HRS_ds_hrs_w9$h_cpd == 1 & HRS_hrs_w9$h_cpd==0 & !HRS_hrs_w9$ybirth %in% miss_values_vector)])/2-HRS_hrs_w9$ybirth[which(HRS_ds_hrs_w9$h_cpd == 1 & HRS_hrs_w9$h_cpd==0 & !HRS_hrs_w9$ybirth %in% miss_values_vector)]
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(HRS_ds_hrs_w9, aes(h_cpd_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")+xlim(30,90)
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(HRS_ds_hrs_w10, aes(h_cpd_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")+xlim(30,95)
...
HRS_ds_hrs_w11$h_cpd_age[which(HRS_ds_hrs_w11$h_cpd == 1 & HRS_hrs_w11$h_cpd==0 & !HRS_hrs_w11$ybirth %in% miss_values_vector)] <- (HRS_hrs_w11$yintw_hrs_w11[which(HRS_ds_hrs_w11$h_cpd == 1 & HRS_hrs_w11$h_cpd==0 & !HRS_hrs_w11$ybirth %in% miss_values_vector)]+HRS_hrs_w11$yintw_hrs_w10[which(HRS_ds_hrs_w11$h_cpd == 1 & HRS_hrs_w11$h_cpd==0 & !HRS_hrs_w11$ybirth %in% miss_values_vector)])/2-HRS_hrs_w11$ybirth[which(HRS_ds_hrs_w11$h_cpd == 1 & HRS_hrs_w11$h_cpd==0 & !HRS_hrs_w11$ybirth %in% miss_values_vector)]
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(HRS_ds_hrs_w11, aes(h_cpd_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")+xlim(30,95)
...
HRS_ds_ahead_w3$h_cpd_age[which(HRS_ds_ahead_w3$h_cpd == 1 & HRS_ahead_w3$h_cpd==0 & !HRS_ahead_w3$ybirth %in% miss_values_vector)] <- (HRS_ahead_w3$yintw_ahead_w3[which(HRS_ds_ahead_w3$h_cpd == 1 & HRS_ahead_w3$h_cpd==0 & !HRS_ahead_w3$ybirth %in% miss_values_vector)]+HRS_ahead_w3$yintw_ahead_w2[which(HRS_ds_ahead_w3$h_cpd == 1 & HRS_ahead_w3$h_cpd==0 & !HRS_ahead_w3$ybirth %in% miss_values_vector)])/2-HRS_ahead_w3$ybirth[which(HRS_ds_ahead_w3$h_cpd == 1 & HRS_ahead_w3$h_cpd==0 & !HRS_ahead_w3$ybirth %in% miss_values_vector)]
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(HRS_ds_ahead_w3, aes(h_cpd_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")+xlim(45,105)
...
HRS_ds_ahead_w4$h_cpd_age[which(HRS_ds_ahead_w4$h_cpd == 1 & HRS_ahead_w4$h_cpd==0 & !HRS_ahead_w4$ybirth %in% miss_values_vector)] <- (HRS_ahead_w4$yintw_ahead_w4[which(HRS_ds_ahead_w4$h_cpd == 1 & HRS_ahead_w4$h_cpd==0 & !HRS_ahead_w4$ybirth %in% miss_values_vector)]+HRS_ahead_w4$yintw_ahead_w3[which(HRS_ds_ahead_w4$h_cpd == 1 & HRS_ahead_w4$h_cpd==0 & !HRS_ahead_w4$ybirth %in% miss_values_vector)])/2-HRS_ahead_w4$ybirth[which(HRS_ds_ahead_w4$h_cpd == 1 & HRS_ahead_w4$h_cpd==0 & !HRS_ahead_w4$ybirth %in% miss_values_vector)]
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(HRS_ds_ahead_w4, aes(h_cpd_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")+xlim(45,105)
...
HRS_ds_ahead_w5$h_cpd_age[which(HRS_ds_ahead_w5$h_cpd == 1 & HRS_ahead_w5$h_cpd==0 & !HRS_ahead_w5$ybirth %in% miss_values_vector)] <- (HRS_ahead_w5$yintw_ahead_w5[which(HRS_ds_ahead_w5$h_cpd == 1 & HRS_ahead_w5$h_cpd==0 & !HRS_ahead_w5$ybirth %in% miss_values_vector)]+HRS_ahead_w5$yintw_ahead_w4[which(HRS_ds_ahead_w5$h_cpd == 1 & HRS_ahead_w5$h_cpd==0 & !HRS_ahead_w5$ybirth %in% miss_values_vector)])/2-HRS_ahead_w5$ybirth[which(HRS_ds_ahead_w5$h_cpd == 1 & HRS_ahead_w5$h_cpd==0 & !HRS_ahead_w5$ybirth %in% miss_values_vector)]
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(HRS_ds_ahead_w5, aes(h_cpd_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")+xlim(45,105)
...
HRS_ds_ahead_w6$h_cpd_age[which(HRS_ds_ahead_w6$h_cpd == 1 & HRS_ahead_w6$h_cpd==0 & !HRS_ahead_w6$ybirth %in% miss_values_vector)] <- (HRS_ahead_w6$yintw_ahead_w6[which(HRS_ds_ahead_w6$h_cpd == 1 & HRS_ahead_w6$h_cpd==0 & !HRS_ahead_w6$ybirth %in% miss_values_vector)]+HRS_ahead_w6$yintw_ahead_w5[which(HRS_ds_ahead_w6$h_cpd == 1 & HRS_ahead_w6$h_cpd==0 & !HRS_ahead_w6$ybirth %in% miss_values_vector)])/2-HRS_ahead_w6$ybirth[which(HRS_ds_ahead_w6$h_cpd == 1 & HRS_ahead_w6$h_cpd==0 & !HRS_ahead_w6$ybirth %in% miss_values_vector)]
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(HRS_ds_ahead_w6, aes(h_cpd_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")+xlim(45,105)
...
HRS_ds_ahead_w7$h_cpd_age[which(HRS_ds_ahead_w7$h_cpd == 1 & HRS_ahead_w7$h_cpd==0 & !HRS_ahead_w7$ybirth %in% miss_values_vector)] <- (HRS_ahead_w7$yintw_ahead_w7[which(HRS_ds_ahead_w7$h_cpd == 1 & HRS_ahead_w7$h_cpd==0 & !HRS_ahead_w7$ybirth %in% miss_values_vector)]+HRS_ahead_w7$yintw_ahead_w6[which(HRS_ds_ahead_w7$h_cpd == 1 & HRS_ahead_w7$h_cpd==0 & !HRS_ahead_w7$ybirth %in% miss_values_vector)])/2-HRS_ahead_w7$ybirth[which(HRS_ds_ahead_w7$h_cpd == 1 & HRS_ahead_w7$h_cpd==0 & !HRS_ahead_w7$ybirth %in% miss_values_vector)]
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(HRS_ds_ahead_w7, aes(h_cpd_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")+xlim(45,100)
...
HRS_ds_ahead_w8$h_cpd_age[which(HRS_ds_ahead_w8$h_cpd == 1 & HRS_ahead_w8$h_cpd==0 & !HRS_ahead_w8$ybirth %in% miss_values_vector)] <- (HRS_ahead_w8$yintw_ahead_w8[which(HRS_ds_ahead_w8$h_cpd == 1 & HRS_ahead_w8$h_cpd==0 & !HRS_ahead_w8$ybirth %in% miss_values_vector)]+HRS_ahead_w8$yintw_ahead_w7[which(HRS_ds_ahead_w8$h_cpd == 1 & HRS_ahead_w8$h_cpd==0 & !HRS_ahead_w8$ybirth %in% miss_values_vector)])/2-HRS_ahead_w8$ybirth[which(HRS_ds_ahead_w8$h_cpd == 1 & HRS_ahead_w8$h_cpd==0 & !HRS_ahead_w8$ybirth %in% miss_values_vector)]
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(HRS_ds_ahead_w8, aes(h_cpd_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")+xlim(45,100)
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(HRS_ds_ahead_w9, aes(h_cpd_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")+xlim(45,105)
...
HRS_ds_ahead_w10$h_cpd_age[which(HRS_ds_ahead_w10$h_cpd == 1 & HRS_ahead_w10$h_cpd==0 & !HRS_ahead_w10$ybirth %in% miss_values_vector)] <- (HRS_ahead_w10$yintw_ahead_w10[which(HRS_ds_ahead_w10$h_cpd == 1 & HRS_ahead_w10$h_cpd==0 & !HRS_ahead_w10$ybirth %in% miss_values_vector)]+HRS_ahead_w10$yintw_ahead_w9[which(HRS_ds_ahead_w10$h_cpd == 1 & HRS_ahead_w10$h_cpd==0 & !HRS_ahead_w10$ybirth %in% miss_values_vector)])/2-HRS_ahead_w10$ybirth[which(HRS_ds_ahead_w10$h_cpd == 1 & HRS_ahead_w10$h_cpd==0 & !HRS_ahead_w10$ybirth %in% miss_values_vector)]
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(HRS_ds_ahead_w10, aes(h_cpd_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")+xlim(45,100)
...
HRS_ds_ahead_w11$h_cpd_age[which(HRS_ds_ahead_w11$h_cpd == 1 & HRS_ahead_w11$h_cpd==0 & !HRS_ahead_w11$ybirth %in% miss_values_vector)] <- (HRS_ahead_w11$yintw_ahead_w11[which(HRS_ds_ahead_w11$h_cpd == 1 & HRS_ahead_w11$h_cpd==0 & !HRS_ahead_w11$ybirth %in% miss_values_vector)]+HRS_ahead_w11$yintw_ahead_w10[which(HRS_ds_ahead_w11$h_cpd == 1 & HRS_ahead_w11$h_cpd==0 & !HRS_ahead_w11$ybirth %in% miss_values_vector)])/2-HRS_ahead_w11$ybirth[which(HRS_ds_ahead_w11$h_cpd == 1 & HRS_ahead_w11$h_cpd==0 & !HRS_ahead_w11$ybirth %in% miss_values_vector)]
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(HRS_ds_ahead_w11, aes(h_cpd_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")+xlim(45,105)
...
HRS_ds_coda_w5$h_cpd_age[which(HRS_ds_coda_w5$h_cpd == 1 & HRS_coda_w5$h_cpd==0 & !HRS_coda_w5$ybirth %in% miss_values_vector)] <- (HRS_coda_w5$yintw_coda_w5[which(HRS_ds_coda_w5$h_cpd == 1 & HRS_coda_w5$h_cpd==0 & !HRS_coda_w5$ybirth %in% miss_values_vector)]+HRS_coda_w5$yintw_coda_w4[which(HRS_ds_coda_w5$h_cpd == 1 & HRS_coda_w5$h_cpd==0 & !HRS_coda_w5$ybirth %in% miss_values_vector)])/2-HRS_coda_w5$ybirth[which(HRS_ds_coda_w5$h_cpd == 1 & HRS_coda_w5$h_cpd==0 & !HRS_coda_w5$ybirth %in% miss_values_vector)]
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(HRS_ds_coda_w5, aes(h_cpd_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")+xlim(45,80)
...
HRS_ds_coda_w6$h_cpd_age[which(HRS_ds_coda_w6$h_cpd == 1 & HRS_coda_w6$h_cpd==0 & !HRS_coda_w6$ybirth %in% miss_values_vector)] <- (HRS_coda_w6$yintw_coda_w6[which(HRS_ds_coda_w6$h_cpd == 1 & HRS_coda_w6$h_cpd==0 & !HRS_coda_w6$ybirth %in% miss_values_vector)]+HRS_coda_w6$yintw_coda_w5[which(HRS_ds_coda_w6$h_cpd == 1 & HRS_coda_w6$h_cpd==0 & !HRS_coda_w6$ybirth %in% miss_values_vector)])/2-HRS_coda_w6$ybirth[which(HRS_ds_coda_w6$h_cpd == 1 & HRS_coda_w6$h_cpd==0 & !HRS_coda_w6$ybirth %in% miss_values_vector)]
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(HRS_ds_coda_w6, aes(h_cpd_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")+xlim(40,80)
...
HRS_ds_coda_w7$h_cpd_age[which(HRS_ds_coda_w7$h_cpd == 1 & HRS_coda_w7$h_cpd==0 & !HRS_coda_w7$ybirth %in% miss_values_vector)] <- (HRS_coda_w7$yintw_coda_w7[which(HRS_ds_coda_w7$h_cpd == 1 & HRS_coda_w7$h_cpd==0 & !HRS_coda_w7$ybirth %in% miss_values_vector)]+HRS_coda_w7$yintw_coda_w6[which(HRS_ds_coda_w7$h_cpd == 1 & HRS_coda_w7$h_cpd==0 & !HRS_coda_w7$ybirth %in% miss_values_vector)])/2-HRS_coda_w7$ybirth[which(HRS_ds_coda_w7$h_cpd == 1 & HRS_coda_w7$h_cpd==0 & !HRS_coda_w7$ybirth %in% miss_values_vector)]
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(HRS_ds_coda_w7, aes(h_cpd_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")+xlim(40,80)
...
HRS_ds_coda_w8$h_cpd_age[which(HRS_ds_coda_w8$h_cpd == 1 & HRS_coda_w8$h_cpd==0 & !HRS_coda_w8$ybirth %in% miss_values_vector)] <- (HRS_coda_w8$yintw_coda_w8[which(HRS_ds_coda_w8$h_cpd == 1 & HRS_coda_w8$h_cpd==0 & !HRS_coda_w8$ybirth %in% miss_values_vector)]+HRS_coda_w8$yintw_coda_w7[which(HRS_ds_coda_w8$h_cpd == 1 & HRS_coda_w8$h_cpd==0 & !HRS_coda_w8$ybirth %in% miss_values_vector)])/2-HRS_coda_w8$ybirth[which(HRS_ds_coda_w8$h_cpd == 1 & HRS_coda_w8$h_cpd==0 & !HRS_coda_w8$ybirth %in% miss_values_vector)]
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(HRS_ds_coda_w8, aes(h_cpd_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")+xlim(40,85)
...
HRS_ds_coda_w9$h_cpd_age[which(HRS_ds_coda_w9$h_cpd == 1 & HRS_coda_w9$h_cpd==0 & !HRS_coda_w9$ybirth %in% miss_values_vector)] <- (HRS_coda_w9$yintw_coda_w9[which(HRS_ds_coda_w9$h_cpd == 1 & HRS_coda_w9$h_cpd==0 & !HRS_coda_w9$ybirth %in% miss_values_vector)]+HRS_coda_w9$yintw_coda_w8[which(HRS_ds_coda_w9$h_cpd == 1 & HRS_coda_w9$h_cpd==0 & !HRS_coda_w9$ybirth %in% miss_values_vector)])/2-HRS_coda_w9$ybirth[which(HRS_ds_coda_w9$h_cpd == 1 & HRS_coda_w9$h_cpd==0 & !HRS_coda_w9$ybirth %in% miss_values_vector)]
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(HRS_ds_coda_w9, aes(h_cpd_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")+xlim(40,90)
...
HRS_ds_coda_w10$h_cpd_age[which(HRS_ds_coda_w10$h_cpd == 1 & HRS_coda_w10$h_cpd==0 & !HRS_coda_w10$ybirth %in% miss_values_vector)] <- (HRS_coda_w10$yintw_coda_w10[which(HRS_ds_coda_w10$h_cpd == 1 & HRS_coda_w10$h_cpd==0 & !HRS_coda_w10$ybirth %in% miss_values_vector)]+HRS_coda_w10$yintw_coda_w9[which(HRS_ds_coda_w10$h_cpd == 1 & HRS_coda_w10$h_cpd==0 & !HRS_coda_w10$ybirth %in% miss_values_vector)])/2-HRS_coda_w10$ybirth[which(HRS_ds_coda_w10$h_cpd == 1 & HRS_coda_w10$h_cpd==0 & !HRS_coda_w10$ybirth %in% miss_values_vector)]
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(HRS_ds_coda_w10, aes(h_cpd_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")+xlim(40,90)
...
HRS_ds_coda_w11$h_cpd_age[which(HRS_ds_coda_w11$h_cpd == 1 & HRS_coda_w11$h_cpd==0 & !HRS_coda_w11$ybirth %in% miss_values_vector)] <- (HRS_coda_w11$yintw_coda_w11[which(HRS_ds_coda_w11$h_cpd == 1 & HRS_coda_w11$h_cpd==0 & !HRS_coda_w11$ybirth %in% miss_values_vector)]+HRS_coda_w11$yintw_coda_w10[which(HRS_ds_coda_w11$h_cpd == 1 & HRS_coda_w11$h_cpd==0 & !HRS_coda_w11$ybirth %in% miss_values_vector)])/2-HRS_coda_w11$ybirth[which(HRS_ds_coda_w11$h_cpd == 1 & HRS_coda_w11$h_cpd==0 & !HRS_coda_w11$ybirth %in% miss_values_vector)]
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(HRS_ds_coda_w11, aes(h_cpd_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")+xlim(40,90)
...
HRS_ds_wb_w5$h_cpd_age[which(HRS_ds_wb_w5$h_cpd == 1 & HRS_wb_w5$h_cpd==0 & !HRS_wb_w5$ybirth %in% miss_values_vector)] <- (HRS_wb_w5$yintw_wb_w5[which(HRS_ds_wb_w5$h_cpd == 1 & HRS_wb_w5$h_cpd==0 & !HRS_wb_w5$ybirth %in% miss_values_vector)]+HRS_wb_w5$yintw_wb_w4[which(HRS_ds_wb_w5$h_cpd == 1 & HRS_wb_w5$h_cpd==0 & !HRS_wb_w5$ybirth %in% miss_values_vector)])/2-HRS_wb_w5$ybirth[which(HRS_ds_wb_w5$h_cpd == 1 & HRS_wb_w5$h_cpd==0 & !HRS_wb_w5$ybirth %in% miss_values_vector)]
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(HRS_ds_wb_w5, aes(h_cpd_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")+xlim(35,75)
...
HRS_ds_wb_w6$h_cpd_age[which(HRS_ds_wb_w6$h_cpd == 1 & HRS_wb_w6$h_cpd==0 & !HRS_wb_w6$ybirth %in% miss_values_vector)] <- (HRS_wb_w6$yintw_wb_w6[which(HRS_ds_wb_w6$h_cpd == 1 & HRS_wb_w6$h_cpd==0 & !HRS_wb_w6$ybirth %in% miss_values_vector)]+HRS_wb_w6$yintw_wb_w5[which(HRS_ds_wb_w6$h_cpd == 1 & HRS_wb_w6$h_cpd==0 & !HRS_wb_w6$ybirth %in% miss_values_vector)])/2-HRS_wb_w6$ybirth[which(HRS_ds_wb_w6$h_cpd == 1 & HRS_wb_w6$h_cpd==0 & !HRS_wb_w6$ybirth %in% miss_values_vector)]
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(HRS_ds_wb_w6, aes(h_cpd_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")+xlim(35,75)
...
HRS_ds_wb_w7$h_cpd_age[which(HRS_ds_wb_w7$h_cpd == 1 & HRS_wb_w7$h_cpd==0 & !HRS_wb_w7$ybirth %in% miss_values_vector)] <- (HRS_wb_w7$yintw_wb_w7[which(HRS_ds_wb_w7$h_cpd == 1 & HRS_wb_w7$h_cpd==0 & !HRS_wb_w7$ybirth %in% miss_values_vector)]+HRS_wb_w7$yintw_wb_w6[which(HRS_ds_wb_w7$h_cpd == 1 & HRS_wb_w7$h_cpd==0 & !HRS_wb_w7$ybirth %in% miss_values_vector)])/2-HRS_wb_w7$ybirth[which(HRS_ds_wb_w7$h_cpd == 1 & HRS_wb_w7$h_cpd==0 & !HRS_wb_w7$ybirth %in% miss_values_vector)]
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(HRS_ds_wb_w7, aes(h_cpd_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")+xlim(35,75)
...
HRS_ds_wb_w8$h_cpd_age[which(HRS_ds_wb_w8$h_cpd == 1 & HRS_wb_w8$h_cpd==0 & !HRS_wb_w8$ybirth %in% miss_values_vector)] <- (HRS_wb_w8$yintw_wb_w8[which(HRS_ds_wb_w8$h_cpd == 1 & HRS_wb_w8$h_cpd==0 & !HRS_wb_w8$ybirth %in% miss_values_vector)]+HRS_wb_w8$yintw_wb_w7[which(HRS_ds_wb_w8$h_cpd == 1 & HRS_wb_w8$h_cpd==0 & !HRS_wb_w8$ybirth %in% miss_values_vector)])/2-HRS_wb_w8$ybirth[which(HRS_ds_wb_w8$h_cpd == 1 & HRS_wb_w8$h_cpd==0 & !HRS_wb_w8$ybirth %in% miss_values_vector)]
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(HRS_ds_wb_w8, aes(h_cpd_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")+xlim(35,75)
...
HRS_ds_wb_w9$h_cpd_age[which(HRS_ds_wb_w9$h_cpd == 1 & HRS_wb_w9$h_cpd==0 & !HRS_wb_w9$ybirth %in% miss_values_vector)] <- (HRS_wb_w9$yintw_wb_w9[which(HRS_ds_wb_w9$h_cpd == 1 & HRS_wb_w9$h_cpd==0 & !HRS_wb_w9$ybirth %in% miss_values_vector)]+HRS_wb_w9$yintw_wb_w8[which(HRS_ds_wb_w9$h_cpd == 1 & HRS_wb_w9$h_cpd==0 & !HRS_wb_w9$ybirth %in% miss_values_vector)])/2-HRS_wb_w9$ybirth[which(HRS_ds_wb_w9$h_cpd == 1 & HRS_wb_w9$h_cpd==0 & !HRS_wb_w9$ybirth %in% miss_values_vector)]
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(HRS_ds_wb_w9, aes(h_cpd_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")+xlim(35,75)
...
HRS_ds_wb_w10$h_cpd_age[which(HRS_ds_wb_w10$h_cpd == 1 & HRS_wb_w10$h_cpd==0 & !HRS_wb_w10$ybirth %in% miss_values_vector)] <- (HRS_wb_w10$yintw_wb_w10[which(HRS_ds_wb_w10$h_cpd == 1 & HRS_wb_w10$h_cpd==0 & !HRS_wb_w10$ybirth %in% miss_values_vector)]+HRS_wb_w10$yintw_wb_w9[which(HRS_ds_wb_w10$h_cpd == 1 & HRS_wb_w10$h_cpd==0 & !HRS_wb_w10$ybirth %in% miss_values_vector)])/2-HRS_wb_w10$ybirth[which(HRS_ds_wb_w10$h_cpd == 1 & HRS_wb_w10$h_cpd==0 & !HRS_wb_w10$ybirth %in% miss_values_vector)]
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(HRS_ds_wb_w10, aes(h_cpd_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")+xlim(30,80)
...
HRS_ds_wb_w11$h_cpd_age[which(HRS_ds_wb_w11$h_cpd == 1 & HRS_wb_w11$h_cpd==0 & !HRS_wb_w11$ybirth %in% miss_values_vector)] <- (HRS_wb_w11$yintw_wb_w11[which(HRS_ds_wb_w11$h_cpd == 1 & HRS_wb_w11$h_cpd==0 & !HRS_wb_w11$ybirth %in% miss_values_vector)]+HRS_wb_w11$yintw_wb_w10[which(HRS_ds_wb_w11$h_cpd == 1 & HRS_wb_w11$h_cpd==0 & !HRS_wb_w11$ybirth %in% miss_values_vector)])/2-HRS_wb_w11$ybirth[which(HRS_ds_wb_w11$h_cpd == 1 & HRS_wb_w11$h_cpd==0 & !HRS_wb_w11$ybirth %in% miss_values_vector)]
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(HRS_ds_wb_w11, aes(h_cpd_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")+xlim(30,80)
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(HRS_ds_ebb_w8, aes(h_cpd_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")+xlim(40,60)
...
HRS_ds_ebb_w9$h_cpd_age[which(HRS_ds_ebb_w9$h_cpd == 1 & HRS_ebb_w9$h_cpd==0 & !HRS_ebb_w9$ybirth %in% miss_values_vector)] <- (HRS_ebb_w9$yintw_ebb_w9[which(HRS_ds_ebb_w9$h_cpd == 1 & HRS_ebb_w9$h_cpd==0 & !HRS_ebb_w9$ybirth %in% miss_values_vector)]+HRS_ebb_w9$yintw_ebb_w8[which(HRS_ds_ebb_w9$h_cpd == 1 & HRS_ebb_w9$h_cpd==0 & !HRS_ebb_w9$ybirth %in% miss_values_vector)])/2-HRS_ebb_w9$ybirth[which(HRS_ds_ebb_w9$h_cpd == 1 & HRS_ebb_w9$h_cpd==0 & !HRS_ebb_w9$ybirth %in% miss_values_vector)]
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(HRS_ds_ebb_w9, aes(h_cpd_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")+xlim(40,60)
...
HRS_ds_ebb_w10$h_cpd_age[which(HRS_ds_ebb_w10$h_cpd == 1 & HRS_ebb_w10$h_cpd==0 & !HRS_ebb_w10$ybirth %in% miss_values_vector)] <- (HRS_ebb_w10$yintw_ebb_w10[which(HRS_ds_ebb_w10$h_cpd == 1 & HRS_ebb_w10$h_cpd==0 & !HRS_ebb_w10$ybirth %in% miss_values_vector)]+HRS_ebb_w10$yintw_ebb_w9[which(HRS_ds_ebb_w10$h_cpd == 1 & HRS_ebb_w10$h_cpd==0 & !HRS_ebb_w10$ybirth %in% miss_values_vector)])/2-HRS_ebb_w10$ybirth[which(HRS_ds_ebb_w10$h_cpd == 1 & HRS_ebb_w10$h_cpd==0 & !HRS_ebb_w10$ybirth %in% miss_values_vector)]
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(HRS_ds_ebb_w10, aes(h_cpd_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")+xlim(40,65)
...
HRS_ds_ebb_w11$h_cpd_age[which(HRS_ds_ebb_w11$h_cpd == 1 & HRS_ebb_w11$h_cpd==0 & !HRS_ebb_w11$ybirth %in% miss_values_vector)] <- (HRS_ebb_w11$yintw_ebb_w11[which(HRS_ds_ebb_w11$h_cpd == 1 & HRS_ebb_w11$h_cpd==0 & !HRS_ebb_w11$ybirth %in% miss_values_vector)]+HRS_ebb_w11$yintw_ebb_w10[which(HRS_ds_ebb_w11$h_cpd == 1 & HRS_ebb_w11$h_cpd==0 & !HRS_ebb_w11$ybirth %in% miss_values_vector)])/2-HRS_ebb_w11$ybirth[which(HRS_ds_ebb_w11$h_cpd == 1 & HRS_ebb_w11$h_cpd==0 & !HRS_ebb_w11$ybirth %in% miss_values_vector)]
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(HRS_ds_ebb_w11, aes(h_cpd_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")+xlim(40,85)
...
HRS_ds_mbb_w11$h_cpd_age[which(HRS_ds_mbb_w11$h_cpd == 1 & HRS_mbb_w11$h_cpd==0 & !HRS_mbb_w11$ybirth %in% miss_values_vector)] <- (HRS_mbb_w11$yintw_mbb_w11[which(HRS_ds_mbb_w11$h_cpd == 1 & HRS_mbb_w11$h_cpd==0 & !HRS_mbb_w11$ybirth %in% miss_values_vector)]+HRS_mbb_w11$yintw_mbb_w10[which(HRS_ds_mbb_w11$h_cpd == 1 & HRS_mbb_w11$h_cpd==0 & !HRS_mbb_w11$ybirth %in% miss_values_vector)])/2-HRS_mbb_w11$ybirth[which(HRS_ds_mbb_w11$h_cpd == 1 & HRS_mbb_w11$h_cpd==0 & !HRS_mbb_w11$ybirth %in% miss_values_vector)]
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(HRS_ds_mbb_w11, aes(h_cpd_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")+xlim(25,70)
...
dbb <- merge(HRS_m_ds_hrs_w1[,c("id","h_cpd")], HRS_m_ds_hrs_w2[,c("id","h_cpd")], by="id", suffixes = c(".w1",".w2"), all=T)
dbb <- merge(dbb, HRS_m_ds_hrs_w3[,c("id","h_cpd")], by="id", all=T)
dbb <- merge(dbb, HRS_m_ds_hrs_w4[,c("id","h_cpd")], by="id", suffixes = c(".w3",".w4"), all=T)
dbb <- merge(dbb, HRS_m_ds_hrs_w5[,c("id","h_cpd")], by="id", all=T)
dbb <- merge(dbb, HRS_m_ds_hrs_w6[,c("id","h_cpd")], by="id", suffixes = c(".w5",".w6"), all=T)
dbb <- merge(dbb, HRS_m_ds_hrs_w7[,c("id","h_cpd")], by="id", all=T)
dbb <- merge(dbb, HRS_m_ds_hrs_w8[,c("id","h_cpd")], by="id", suffixes = c(".w7",".w8"), all=T)
dbb <- merge(dbb, HRS_m_ds_hrs_w9[,c("id","h_cpd")], by="id", all=T)
dbb <- merge(dbb, HRS_m_ds_hrs_w10[,c("id","h_cpd")], by="id", suffixes = c(".w9",".w10"), all=T)
dbb <- merge(dbb, HRS_m_ds_hrs_w11[,c("id","h_cpd")], by="id", all=T)
...
dbb <- merge(HRS_m_ds_ahead_w2[,c("id","h_cpd")], HRS_m_ds_ahead_w3[,c("id","h_cpd")], by="id", suffixes = c(".w2",".w3"), all=T)
dbb <- merge(dbb, HRS_m_ds_ahead_w4[,c("id","h_cpd")], by="id", all=T)
dbb <- merge(dbb, HRS_m_ds_ahead_w5[,c("id","h_cpd")], by="id", suffixes = c(".w4",".w5"), all=T)
dbb <- merge(dbb, HRS_m_ds_ahead_w6[,c("id","h_cpd")], by="id", all=T)
dbb <- merge(dbb, HRS_m_ds_ahead_w7[,c("id","h_cpd")], by="id", suffixes = c(".w6",".w7"), all=T)
dbb <- merge(dbb, HRS_m_ds_ahead_w8[,c("id","h_cpd")], by="id", all=T)
dbb <- merge(dbb, HRS_m_ds_ahead_w9[,c("id","h_cpd")], by="id", suffixes = c(".w8",".w9"), all=T)
dbb <- merge(dbb, HRS_m_ds_ahead_w10[,c("id","h_cpd")], by="id", all=T)
dbb <- merge(dbb, HRS_m_ds_ahead_w11[,c("id","h_cpd")], by="id", suffixes = c(".w10",".w11"), all=T)
...
dbb <- merge(HRS_m_ds_coda_w4[,c("id","h_cpd")], HRS_m_ds_coda_w5[,c("id","h_cpd")], by="id", suffixes = c(".w4",".w5"), all=T)
dbb <- merge(dbb, HRS_m_ds_coda_w6[,c("id","h_cpd")], by="id", all=T)
dbb <- merge(dbb, HRS_m_ds_coda_w7[,c("id","h_cpd")], by="id", suffixes = c(".w6",".w7"), all=T)
dbb <- merge(dbb, HRS_m_ds_coda_w8[,c("id","h_cpd")], by="id", all=T)
dbb <- merge(dbb, HRS_m_ds_coda_w9[,c("id","h_cpd")], by="id", suffixes = c(".w8",".w9"), all=T)
dbb <- merge(dbb, HRS_m_ds_coda_w10[,c("id","h_cpd")], by="id", all=T)
dbb <- merge(dbb, HRS_m_ds_coda_w11[,c("id","h_cpd")], by="id", suffixes = c(".w10",".w11"), all=T)
...
dbb <- merge(HRS_m_ds_wb_w4[,c("id","h_cpd")], HRS_m_ds_wb_w5[,c("id","h_cpd")], by="id", suffixes = c(".w4",".w5"), all=T)
dbb <- merge(dbb, HRS_m_ds_wb_w6[,c("id","h_cpd")], by="id", all=T)
dbb <- merge(dbb, HRS_m_ds_wb_w7[,c("id","h_cpd")], by="id", suffixes = c(".w6",".w7"), all=T)
dbb <- merge(dbb, HRS_m_ds_wb_w8[,c("id","h_cpd")], by="id", all=T)
dbb <- merge(dbb, HRS_m_ds_wb_w9[,c("id","h_cpd")], by="id", suffixes = c(".w8",".w9"), all=T)
dbb <- merge(dbb, HRS_m_ds_wb_w10[,c("id","h_cpd")], by="id", all=T)
dbb <- merge(dbb, HRS_m_ds_wb_w11[,c("id","h_cpd")], by="id", suffixes = c(".w10",".w11"), all=T)
names(dbb) <- c("id", "w4", "w5", "w6", "w7", "w8", "w9", "w10", "w11")
v.dbb <- paste(dbb[,2],dbb[,3],dbb[,4],dbb[,5],dbb[,6],dbb[,7],dbb[,8],sep="")
f.dbb <- frq(v.dbb)[[1]][,c(1,2,4)]
kable(f.dbb[f.dbb[,3]>=0.3,])
...
dbb <- merge(HRS_m_ds_ebb_w7[,c("id","h_cpd")], HRS_m_ds_ebb_w8[,c("id","h_cpd")], by="id", suffixes = c(".w7",".w8"), all=T)
dbb <- merge(dbb, HRS_m_ds_ebb_w9[,c("id","h_cpd")], by="id", all=T)
dbb <- merge(dbb, HRS_m_ds_ebb_w10[,c("id","h_cpd")], by="id", suffixes = c(".w9",".w10"), all=T)
dbb <- merge(dbb, HRS_m_ds_ebb_w11[,c("id","h_cpd")], by="id", all=T)
...
dbb <- merge(HRS_m_ds_mbb_w10[,c("id","h_cpd")], HRS_m_ds_mbb_w11[,c("id","h_cpd")], by="id", suffixes = c(".w10",".w11"), all=T)
...
for(name in names(lb.hrs)){
  h_cpd <- lb.hrs[[name]]
  save(h_cpd, file = paste0(datafolder,name,"/h_cpd.RData"))
}
