...
grip <- read_dta("M:/Datasets/HRS/HarmonizedHRS.vB/grip.dta") %>% mutate(id = as.character(hhidpn)) %>% select(-hhidpn)
vbl_miss <- c('d','m','n','i','r','s','x')
...
grip_hrs <- grip %>% filter(id %in% HRS_hrs$id) 
HRS_hrs <- full_join(HRS_hrs, grip_hrs, by = "id", suffix = c("",".tagged"))
...
| **Units** |`kg`|`kg`|
| **Missings** |`d = Don't know`<br/>`m = Other missing`<br/>`n = Not applicable`<br/>`i = Unknown Unmarried`<br/>`r '\x60r = Refused\x60'`<br/>`s = Information not available due to skip patterns`<br/>`x = Does not apply`<br/>`NA`|`d = Don't know`<br/>`m = Other missing`<br/>`n = Not applicable`<br/>`i = Unknown Unmarried`<br/>`r '\x60r = Refused\x60'`<br/>`s = Information not available due to skip patterns`<br/>`x = Does not apply`<br/>`NA`|
| **Description** |  |  |
...
vbl <- HRS_hrs$r7lgrip
vbl.tagged <- HRS_hrs$r7lgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
ggplot(HRS_hrs, aes(r7lgrip)) + geom_histogram(stat="count", fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")

vbl <- HRS_hrs$r7rgrip
vbl.tagged <- HRS_hrs$r7rgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
ggplot(HRS_hrs, aes(r7rgrip)) + geom_histogram(stat="count", fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")

kable(addmargins(table(na_tag((HRS_hrs %>% filter(is.na(r7lgrip) & is.na(r7rgrip)))$r7lgrip.tagged), na_tag((HRS_hrs %>% filter(is.na(r7lgrip) & is.na(r7rgrip)))$r7rgrip.tagged), useNA = "ifany")), caption = "Both hands missing values")
...
HRS_ds_hrs_w7$grip[which(is.na(HRS_ds_hrs_w7$grip))] <- car::recode(na_tag(HRS_hrs$r7lgrip.tagged[which(is.na(HRS_ds_hrs_w7$grip))]), "'i' = 999; 'n' = 996; 'r' = 997; 's' = 996; 'x' = 996; NA = 999")
...
vbl <- HRS_hrs$r8lgrip
vbl.tagged <- HRS_hrs$r8lgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
...
vbl <- HRS_hrs$r8rgrip
vbl.tagged <- HRS_hrs$r8rgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
ggplot(HRS_hrs, aes(r8rgrip)) + geom_histogram(stat="count", fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")

kable(addmargins(table(na_tag((HRS_hrs %>% filter(is.na(r8lgrip) & is.na(r8rgrip)))$r8lgrip.tagged), na_tag((HRS_hrs %>% filter(is.na(r8lgrip) & is.na(r8rgrip)))$r8rgrip.tagged), useNA = "ifany")), caption = "Both hands missing values")
...
HRS_ds_hrs_w8$grip[which(is.na(HRS_ds_hrs_w8$grip))] <- car::recode(na_tag(HRS_hrs$r8lgrip.tagged[which(is.na(HRS_ds_hrs_w8$grip))]), "'m' = 999; 'n' = 996; 'i' = 999; 'n' = 996; 'r' = 997; 's' = 996; 'x' = 996; NA = 999")
...
vbl <- HRS_hrs$r9lgrip
vbl.tagged <- HRS_hrs$r9lgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
...
vbl <- HRS_hrs$r9rgrip
vbl.tagged <- HRS_hrs$r9rgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
ggplot(HRS_hrs, aes(r9rgrip)) + geom_histogram(stat="count", fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")

kable(addmargins(table(na_tag((HRS_hrs %>% filter(is.na(r9lgrip) & is.na(r9rgrip)))$r9lgrip.tagged), na_tag((HRS_hrs %>% filter(is.na(r9lgrip) & is.na(r9rgrip)))$r9rgrip.tagged), useNA = "ifany")), caption = "Both hands missing values")
...
HRS_ds_hrs_w9$grip[which(is.na(HRS_ds_hrs_w9$grip))] <- car::recode(na_tag(HRS_hrs$r9rgrip.tagged[which(is.na(HRS_ds_hrs_w9$grip))]), "'m' = 999; 'n' = 996; 'i' = 999; 'n' = 996; 'r' = 997; 's' = 996; 'x' = 996; NA = 999")
...
vbl.tagged <- HRS_hrs$r10lgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
...
vbl.tagged <- HRS_hrs$r10rgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
ggplot(HRS_hrs, aes(r10rgrip)) + geom_histogram(stat="count", fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")

kable(addmargins(table(na_tag((HRS_hrs %>% filter(is.na(r10lgrip) & is.na(r10rgrip)))$r10lgrip.tagged), na_tag((HRS_hrs %>% filter(is.na(r10lgrip) & is.na(r10rgrip)))$r10rgrip.tagged), useNA = "ifany")), caption = "Both hands missing values")
...
HRS_ds_hrs_w10$grip[which(is.na(HRS_ds_hrs_w10$grip))] <- car::recode(na_tag(HRS_hrs$r10rgrip.tagged[which(is.na(HRS_ds_hrs_w10$grip))]), "'m' = 999; 'n' = 996; 'i' = 999; 'n' = 996; 'r' = 997; 's' = 996; 'x' = 996; NA = 999")
...
vbl.tagged <- HRS_hrs$r11lgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
...
vbl.tagged <- HRS_hrs$r11rgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
ggplot(HRS_hrs, aes(r11rgrip)) + geom_histogram(stat="count", fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")

kable(addmargins(table(na_tag((HRS_hrs %>% filter(is.na(r11lgrip) & is.na(r11rgrip)))$r11lgrip.tagged), na_tag((HRS_hrs %>% filter(is.na(r11lgrip) & is.na(r11rgrip)))$r11rgrip.tagged), useNA = "ifany")), caption = "Both hands missing values")
...
HRS_ds_hrs_w11$grip[which(is.na(HRS_ds_hrs_w11$grip))] <- car::recode(na_tag(HRS_hrs$r11lgrip.tagged[which(is.na(HRS_ds_hrs_w11$grip))]), "'m' = 999; 'n' = 996; 'i' = 999; 'n' = 996; 'r' = 997; 's' = 996; 'x' = 996; NA = 999")
...
grip_ahead <- grip %>% filter(id %in% HRS_ahead$id) 
HRS_ahead <- full_join(HRS_ahead, grip_ahead, by = "id", suffix = c("",".tagged"))
...
vbl.tagged <- HRS_ahead$r7lgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
...
vbl.tagged <- HRS_ahead$r7rgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
ggplot(HRS_ahead, aes(r7rgrip)) + geom_histogram(stat="count", fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")

kable(addmargins(table(na_tag((HRS_ahead %>% filter(is.na(r7lgrip) & is.na(r7rgrip)))$r7lgrip.tagged), na_tag((HRS_ahead %>% filter(is.na(r7lgrip) & is.na(r7rgrip)))$r7rgrip.tagged), useNA = "ifany")), caption = "Both hands missing values")
...
HRS_ds_ahead_w7$grip[which(is.na(HRS_ds_ahead_w7$grip))] <- car::recode(na_tag(HRS_ahead$r7lgrip.tagged[which(is.na(HRS_ds_ahead_w7$grip))]), "'i' = 999; 'n' = 996; 'r' = 997; 's' = 996; 'x' = 996; NA = 999")
...
vbl.tagged <- HRS_ahead$r8lgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
...
vbl.tagged <- HRS_ahead$r8rgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
ggplot(HRS_ahead, aes(r8rgrip)) + geom_histogram(stat="count", fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")

kable(addmargins(table(na_tag((HRS_ahead %>% filter(is.na(r8lgrip) & is.na(r8rgrip)))$r8lgrip.tagged), na_tag((HRS_ahead %>% filter(is.na(r8lgrip) & is.na(r8rgrip)))$r8rgrip.tagged), useNA = "ifany")), caption = "Both hands missing values")
...
HRS_ds_ahead_w8$grip[which(is.na(HRS_ds_ahead_w8$grip))] <- car::recode(na_tag(HRS_ahead$r8lgrip.tagged[which(is.na(HRS_ds_ahead_w8$grip))]), "'m' = 999; 'n' = 996; 'i' = 999; 'n' = 996; 'r' = 997; 's' = 996; 'x' = 996; NA = 999")
...
vbl.tagged <- HRS_ahead$r9lgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
...
vbl.tagged <- HRS_ahead$r9rgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
ggplot(HRS_ahead, aes(r9rgrip)) + geom_histogram(stat="count", fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")

kable(addmargins(table(na_tag((HRS_ahead %>% filter(is.na(r9lgrip) & is.na(r9rgrip)))$r9lgrip.tagged), na_tag((HRS_ahead %>% filter(is.na(r9lgrip) & is.na(r9rgrip)))$r9rgrip.tagged), useNA = "ifany")), caption = "Both hands missing values")
...
HRS_ds_ahead_w9$grip[which(is.na(HRS_ds_ahead_w9$grip))] <- car::recode(na_tag(HRS_ahead$r9rgrip.tagged[which(is.na(HRS_ds_ahead_w9$grip))]), "'m' = 999; 'n' = 996; 'i' = 999; 'n' = 996; 'r' = 997; 's' = 996; 'x' = 996; NA = 999")
...
vbl.tagged <- HRS_ahead$r10lgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
...
vbl.tagged <- HRS_ahead$r10rgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
ggplot(HRS_ahead, aes(r10rgrip)) + geom_histogram(stat="count", fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")

kable(addmargins(table(na_tag((HRS_ahead %>% filter(is.na(r10lgrip) & is.na(r10rgrip)))$r10lgrip.tagged), na_tag((HRS_ahead %>% filter(is.na(r10lgrip) & is.na(r10rgrip)))$r10rgrip.tagged), useNA = "ifany")), caption = "Both hands missing values")
...
HRS_ds_ahead_w10$grip[which(is.na(HRS_ds_ahead_w10$grip))] <- car::recode(na_tag(HRS_ahead$r10rgrip.tagged[which(is.na(HRS_ds_ahead_w10$grip))]), "'m' = 999; 'n' = 996; 'i' = 999; 'n' = 996; 'r' = 997; 's' = 996; 'x' = 996; NA = 999")
...
vbl.tagged <- HRS_ahead$r11lgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
...
vbl.tagged <- HRS_ahead$r11rgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
ggplot(HRS_ahead, aes(r11rgrip)) + geom_histogram(stat="count", fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")

kable(addmargins(table(na_tag((HRS_ahead %>% filter(is.na(r11lgrip) & is.na(r11rgrip)))$r11lgrip.tagged), na_tag((HRS_ahead %>% filter(is.na(r11lgrip) & is.na(r11rgrip)))$r11rgrip.tagged), useNA = "ifany")), caption = "Both hands missing values")
...
HRS_ds_ahead_w11$grip[which(is.na(HRS_ds_ahead_w11$grip))] <- car::recode(na_tag(HRS_ahead$r11lgrip.tagged[which(is.na(HRS_ds_ahead_w11$grip))]), "'m' = 999; 'n' = 996; 'i' = 999; 'n' = 996; 'r' = 997; 's' = 996; 'x' = 996; NA = 999")
...
grip_coda <- grip %>% filter(id %in% HRS_coda$id) 
HRS_coda <- full_join(HRS_coda, grip_coda, by = "id", suffix = c("",".tagged"))
...
vbl.tagged <- HRS_coda$r7lgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
...
vbl.tagged <- HRS_coda$r7rgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
ggplot(HRS_coda, aes(r7rgrip)) + geom_histogram(stat="count", fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")

kable(addmargins(table(na_tag((HRS_coda %>% filter(is.na(r7lgrip) & is.na(r7rgrip)))$r7lgrip.tagged), na_tag((HRS_coda %>% filter(is.na(r7lgrip) & is.na(r7rgrip)))$r7rgrip.tagged), useNA = "ifany")), caption = "Both hands missing values")
...
HRS_ds_coda_w7$grip[which(is.na(HRS_ds_coda_w7$grip))] <- car::recode(na_tag(HRS_coda$r7lgrip.tagged[which(is.na(HRS_ds_coda_w7$grip))]), "'i' = 999; 'n' = 996; 'r' = 997; 's' = 996; 'x' = 996; NA = 999")
...
vbl.tagged <- HRS_coda$r8lgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
...
vbl.tagged <- HRS_coda$r8rgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
ggplot(HRS_coda, aes(r8rgrip)) + geom_histogram(stat="count", fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")

kable(addmargins(table(na_tag((HRS_coda %>% filter(is.na(r8lgrip) & is.na(r8rgrip)))$r8lgrip.tagged), na_tag((HRS_coda %>% filter(is.na(r8lgrip) & is.na(r8rgrip)))$r8rgrip.tagged), useNA = "ifany")), caption = "Both hands missing values")
...
HRS_ds_coda_w8$grip[which(is.na(HRS_ds_coda_w8$grip))] <- car::recode(na_tag(HRS_coda$r8lgrip.tagged[which(is.na(HRS_ds_coda_w8$grip))]), "'m' = 999; 'n' = 996; 'i' = 999; 'n' = 996; 'r' = 997; 's' = 996; 'x' = 996; NA = 999")
...
vbl.tagged <- HRS_coda$r9lgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
...
vbl.tagged <- HRS_coda$r9rgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
ggplot(HRS_coda, aes(r9rgrip)) + geom_histogram(stat="count", fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")

kable(addmargins(table(na_tag((HRS_coda %>% filter(is.na(r9lgrip) & is.na(r9rgrip)))$r9lgrip.tagged), na_tag((HRS_coda %>% filter(is.na(r9lgrip) & is.na(r9rgrip)))$r9rgrip.tagged), useNA = "ifany")), caption = "Both hands missing values")
...
HRS_ds_coda_w9$grip[which(is.na(HRS_ds_coda_w9$grip))] <- car::recode(na_tag(HRS_coda$r9rgrip.tagged[which(is.na(HRS_ds_coda_w9$grip))]), "'m' = 999; 'n' = 996; 'i' = 999; 'n' = 996; 'r' = 997; 's' = 996; 'x' = 996; NA = 999")
...
vbl.tagged <- HRS_coda$r10lgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
...
vbl.tagged <- HRS_coda$r10rgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
ggplot(HRS_coda, aes(r10rgrip)) + geom_histogram(stat="count", fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")

kable(addmargins(table(na_tag((HRS_coda %>% filter(is.na(r10lgrip) & is.na(r10rgrip)))$r10lgrip.tagged), na_tag((HRS_coda %>% filter(is.na(r10lgrip) & is.na(r10rgrip)))$r10rgrip.tagged), useNA = "ifany")), caption = "Both hands missing values")
...
HRS_ds_coda_w10$grip[which(is.na(HRS_ds_coda_w10$grip))] <- car::recode(na_tag(HRS_coda$r10rgrip.tagged[which(is.na(HRS_ds_coda_w10$grip))]), "'m' = 999; 'n' = 996; 'i' = 999; 'n' = 996; 'r' = 997; 's' = 996; 'x' = 996; NA = 999")
...
vbl.tagged <- HRS_coda$r11lgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
...
vbl.tagged <- HRS_coda$r11rgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
ggplot(HRS_coda, aes(r11rgrip)) + geom_histogram(stat="count", fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")

kable(addmargins(table(na_tag((HRS_coda %>% filter(is.na(r11lgrip) & is.na(r11rgrip)))$r11lgrip.tagged), na_tag((HRS_coda %>% filter(is.na(r11lgrip) & is.na(r11rgrip)))$r11rgrip.tagged), useNA = "ifany")), caption = "Both hands missing values")
...
HRS_ds_coda_w11$grip[which(is.na(HRS_ds_coda_w11$grip))] <- car::recode(na_tag(HRS_coda$r11lgrip.tagged[which(is.na(HRS_ds_coda_w11$grip))]), "'m' = 999; 'n' = 996; 'i' = 999; 'n' = 996; 'r' = 997; 's' = 996; 'x' = 996; NA = 999")
...
grip_wb <- grip %>% filter(id %in% HRS_wb$id) 
HRS_wb <- full_join(HRS_wb, grip_wb, by = "id", suffix = c("",".tagged"))
...
vbl <- HRS_wb$r7lgrip
vbl.tagged <- HRS_wb$r7lgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
...
vbl <- HRS_wb$r7rgrip
vbl.tagged <- HRS_wb$r7rgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
ggplot(HRS_wb, aes(r7rgrip)) + geom_histogram(stat="count", fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")

kable(addmargins(table(na_tag((HRS_wb %>% filter(is.na(r7lgrip) & is.na(r7rgrip)))$r7lgrip.tagged), na_tag((HRS_wb %>% filter(is.na(r7lgrip) & is.na(r7rgrip)))$r7rgrip.tagged), useNA = "ifany")), caption = "Both hands missing values")
...
HRS_ds_wb_w7$grip[which(is.na(HRS_ds_wb_w7$grip))] <- car::recode(na_tag(HRS_wb$r7lgrip.tagged[which(is.na(HRS_ds_wb_w7$grip))]), "'i' = 999; 'n' = 996; 'r' = 997; 's' = 996; 'x' = 996; NA = 999")
...
vbl <- HRS_wb$r8lgrip
vbl.tagged <- HRS_wb$r8lgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
...
vbl <- HRS_wb$r8rgrip
vbl.tagged <- HRS_wb$r8rgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
ggplot(HRS_wb, aes(r8rgrip)) + geom_histogram(stat="count", fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")

kable(addmargins(table(na_tag((HRS_wb %>% filter(is.na(r8lgrip) & is.na(r8rgrip)))$r8lgrip.tagged), na_tag((HRS_wb %>% filter(is.na(r8lgrip) & is.na(r8rgrip)))$r8rgrip.tagged), useNA = "ifany")), caption = "Both hands missing values")
...
HRS_ds_wb_w8$grip[which(is.na(HRS_ds_wb_w8$grip))] <- car::recode(na_tag(HRS_wb$r8lgrip.tagged[which(is.na(HRS_ds_wb_w8$grip))]), "'m' = 999; 'n' = 996; 'i' = 999; 'n' = 996; 'r' = 997; 's' = 996; 'x' = 996; NA = 999")
...
vbl <- HRS_wb$r9lgrip
vbl.tagged <- HRS_wb$r9lgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
...
vbl <- HRS_wb$r9rgrip
vbl.tagged <- HRS_wb$r9rgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
ggplot(HRS_wb, aes(r9rgrip)) + geom_histogram(stat="count", fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")

kable(addmargins(table(na_tag((HRS_wb %>% filter(is.na(r9lgrip) & is.na(r9rgrip)))$r9lgrip.tagged), na_tag((HRS_wb %>% filter(is.na(r9lgrip) & is.na(r9rgrip)))$r9rgrip.tagged), useNA = "ifany")), caption = "Both hands missing values")
...
HRS_ds_wb_w9$grip[which(is.na(HRS_ds_wb_w9$grip))] <- car::recode(na_tag(HRS_wb$r9rgrip.tagged[which(is.na(HRS_ds_wb_w9$grip))]), "'m' = 999; 'n' = 996; 'i' = 999; 'n' = 996; 'r' = 997; 's' = 996; 'x' = 996; NA = 999")
...
vbl <- HRS_wb$r10lgrip
vbl.tagged <- HRS_wb$r10lgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
...
vbl <- HRS_wb$r10rgrip
vbl.tagged <- HRS_wb$r10rgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
ggplot(HRS_wb, aes(r10rgrip)) + geom_histogram(stat="count", fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")

kable(addmargins(table(na_tag((HRS_wb %>% filter(is.na(r10lgrip) & is.na(r10rgrip)))$r10lgrip.tagged), na_tag((HRS_wb %>% filter(is.na(r10lgrip) & is.na(r10rgrip)))$r10rgrip.tagged), useNA = "ifany")), caption = "Both hands missing values")
...
HRS_ds_wb_w10$grip[which(is.na(HRS_ds_wb_w10$grip))] <- car::recode(na_tag(HRS_wb$r10rgrip.tagged[which(is.na(HRS_ds_wb_w10$grip))]), "'m' = 999; 'n' = 996; 'i' = 999; 'n' = 996; 'r' = 997; 's' = 996; 'x' = 996; NA = 999")
...
vbl <- HRS_wb$r11lgrip
vbl.tagged <- HRS_wb$r11lgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
...
vbl <- HRS_wb$r11rgrip
vbl.tagged <- HRS_wb$r11rgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
ggplot(HRS_wb, aes(r11rgrip)) + geom_histogram(stat="count", fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")

kable(addmargins(table(na_tag((HRS_wb %>% filter(is.na(r11lgrip) & is.na(r11rgrip)))$r11lgrip.tagged), na_tag((HRS_wb %>% filter(is.na(r11lgrip) & is.na(r11rgrip)))$r11rgrip.tagged), useNA = "ifany")), caption = "Both hands missing values")
...
HRS_ds_wb_w11$grip[which(is.na(HRS_ds_wb_w11$grip))] <- car::recode(na_tag(HRS_wb$r11lgrip.tagged[which(is.na(HRS_ds_wb_w11$grip))]), "'m' = 999; 'n' = 996; 'i' = 999; 'n' = 996; 'r' = 997; 's' = 996; 'x' = 996; NA = 999")
...
grip_ebb <- grip %>% filter(id %in% HRS_ebb$id) 
HRS_ebb <- full_join(HRS_ebb, grip_ebb, by = "id", suffix = c("",".tagged"))
...
vbl <- HRS_ebb$r7lgrip
vbl.tagged <- HRS_ebb$r7lgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
...
vbl <- HRS_ebb$r7rgrip
vbl.tagged <- HRS_ebb$r7rgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
ggplot(HRS_ebb, aes(r7rgrip)) + geom_histogram(stat="count", fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")

kable(addmargins(table(na_tag((HRS_ebb %>% filter(is.na(r7lgrip) & is.na(r7rgrip)))$r7lgrip.tagged), na_tag((HRS_ebb %>% filter(is.na(r7lgrip) & is.na(r7rgrip)))$r7rgrip.tagged), useNA = "ifany")), caption = "Both hands missing values")
...
HRS_ds_ebb_w7$grip[which(is.na(HRS_ds_ebb_w7$grip))] <- car::recode(na_tag(HRS_ebb$r7rgrip.tagged[which(is.na(HRS_ds_ebb_w7$grip))]), "'i' = 999; 'n' = 996; 'r' = 997; 's' = 996; 'x' = 996; NA = 999")
...
vbl <- HRS_ebb$r8lgrip
vbl.tagged <- HRS_ebb$r8lgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
...
vbl <- HRS_ebb$r8rgrip
vbl.tagged <- HRS_ebb$r8rgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
ggplot(HRS_ebb, aes(r8rgrip)) + geom_histogram(stat="count", fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")

kable(addmargins(table(na_tag((HRS_ebb %>% filter(is.na(r8lgrip) & is.na(r8rgrip)))$r8lgrip.tagged), na_tag((HRS_ebb %>% filter(is.na(r8lgrip) & is.na(r8rgrip)))$r8rgrip.tagged), useNA = "ifany")), caption = "Both hands missing values")
...
HRS_ds_ebb_w8$grip[which(is.na(HRS_ds_ebb_w8$grip))] <- car::recode(na_tag(HRS_ebb$r8lgrip.tagged[which(is.na(HRS_ds_ebb_w8$grip))]), "'m' = 999; 'n' = 996; 'i' = 999; 'n' = 996; 'r' = 997; 's' = 996; 'x' = 996; NA = 999")
...
vbl <- HRS_ebb$r9lgrip
vbl.tagged <- HRS_ebb$r9lgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
...
vbl <- HRS_ebb$r9rgrip
vbl.tagged <- HRS_ebb$r9rgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
ggplot(HRS_ebb, aes(r9rgrip)) + geom_histogram(stat="count", fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")

kable(addmargins(table(na_tag((HRS_ebb %>% filter(is.na(r9lgrip) & is.na(r9rgrip)))$r9lgrip.tagged), na_tag((HRS_ebb %>% filter(is.na(r9lgrip) & is.na(r9rgrip)))$r9rgrip.tagged), useNA = "ifany")), caption = "Both hands missing values")
...
HRS_ds_ebb_w9$grip[which(is.na(HRS_ds_ebb_w9$grip))] <- car::recode(na_tag(HRS_ebb$r9rgrip.tagged[which(is.na(HRS_ds_ebb_w9$grip))]), "'m' = 999; 'n' = 996; 'i' = 999; 'n' = 996; 'r' = 997; 's' = 996; 'x' = 996; NA = 999")
...
vbl.tagged <- HRS_ebb$r10lgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
...
vbl.tagged <- HRS_ebb$r10rgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
ggplot(HRS_ebb, aes(r10rgrip)) + geom_histogram(stat="count", fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")

kable(addmargins(table(na_tag((HRS_ebb %>% filter(is.na(r10lgrip) & is.na(r10rgrip)))$r10lgrip.tagged), na_tag((HRS_ebb %>% filter(is.na(r10lgrip) & is.na(r10rgrip)))$r10rgrip.tagged), useNA = "ifany")), caption = "Both hands missing values")
...
HRS_ds_ebb_w10$grip[which(is.na(HRS_ds_ebb_w10$grip))] <- car::recode(na_tag(HRS_ebb$r10rgrip.tagged[which(is.na(HRS_ds_ebb_w10$grip))]), "'m' = 999; 'n' = 996; 'i' = 999; 'n' = 996; 'r' = 997; 's' = 996; 'x' = 996; NA = 999")
...
vbl.tagged <- HRS_ebb$r11lgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
...
vbl.tagged <- HRS_ebb$r11rgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
ggplot(HRS_ebb, aes(r11rgrip)) + geom_histogram(stat="count", fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")

kable(addmargins(table(na_tag((HRS_ebb %>% filter(is.na(r11lgrip) & is.na(r11rgrip)))$r11lgrip.tagged), na_tag((HRS_ebb %>% filter(is.na(r11lgrip) & is.na(r11rgrip)))$r11rgrip.tagged), useNA = "ifany")), caption = "Both hands missing values")
...
HRS_ds_ebb_w11$grip[which(is.na(HRS_ds_ebb_w11$grip))] <- car::recode(na_tag(HRS_ebb$r11lgrip.tagged[which(is.na(HRS_ds_ebb_w11$grip))]), "'m' = 999; 'n' = 996; 'i' = 999; 'n' = 996; 'r' = 997; 's' = 996; 'x' = 996; NA = 999")
...
grip_mbb <- grip %>% filter(id %in% HRS_mbb$id) 
HRS_mbb <- full_join(HRS_mbb, grip_mbb, by = "id", suffix = c("",".tagged"))
...
vbl.tagged <- HRS_mbb$r10lgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
...
vbl.tagged <- HRS_mbb$r10rgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
ggplot(HRS_mbb, aes(r10rgrip)) + geom_histogram(stat="count", fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")

kable(addmargins(table(na_tag((HRS_mbb %>% filter(is.na(r10lgrip) & is.na(r10rgrip)))$r10lgrip.tagged), na_tag((HRS_mbb %>% filter(is.na(r10lgrip) & is.na(r10rgrip)))$r10rgrip.tagged), useNA = "ifany")), caption = "Both hands missing values")
...
HRS_ds_mbb_w10$grip[which(is.na(HRS_ds_mbb_w10$grip))] <- car::recode(na_tag(HRS_mbb$r10rgrip.tagged[which(is.na(HRS_ds_mbb_w10$grip))]), "'d' = 998; 'm' = 999; 'n' = 996; 'i' = 999; 'n' = 996; 'r' = 997; 's' = 996; 'x' = 996; NA = 999")
...
vbl.tagged <- HRS_mbb$r11lgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
...
vbl.tagged <- HRS_mbb$r11rgrip.tagged
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = attributes(vbl)$`spss::shortName`)
kable(Continuous_summary(na_tag(vbl.tagged), missing_values = vbl_miss)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
ggplot(HRS_mbb, aes(r11rgrip)) + geom_histogram(stat="count", fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")

kable(addmargins(table(na_tag((HRS_mbb %>% filter(is.na(r11lgrip) & is.na(r11rgrip)))$r11lgrip.tagged), na_tag((HRS_mbb %>% filter(is.na(r11lgrip) & is.na(r11rgrip)))$r11rgrip.tagged), useNA = "ifany")), caption = "Both hands missing values")
...
HRS_ds_mbb_w11$grip[which(is.na(HRS_ds_mbb_w11$grip))] <- car::recode(na_tag(HRS_mbb$r11rgrip.tagged[which(is.na(HRS_ds_mbb_w11$grip))]), "'d' = 998; 'm' = 999; 'n' = 996; 'i' = 999; 'r' = 997; 's' = 996; 'x' = 996; NA = 999")
