...
|-|-|-|
| **Label** |`Year of death`|`year of individual interview`|
| **Table name** |`elsa_w6_hd`|`wave_6_ifs_derived_variables`|
| **Units** |`years`|`years`|
| **Missings** |`NA`|  |
| **Description** |  |  |
...
ELSA_ds_w6$living_status[!is.na(ELSA_w6_LS$ydeath)] <- 1
ELSA_ds_w6$living_status[is.na(ELSA_w6_LS$ydeath) & is.na(ELSA_w6_LS$iintdaty)] <- 2
