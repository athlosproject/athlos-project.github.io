...
opal.assign.table.tibble(o, 'ELSA_w2','ELSA.wave_2_nurse_data_v2', variables=list('hdl'), missings = TRUE)
...
ggplot(filter(ELSA_w2,!vbl %in% vbl_miss), aes(hdl)) + geom_histogram(stat="count", fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")
...
ELSA_ds_w2$hdl_chol <- car::recode(ELSA_w2$hdl, "-11 = 994;-8:-2 = 993; -1 = 999")
ELSA_ds_w2$hdl_chol[which(!ELSA_ds_w2$hdl_chol %in% miss_values_vector)] <- 38.67*ELSA_ds_w2$hdl_chol[which(!ELSA_ds_w2$hdl_chol %in% miss_values_vector)]
...
vbl <- ELSA_ds_w2$hdl_chol
kable(Continuous_summary(var = vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(filter(ELSA_ds_w2,!vbl %in% miss_values_vector), aes(hdl_chol)) + geom_histogram(stat="count", fill="steelblue") + xlab(ds_label) + ylab("Frequency")
...
opal.assign.table.tibble(o, 'ELSA_w4','ELSA.wave_4_nurse_data', variables=list('hdl'), missings = TRUE)
...
kable(Continuous_summary(vbl, missing_values = vbl_miss)[3], caption = "hdl") 
pander(Continuous_summary(vbl, missing_values = vbl_miss)$summary, caption = "Summary")
ggplot(filter(ELSA_w4,!vbl %in% vbl_miss), aes(hdl)) + geom_histogram(stat="count", fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")
...
ELSA_ds_w4$hdl_chol <- car::recode(ELSA_w4$hdl, "-11 = 994;-7:-2 = 993; -1 = 999")
ELSA_ds_w4$hdl_chol[which(!ELSA_ds_w4$hdl_chol %in% miss_values_vector)] <- 38.67*ELSA_ds_w4$hdl_chol[which(!ELSA_ds_w4$hdl_chol %in% miss_values_vector)]
...
vbl <- ELSA_ds_w4$hdl_chol
kable(Continuous_summary(var = vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(filter(ELSA_ds_w4,!vbl %in% miss_values_vector), aes(hdl_chol)) + geom_histogram(stat="count", fill="steelblue") + xlab(ds_label) + ylab("Frequency")
...
opal.assign.table.tibble(o, 'ELSA_w6','ELSA.wave_6_elsa_nurse_data_v2', variables=list('hdl'), missings = TRUE)
...
kable(Continuous_summary(vbl, missing_values = vbl_miss)[3], caption = "hdl") 
pander(Continuous_summary(vbl, missing_values = vbl_miss)$summary, caption = "Summary")
ggplot(filter(ELSA_w6,!vbl %in% vbl_miss), aes(hdl)) + geom_histogram(stat="count", fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")
...
ELSA_ds_w6$hdl_chol <- car::recode(ELSA_w6$hdl, "-11 = 994; -7:-2 = 993; -1 = 999")
ELSA_ds_w6$hdl_chol[which(!ELSA_ds_w6$hdl_chol %in% miss_values_vector)] <- 38.67*ELSA_ds_w6$hdl_chol[which(!ELSA_ds_w6$hdl_chol %in% miss_values_vector)]
...
vbl <- ELSA_ds_w6$hdl_chol
kable(Continuous_summary(var = vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(filter(ELSA_ds_w6,!vbl %in% miss_values_vector), aes(hdl_chol)) + geom_histogram(stat="count", fill="steelblue") + xlab(ds_label) + ylab("Frequency")
