...
ELSA_ds_w1$smoking <- car::recode(ELSA_w1$smokerstat, "2 = 1;3 = 1;4 = 2;-2 = 998;-8 = 998;-9 = 997 ")
```
...
BeforeH <- c(X[4],sum(X[5:7]),X[c(8,1)],sum(X[2:3]))
C <- rbind(BeforeH,AfterH)
colnames(C) <- c("0->0","1,2,3->1","4->2","-9->997","-8,-2->998") 
kable(C)
```
...
ELSA_ds_w2$smoking <- car::recode(ELSA_w2$smokerstat, "2 = 1;3 = 1;4 = 2;-2 = 998;-8 = 998;-9 = 997 ")
```
...
ELSA_ds_w3$smoking <- car::recode(ELSA_w3$smokerstat, "2 = 1;3 = 1;4 = 2;-2 = 998;-8 = 998;-9 = 997 ")
```
...
ELSA_ds_w4$smoking <- car::recode(ELSA_w4$smokerstat, "2 = 1;3 = 1;4 = 2;-2 = 998;-8 = 998;-9 = 997 ")
```
...
ELSA_ds_w5$smoking <- car::recode(ELSA_w5$smokerstat, "2 = 1;3 = 1;4 = 2;-2 = 998;-8 = 998;-9 = 997 ")
```
