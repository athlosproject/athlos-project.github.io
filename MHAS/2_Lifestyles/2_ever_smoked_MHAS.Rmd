...
dbb <- get(paste0("MHAS_m_ds_",names(l.hds)[1]))[,c("id","ever_smoked")]
for(ind in 2:length(l.hds)){
  dbb <- merge(dbb, get(paste0("MHAS_m_ds_",names(l.hds)[ind]))[,c("id","ever_smoked")], by = "id", suffixes = c("", paste0(".",names(l.hds)[ind])), all = T)
}
