...
```{r summ}
KLOSA_ds_w1$retired <- labelled(KLOSA_ds_w1$retired, labels = cat_label)
label(KLOSA_ds_w1$retired) <- ds_label
KLOSA_ds_w2$retired <- labelled(KLOSA_ds_w2$retired, labels = cat_label)
label(KLOSA_ds_w2$retired) <- ds_label
KLOSA_ds_w3$retired <- labelled(KLOSA_ds_w3$retired, labels = cat_label)
label(KLOSA_ds_w3$retired) <- ds_label
KLOSA_ds_w4$retired <- labelled(KLOSA_ds_w4$retired, labels = cat_label)
label(KLOSA_ds_w4$retired) <- ds_label
KLOSA_ds_w1$age_retired <- labelled(KLOSA_ds_w1$age_retired, labels = cont_label)
label(KLOSA_ds_w1$age_retired) <- ds_label_age
KLOSA_ds_w2$age_retired <- labelled(KLOSA_ds_w2$age_retired, labels = cont_label)
label(KLOSA_ds_w2$age_retired) <- ds_label_age
KLOSA_ds_w3$age_retired <- labelled(KLOSA_ds_w3$age_retired, labels = cont_label)
label(KLOSA_ds_w3$age_retired) <- ds_label_age
KLOSA_ds_w4$age_retired <- labelled(KLOSA_ds_w4$age_retired, labels = cont_label)
label(KLOSA_ds_w4$age_retired) <- ds_label_age

KLOSA_m_ds_w1 <- KLOSA_ds_w1
KLOSA_m_ds_w1$retired <- car::recode(KLOSA_m_ds_w1$retired, "miss_values_vector=NA")
KLOSA_m_ds_w2 <- KLOSA_ds_w2
KLOSA_m_ds_w2$retired <- car::recode(KLOSA_m_ds_w2$retired, "miss_values_vector=NA")
KLOSA_m_ds_w3 <- KLOSA_ds_w3
KLOSA_m_ds_w3$retired <- car::recode(KLOSA_m_ds_w3$retired, "miss_values_vector=NA")
KLOSA_m_ds_w4 <- KLOSA_ds_w4
KLOSA_m_ds_w4$retired <- car::recode(KLOSA_m_ds_w4$retired, "miss_values_vector=NA")


tt <-    frq(KLOSA_ds_w1$retired)[[1]][,c(1:2,4)]
tt[4] <- frq(KLOSA_ds_w2$retired)[[1]][,c(4)]
tt[5] <- frq(KLOSA_ds_w3$retired)[[1]][,c(4)]
tt[6] <- frq(KLOSA_ds_w4$retired)[[1]][,c(4)]
tt[13,] <- c("n", "sample size", 
             length(KLOSA_ds_w1$retired), length(KLOSA_ds_w2$retired), length(KLOSA_ds_w3$retired), length(KLOSA_ds_w4$retired)
             )
names(tt)<-c("val", "label", "w1", "w2", "w3", "w4")
kable(tt)

dbb <- merge(KLOSA_m_ds_w1[,c("id","retired")], KLOSA_m_ds_w2[,c("id","retired")], by="id", suffixes = c(".w1",".w2"), all=T)
dbb <- merge(dbb, KLOSA_m_ds_w3[,c("id","retired")], by="id", all=T)
dbb <- merge(dbb, KLOSA_m_ds_w4[,c("id","retired")], by="id", suffixes = c(".w3",".w4"), all=T)
...
for(index in seq_along(l.KLOSA)){
  retired <- l.KLOSA[[index]]
  save(retired, file = paste0(datafolder,names(l.KLOSA)[index],"/retired.RData"))
}
