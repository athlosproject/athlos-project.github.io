...
```{r summ}
KLOSA_ds_w1$h_joint_disorders <- labelled(KLOSA_ds_w1$h_joint_disorders, labels = cat_label)
label(KLOSA_ds_w1$h_joint_disorders) <- ds_label
KLOSA_ds_w1$h_joint_disorders_age <- labelled(KLOSA_ds_w1$h_joint_disorders_age, labels = cont_label)
label(KLOSA_ds_w1$h_joint_disorders_age) <- ds_label_age
KLOSA_ds_w2$h_joint_disorders <- labelled(KLOSA_ds_w2$h_joint_disorders, labels = cat_label)
label(KLOSA_ds_w2$h_joint_disorders) <- ds_label
KLOSA_ds_w2$h_joint_disorders_age <- labelled(KLOSA_ds_w2$h_joint_disorders_age, labels = cont_label)
label(KLOSA_ds_w2$h_joint_disorders_age) <- ds_label_age
KLOSA_ds_w3$h_joint_disorders <- labelled(KLOSA_ds_w3$h_joint_disorders, labels = cat_label)
label(KLOSA_ds_w3$h_joint_disorders) <- ds_label
KLOSA_ds_w3$h_joint_disorders_age <- labelled(KLOSA_ds_w3$h_joint_disorders_age, labels = cont_label)
label(KLOSA_ds_w3$h_joint_disorders_age) <- ds_label_age
KLOSA_ds_w4$h_joint_disorders <- labelled(KLOSA_ds_w4$h_joint_disorders, labels = cat_label)
label(KLOSA_ds_w4$h_joint_disorders) <- ds_label
KLOSA_ds_w4$h_joint_disorders_age <- labelled(KLOSA_ds_w4$h_joint_disorders_age, labels = cont_label)
label(KLOSA_ds_w4$h_joint_disorders_age) <- ds_label_age

KLOSA_m_ds_w1 <- KLOSA_ds_w1
KLOSA_m_ds_w1$h_joint_disorders <- car::recode(KLOSA_m_ds_w1$h_joint_disorders, "miss_values_vector=NA")
KLOSA_m_ds_w2 <- KLOSA_ds_w2
KLOSA_m_ds_w2$h_joint_disorders <- car::recode(KLOSA_m_ds_w2$h_joint_disorders, "miss_values_vector=NA")
KLOSA_m_ds_w3 <- KLOSA_ds_w3
KLOSA_m_ds_w3$h_joint_disorders <- car::recode(KLOSA_m_ds_w3$h_joint_disorders, "miss_values_vector=NA")
KLOSA_m_ds_w4 <- KLOSA_ds_w4
KLOSA_m_ds_w4$h_joint_disorders <- car::recode(KLOSA_m_ds_w4$h_joint_disorders, "miss_values_vector=NA")


tt <-    frq(KLOSA_ds_w1$h_joint_disorders)[[1]][,c(1:2,4)]
tt[4] <- frq(KLOSA_ds_w2$h_joint_disorders)[[1]][,c(4)]
tt[5] <- frq(KLOSA_ds_w3$h_joint_disorders)[[1]][,c(4)]
tt[6] <- frq(KLOSA_ds_w4$h_joint_disorders)[[1]][,c(4)]
tt[13,] <- c("n", "sample size", 
             length(KLOSA_ds_w1$h_joint_disorders), length(KLOSA_ds_w2$h_joint_disorders), length(KLOSA_ds_w3$h_joint_disorders), length(KLOSA_ds_w4$h_joint_disorders)
             )
names(tt)<-c("val", "label", "w1", "w2", "w3", "w4")
kable(tt)

dbb <- merge(KLOSA_m_ds_w1[,c("id","h_joint_disorders")], KLOSA_m_ds_w2[,c("id","h_joint_disorders")], by="id", suffixes = c(".w1",".w2"), all=T)
dbb <- merge(dbb, KLOSA_m_ds_w3[,c("id","h_joint_disorders")], by="id", all=T)
dbb <- merge(dbb, KLOSA_m_ds_w4[,c("id","h_joint_disorders")], by="id", suffixes = c(".w3",".w4"), all=T)
...
for(index in seq_along(l.KLOSA)){
  h_joint_disorders <- l.KLOSA[[index]]
  save(h_joint_disorders, file = paste0(datafolder,names(l.KLOSA)[index],"/h_joint_disorders.RData"))
}
