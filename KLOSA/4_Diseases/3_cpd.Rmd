...
KLOSA_ds <- rows_update(KLOSA_ds, KLOSA_ds_w2 |> filter(h_cpd != 999) |> select(id, h_cpd_age), by = "id")
...
KLOSA_ds <- rows_update(KLOSA_ds, KLOSA_ds_w3 |> filter(h_cpd != 999) |> select(id, h_cpd_age), by = "id")
