...
vbl_miss <- c(-8)
kable(Continuous_summary(vbl, missing_values = vbl_miss)[3], caption = "w01C105") 
pander(Continuous_summary(vbl, missing_values = vbl_miss)$summary, caption = "Summary")
ggplot(KLOSA_w1, aes(w01C105)) + geom_histogram(stat="count", fill="steelblue", data = .%>% filter(!vbl %in% vbl_miss)) + xlab(label(vbl)) + ylab("Frequency")
...
ggplot(KLOSA_ds_w1, aes(n_cigarettes)) + geom_histogram(stat="count", fill="steelblue", data = .%>% filter(!vbl %in% vbl_miss)) + xlab(ds_label) + ylab("Frequency")
...
vbl_miss <- c(-8)
kable(Continuous_summary(vbl, missing_values = vbl_miss)[3], caption = "w02C119") 
pander(Continuous_summary(vbl, missing_values = vbl_miss)$summary, caption = "Summary")
ggplot(KLOSA_w2, aes(w02C119)) + geom_histogram(stat="count", fill="steelblue", data = .%>% filter(!vbl %in% vbl_miss)) + xlab(label(vbl)) + ylab("Frequency")
```
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(KLOSA_ds_w2, aes(n_cigarettes)) + geom_histogram(stat="count", fill="steelblue", data = .%>% filter(!vbl %in% vbl_miss)) + xlab(ds_label) + ylab("Frequency") 
```
...
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = "w03C119") 
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
ggplot(KLOSA_w3, aes(w03C119)) + geom_histogram(stat="count", fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(KLOSA_ds_w3, aes(n_cigarettes)) + geom_histogram(stat="count", fill="steelblue", data = .%>% filter(!vbl %in% vbl_miss)) + xlab(ds_label) + ylab("Frequency")
...
kable(Continuous_summary(vbl, missing_values = NA)[3], caption = "w04C119") 
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
ggplot(KLOSA_w4, aes(w04C119)) + geom_histogram(stat="count", fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")
```
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(KLOSA_ds_w4, aes(n_cigarettes)) + geom_histogram(stat="count", fill="steelblue", data = .%>% filter(!vbl %in% vbl_miss)) + xlab(ds_label) + ylab("Frequency")
