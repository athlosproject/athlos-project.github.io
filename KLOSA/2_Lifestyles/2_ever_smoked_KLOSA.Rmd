...
KLOSA_ds_w1$ever_smoked <- car::recode(KLOSA_w1$w01smoke, "2 = 1;NA = 999 ")
```

#### Statistical description of the new harmonised variable
```{r descript w1, echo=F}
vbl <- KLOSA_ds_w1$ever_smoked
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(KLOSA_ds_w1, aes(x=factor(ever_smoked))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
```

#### Validation
```{r crosstabulation w1, echo=F}
AfterH <- table(KLOSA_ds_w1$ever_smoked)
X<-table(KLOSA_w1$w01smoke)
BeforeH <- c(X[1],sum(X[2:3]),sum(is.na(KLOSA_w1$w01smoke)))
...
KLOSA_ds_w2$ever_smoked <- car::recode(KLOSA_w2$w02smoke, "2 = 1;NA = 999 ")
```

#### Statistical description of the new harmonised variable
```{r descript w2, echo=F}
vbl <- KLOSA_ds_w2$ever_smoked
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(KLOSA_ds_w2, aes(x=factor(ever_smoked))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
```

#### Validation
```{r crosstabulation w2, echo=F}
AfterH <- table(KLOSA_ds_w2$ever_smoked)
X<-table(KLOSA_w2$w02smoke)
BeforeH <- c(X[1],sum(X[2:3]),sum(is.na(KLOSA_w2$w02smoke)))
C <- rbind(BeforeH,AfterH)
colnames(C) <- c("0->0","1,2->1","NA->999") 
kable(C)
```
...
KLOSA_ds_w3$ever_smoked <- car::recode(KLOSA_w3$w03smoke, "2 = 1 ")
```

#### Statistical description of the new harmonised variable
```{r descript w3, echo=F}
vbl <- KLOSA_ds_w3$ever_smoked
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(KLOSA_ds_w3, aes(x=factor(ever_smoked))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
```

#### Validation
```{r crosstabulation w3, echo=F}
AfterH <- table(KLOSA_ds_w3$ever_smoked)
X<-table(KLOSA_w3$w03smoke)
...
KLOSA_ds_w4$ever_smoked <- car::recode(KLOSA_w4$w04smoke, "2 = 1;NA = 999 ")
```

#### Statistical description of the new harmonised variable
```{r descript w4, echo=F}
vbl <- KLOSA_ds_w4$ever_smoked
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(KLOSA_ds_w4, aes(x=factor(ever_smoked))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
```

#### Validation
```{r crosstabulation w4, echo=F}
AfterH <- table(KLOSA_ds_w4$ever_smoked)
X<-table(KLOSA_w4$w04smoke)
BeforeH <- c(X[1],sum(X[2:3]),sum(is.na(KLOSA_w4$w04smoke)))
C <- rbind(BeforeH,AfterH)
colnames(C) <- c("0->0","1,2->1","NA->999") 
kable(C)
```
...
dbb <- get(paste0("KLOSA_m_ds_",names(l.hds)[1]))[,c("id","ever_smoked")]
for(ind in 2:length(l.hds)){
  dbb <- merge(dbb, get(paste0("KLOSA_m_ds_",names(l.hds)[ind]))[,c("id","ever_smoked")], by = "id", suffixes = c("", paste0(".",names(l.hds)[ind])), all = T)
}
