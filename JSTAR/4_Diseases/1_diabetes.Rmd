...
ggplot(JSTAR_aksst_w1, aes(h_001_5_1)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")+xlim(15,80)
...
JSTAR_ds_aksst_w1$h_diabetes_age[JSTAR_ds_aksst_w1$h_diabetes==1] <- JSTAR_aksst_w1$h_001_5_1[JSTAR_ds_aksst_w1$h_diabetes==1]
JSTAR_ds_aksst_w1$h_diabetes_age[JSTAR_ds_aksst_w1$h_diabetes==0] <- 996
...
ggplot(JSTAR_ds_aksst_w1, aes(h_diabetes_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")+xlim(15,85)
...
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
ggplot(JSTAR_aksst_w2, aes(h_001_5_1_b)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")+xlim(1975,2010)
...
JSTAR_ds_aksst_w2$h_diabetes[((!is.na(JSTAR_aksst_w2$h_001_5)) & JSTAR_aksst_w2$h_001_5 == 4) & (JSTAR_aksst_w2$h_diabetes != 1)] <- 0
JSTAR_ds_aksst_w2$h_diabetes[((!is.na(JSTAR_aksst_w2$h_001_5)) & JSTAR_aksst_w2$h_001_5 %in% c(1,2,3)) | ((!is.na(JSTAR_aksst_w2$h_diabetes)) & (!is.na(JSTAR_aksst_w2$h_001_5)) & JSTAR_aksst_w2$h_diabetes == 1)] <- 1
...
# Continuous variable harmonization
diabetes_age <- JSTAR_aksst_w2$h_001_5_1_b[JSTAR_ds_aksst_w2$h_diabetes == 1 & (JSTAR_aksst_w2$h_diabetes==0 | is.na(JSTAR_aksst_w2$h_diabetes)) & JSTAR_aksst_w2$ybirth != 999]-JSTAR_aksst_w2$ybirth[JSTAR_ds_aksst_w2$h_diabetes == 1 & (JSTAR_aksst_w2$h_diabetes==0 | is.na(JSTAR_aksst_w2$h_diabetes)) & JSTAR_aksst_w2$ybirth != 999]

JSTAR_ds_aksst_w2$h_diabetes_age <- rep(999,length(JSTAR_aksst_w2$id))
JSTAR_ds_aksst_w2$h_diabetes_age[JSTAR_ds_aksst_w2$h_diabetes == 0] <- 996
JSTAR_ds_aksst_w2$h_diabetes_age[JSTAR_ds_aksst_w2$h_diabetes == 1 & (JSTAR_aksst_w2$h_diabetes==0 | is.na(JSTAR_aksst_w2$h_diabetes)) & JSTAR_aksst_w2$ybirth != 999] <- diabetes_age
JSTAR_ds_aksst_w2$h_diabetes_age[JSTAR_ds_aksst_w2$h_diabetes == 1 & JSTAR_aksst_w2$h_diabetes==1 & !is.na(JSTAR_aksst_w2$h_diabetes)] <- car::recode(JSTAR_aksst_w2$h_diabetes_age[JSTAR_ds_aksst_w2$h_diabetes == 1 & JSTAR_aksst_w2$h_diabetes==1 & !is.na(JSTAR_aksst_w2$h_diabetes)],"miss_values_vector=999")
JSTAR_ds_aksst_w2$h_diabetes_age <- car::recode(JSTAR_ds_aksst_w2$h_diabetes_age, "NA=999")
JSTAR_ds_aksst$h_diabetes_age[(JSTAR_ds_aksst$id %in% JSTAR_ds_aksst_w2$id) & (JSTAR_ds_aksst$h_diabetes != 999)] <- JSTAR_ds_aksst_w2$h_diabetes_age[JSTAR_ds_aksst_w2$h_diabetes != 999]
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(JSTAR_ds_aksst_w2, aes(h_diabetes_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")+xlim(15,80)
...
kable(JSTAR_aksst_w2[which(!is.na(JSTAR_aksst_w2$h_001_5_1_b) & !is.na(JSTAR_aksst_w2$h_diabetes_age) & !JSTAR_aksst_w2$h_diabetes_age %in% miss_values_vector),],align = 'c',caption = 'There are seven individuals which answer age of diagnostic in wave 1 and year of diagnostic in wave 2. The data of five of them is incompatible. We harmonize them from the first data answered (wave 1).')
...
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(JSTAR_aksst_w3, aes(ybirth)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")+xlim(1905,1965)
...
JSTAR_ds_aksst_w3$h_diabetes[((!is.na(JSTAR_aksst_w3$h_001_5)) & JSTAR_aksst_w3$h_001_5 == 4) & (JSTAR_aksst_w3$h_diabetes != 1)] <- 0
JSTAR_ds_aksst_w3$h_diabetes[((!is.na(JSTAR_aksst_w3$h_001_5)) & JSTAR_aksst_w3$h_001_5 %in% c(1,2,3)) | ((!is.na(JSTAR_aksst_w3$h_diabetes)) & (!is.na(JSTAR_aksst_w3$h_001_5)) & JSTAR_aksst_w3$h_diabetes == 1)] <- 1
...
JSTAR_ds_aksst_w3$h_diabetes_age[JSTAR_ds_aksst_w3$h_diabetes == 0] <- 996
JSTAR_ds_aksst_w3$h_diabetes_age[JSTAR_ds_aksst_w3$h_diabetes == 1 & JSTAR_aksst_w3$h_diabetes!=0 & !is.na(JSTAR_aksst_w3$h_diabetes)] <- car::recode(JSTAR_aksst_w3$h_diabetes_age[JSTAR_ds_aksst_w3$h_diabetes == 1 & JSTAR_aksst_w3$h_diabetes!=0 & !is.na(JSTAR_aksst_w3$h_diabetes)],"miss_values_vector=999")
JSTAR_ds_aksst_w3$h_diabetes_age[which(JSTAR_ds_aksst_w3$h_diabetes == 1 & JSTAR_aksst_w3$h_diabetes==0 & JSTAR_aksst_w3$ybirth != 999)] <- (JSTAR_aksst_w3$yintw_aksst_w3[which(JSTAR_ds_aksst_w3$h_diabetes == 1 & JSTAR_aksst_w3$h_diabetes==0 & JSTAR_aksst_w3$ybirth != 999)] + JSTAR_aksst_w3$yintw_aksst_w2[which(JSTAR_ds_aksst_w3$h_diabetes == 1 & JSTAR_aksst_w3$h_diabetes==0 & JSTAR_aksst_w3$ybirth != 999)])/2 - JSTAR_aksst_w3$ybirth[which(JSTAR_ds_aksst_w3$h_diabetes == 1 & JSTAR_aksst_w3$h_diabetes==0 & JSTAR_aksst_w3$ybirth != 999)]
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(JSTAR_ds_aksst_w3, aes(h_diabetes_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")+xlim(15,80)
...
cat("There are 80 individuals who answered in previous waves they had diabetes and in wave 3 that they did not. We harmonize them as having diabetes.")
...
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
ggplot(JSTAR_tn_w1, aes(h_001_5_1)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")+xlim(20,75)
...
JSTAR_ds_tn_w1$h_diabetes_age[JSTAR_ds_tn_w1$h_diabetes==1] <- JSTAR_tn_w1$h_001_5_1[JSTAR_ds_tn_w1$h_diabetes==1]
JSTAR_ds_tn_w1$h_diabetes_age[JSTAR_ds_tn_w1$h_diabetes==0] <- 996
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(JSTAR_ds_tn_w1, aes(h_diabetes_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")+xlim(20,75)
...
JSTAR_ds_tn_w2$h_diabetes[((!is.na(JSTAR_tn_w2$h_001_5)) & JSTAR_tn_w2$h_001_5 == 4) & (JSTAR_tn_w2$h_diabetes != 1)] <- 0
JSTAR_ds_tn_w2$h_diabetes[((!is.na(JSTAR_tn_w2$h_001_5)) & JSTAR_tn_w2$h_001_5 %in% c(1,2,3)) | ((!is.na(JSTAR_tn_w2$h_diabetes)) & (!is.na(JSTAR_tn_w2$h_001_5)) & JSTAR_tn_w2$h_diabetes == 1)] <- 1

# Continuous variable harmonization
JSTAR_ds_tn_w2$h_diabetes_age <- rep(999,length(JSTAR_tn_w2$id))
JSTAR_ds_tn_w2$h_diabetes_age[JSTAR_ds_tn_w2$h_diabetes == 0] <- 996
JSTAR_ds_tn_w2$h_diabetes_age[JSTAR_ds_tn_w2$h_diabetes == 1 & JSTAR_tn_w2$h_diabetes!=0 & !is.na(JSTAR_tn_w2$h_diabetes)] <- car::recode(JSTAR_tn_w2$h_diabetes_age[JSTAR_ds_tn_w2$h_diabetes == 1 & JSTAR_tn_w2$h_diabetes!=0 & !is.na(JSTAR_tn_w2$h_diabetes)],"miss_values_vector=999")
JSTAR_ds_tn_w2$h_diabetes_age[which(JSTAR_ds_tn_w2$h_diabetes == 1 & JSTAR_tn_w2$h_diabetes==0 & JSTAR_tn_w2$ybirth != 999)] <- (JSTAR_tn_w2$yintw_tn_w2[which(JSTAR_ds_tn_w2$h_diabetes == 1 & JSTAR_tn_w2$h_diabetes==0 & JSTAR_tn_w2$ybirth != 999)] + JSTAR_tn_w2$yintw_tn_w1[which(JSTAR_ds_tn_w2$h_diabetes == 1 & JSTAR_tn_w2$h_diabetes==0 & JSTAR_tn_w2$ybirth != 999)])/2 - JSTAR_tn_w2$ybirth[which(JSTAR_ds_tn_w2$h_diabetes == 1 & JSTAR_tn_w2$h_diabetes==0 & JSTAR_tn_w2$ybirth != 999)]
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(JSTAR_ds_tn_w2, aes(h_diabetes_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")+xlim(20,80)
...
pander(Continuous_summary(vbl, missing_values = NA)$summary, caption = "Summary")
ggplot(JSTAR_cth_w1, aes(h_001_5_1)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(label(vbl)) + ylab("Frequency")+xlim(25,75)
...
JSTAR_ds_cth_w1$h_diabetes_age[JSTAR_ds_cth_w1$h_diabetes==1] <- JSTAR_cth_w1$h_001_5_1[JSTAR_ds_cth_w1$h_diabetes==1]
JSTAR_ds_cth_w1$h_diabetes_age[JSTAR_ds_cth_w1$h_diabetes==0] <- 996
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(JSTAR_ds_cth_w1, aes(h_diabetes_age)) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label_age) + ylab("Frequency")+xlim(25,75)
