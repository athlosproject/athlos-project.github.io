...
#Categorical_summary(var = TILDA_w1_cont_fr$SCQsocact13, missing_values = NA)
...
TILDA_ds_w1$cont_fr <- car::recode(as.vector(TILDA_w1_cont_fr$SCQsocact13), "1:4='1'; 5:8='0'; -99='997'; -98='998'; -878:-812='999'; NA='999'")
...
#Categorical_summary(var = TILDA_ds_w1$cont_fr, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))
...
AfterH <- table(TILDA_ds_w1$cont_fr)
BeforeH <- table(TILDA_w1_cont_fr$SCQsocact13, useNA='ifany')
BeforeH1 <- c(NA)
BeforeH1[[1]] <- sum(BeforeH[c(7:10)])
BeforeH1[[2]] <- sum(BeforeH[c(3:6)])
BeforeH1[[3]] <- sum(BeforeH[c(1,2,11)])
C <- rbind(BeforeH1,AfterH)
colnames(C) <- c("0","1","NA,-823,-812->999")
...
#Categorical_summary(var = TILDA_w2_cont_fr$SCQSocAct13, missing_values = NA)
...
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[1], caption = "Category")
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[2], caption = "Type of missing")
#Categorical_summary(var = TILDA_ds_w2$cont_fr, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))
