...
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(COURAGE_ds_pol_w2, aes(h_angina_age)) + geom_bar(stat="count", width=0.4, fill="steelblue", data = . %>% filter(!vbl %in% miss_values_vector)) + xlab(ds_label_age) + ylab("Frequency")
...
COURAGE_ds_spain_w2$h_angina_age[which(COURAGE_ds_spain_w2$h_angina == 1 & COURAGE_spain_w2$h_angina==0 & !COURAGE_spain_w2$age %in% miss_values_vector)] <- floor(COURAGE_spain_w2$age[which(COURAGE_ds_spain_w2$h_angina == 1 & COURAGE_spain_w2$h_angina==0 & !COURAGE_spain_w2$age %in% miss_values_vector)]-(COURAGE_spain_w2$yintw_spain_w2[which(COURAGE_ds_spain_w2$h_angina == 1 & COURAGE_spain_w2$h_angina==0 & !COURAGE_spain_w2$age %in% miss_values_vector)]-COURAGE_spain_w2$yintw_spain_w1[which(COURAGE_ds_spain_w2$h_angina == 1 & COURAGE_spain_w2$h_angina==0 & !COURAGE_spain_w2$age %in% miss_values_vector)])/2)
