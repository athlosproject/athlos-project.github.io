...
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(COURAGE_ds_pol_w2, aes(stroke_age)) + geom_bar(stat="count", width=0.4, fill="steelblue", data = . %>% filter(!vbl %in% miss_values_vector)) + xlab(ds_label_age) + ylab("Frequency")
...
COURAGE_ds_spain_w2$stroke_age[which(COURAGE_ds_spain_w2$stroke == 1 & COURAGE_spain_w2$stroke==0 & COURAGE_spain_w2$age != 999)] <- floor(COURAGE_spain_w2$age[which(COURAGE_ds_spain_w2$stroke == 1 & COURAGE_spain_w2$stroke==0 & COURAGE_spain_w2$age != 999)]-(COURAGE_spain_w2$yintw_spain_w2[which(COURAGE_ds_spain_w2$stroke == 1 & COURAGE_spain_w2$stroke==0 & COURAGE_spain_w2$age != 999)]-COURAGE_spain_w2$yintw_spain_w1[which(COURAGE_ds_spain_w2$stroke == 1 & COURAGE_spain_w2$stroke==0 & COURAGE_spain_w2$age != 999)])/2)
...
kable(Continuous_summary(vbl, missing_values = miss_values_vector)[2], caption = "Values")
pander(Continuous_summary(vbl, missing_values = miss_values_vector)$summary, caption = "Summary")
ggplot(COURAGE_ds_spain_w2, aes(stroke_age)) + geom_bar(stat="count", width=0.4, fill="steelblue", data = . %>% filter(!vbl %in% miss_values_vector)) + xlab(ds_label_age) + ylab("Frequency")
