...
ggplot(COURAGE_Spain_w1_cog_del, aes(x=factor(q2544_recall))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab("Delayed recall") + ylab("Frequency")
```
...
ggplot(COURAGE_ds_spain_w1, aes(x=factor(vari))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab("cog_del") + ylab("Frequency")
...
ggplot(COURAGE_ds_spain_w1, aes(x=factor(cog_del))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab("Delayed recall") + ylab("Frequency")
```
...
label(COURAGE_ds_spain_w1$cog_del_c) <- ds_label_cog_del_c
label(COURAGE_ds_spain_w1$cog_del) <- ds_label_cog_del
...
cog_del <- COURAGE_ds_spain_w1
save(cog_del, file = "../RData/spain_w1/cog_del.RData")
rm(cog_del)

COURAGE_m_ds_spain_w1 <- COURAGE_ds_spain_w1
COURAGE_m_ds_spain_w1$cog_del <- car::recode(COURAGE_m_ds_spain_w1$cog_del, "c(991, 992, 993, 994, 995, 996, 997,998, 999)=NA")
COURAGE_m_ds_spain_w1$cog_del_c <- car::recode(COURAGE_m_ds_spain_w1$cog_del_c, "c(991, 992, 993, 994, 995, 996, 997,998, 999)=NA")
...
kable(Continuous_summary(var = vari, missing_values = c(-97))[3], caption = "Delayed recall continuous")
...
ggplot(COURAGE_Spain_w2_cog_del, aes(x=factor(q2544_recall_s1))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab("Delayed recall") + ylab("Frequency")
```
...
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[1], caption = "Category")
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[2], caption = "Type of missing")
ggplot(COURAGE_ds_spain_w2, aes(x=factor(cog_del))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab("Delayed recall") + ylab("Frequency")
```
...
label(COURAGE_ds_spain_w2$cog_del_c) <- ds_label_cog_del_c
label(COURAGE_ds_spain_w2$cog_del) <- ds_label_cog_del
...
cog_del <- COURAGE_ds_spain_w2
save(cog_del, file = "../RData/spain_w2/cog_del.RData")
rm(cog_del)

COURAGE_m_ds_spain_w2 <- COURAGE_ds_spain_w2
COURAGE_m_ds_spain_w2$cog_del <- car::recode(COURAGE_m_ds_spain_w2$cog_del, "c(991, 992, 993, 994, 995, 996, 997,998, 999)=NA")
COURAGE_m_ds_spain_w2$cog_del_c <- car::recode(COURAGE_m_ds_spain_w2$cog_del_c, "c(991, 992, 993, 994, 995, 996, 997,998, 999)=NA")
...
ggplot(COURAGE_Poland_w1_cog_del, aes(x=factor(q2544_recall))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab("Delayed recall") + ylab("Frequency")
```
...
kable(Continuous_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[2], caption = "Values")
pander(Continuous_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))$summary, caption = "Summary")
ggplot(COURAGE_ds_pol_w1, aes(x=factor(vari))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab("cog_del") + ylab("Frequency")

vari <- COURAGE_ds_pol_w1$cog_del
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[3], caption = "Delayed recall categorical") 
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[1], caption = "Category")
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[2], caption = "Type of missing")
ggplot(COURAGE_ds_pol_w1, aes(x=factor(cog_del))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab("Delayed recall") + ylab("Frequency")
```
...
label(COURAGE_ds_pol_w1$cog_del_c) <- ds_label_cog_del_c
label(COURAGE_ds_pol_w1$cog_del) <- ds_label_cog_del
...
cog_del <- COURAGE_ds_pol_w1
save(cog_del, file = "../RData/pol_w1/cog_del.RData")
rm(cog_del)

COURAGE_m_ds_pol_w1 <- COURAGE_ds_pol_w1
COURAGE_m_ds_pol_w1$cog_del <- car::recode(COURAGE_m_ds_pol_w1$cog_del, "c(991, 992, 993, 994, 995, 996, 997,998, 999)=NA")
COURAGE_m_ds_pol_w1$cog_del_c <- car::recode(COURAGE_m_ds_pol_w1$cog_del_c, "c(991, 992, 993, 994, 995, 996, 997,998, 999)=NA")
...
kable(Continuous_summary(var = vari, missing_values = NA)[3], caption = "Delayed recall continuous")
pander(Continuous_summary(vari, missing_values = NA)$summary, caption = "Summary")
ggplot(COURAGE_Finland_w1_cog_del, aes(x=factor(q2544_recall))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab("Delayed recall") + ylab("Frequency")
```
...
kable(Continuous_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[2], caption = "Values")
pander(Continuous_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))$summary, caption = "Summary")
ggplot(COURAGE_ds_fin_w1, aes(x=factor(vari))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab("cog_del") + ylab("Frequency")

vari <- COURAGE_ds_fin_w1$cog_del
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[3], caption = "Delayed recall categorical") 
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[1], caption = "Category")
kable(Categorical_summary(vari, missing_values = c(991, 992, 993, 994, 995, 996, 997, 998, 999))[2], caption = "Type of missing")
ggplot(COURAGE_ds_fin_w1, aes(x=factor(cog_del))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab("Delayed recall") + ylab("Frequency")
```
...
cog_del <- COURAGE_ds_fin_w1
save(cog_del, file = "../RData/fin_w1/cog_del.RData")
rm(cog_del)

COURAGE_m_ds_fin_w1 <- COURAGE_ds_fin_w1
COURAGE_m_ds_fin_w1$cog_del <- car::recode(COURAGE_m_ds_fin_w1$cog_del, "c(991, 992, 993, 994, 995, 996, 997,998, 999)=NA")
COURAGE_m_ds_fin_w1$cog_del_c <- car::recode(COURAGE_m_ds_fin_w1$cog_del_c, "c(991, 992, 993, 994, 995, 996, 997,998, 999)=NA")
