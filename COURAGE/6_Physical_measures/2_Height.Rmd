...
We have detected there are four individuals with rare height evolution from wave 1 to wave 2 in Spain cohort. We did not anything thereon.
```{r echo=F}

COURAGE_QE1 <-left_join(COURAGE_ds_spain_w1[COURAGE_spain_w1$id %in% COURAGE_ds_spain_w2$id[COURAGE_ds_spain_w2$height<100],],COURAGE_ds_spain_w2[COURAGE_ds_spain_w2$height<100,], by="id",suffix=c(".w1",".w2"))
kable(COURAGE_QE1,align = 'c')
