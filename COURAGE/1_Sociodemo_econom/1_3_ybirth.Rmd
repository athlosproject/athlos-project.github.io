...
Add_indiv <- function(old, new){
  ...
  new_22 <- data.frame(id=new_2[,1], q1010_birth_date=suppressWarnings(as.Date(new_2[,2])), ybirth=suppressWarnings(as.numeric(new_2[,3])))
  new_22
}
...
In wave 1 for the spanish sample, the values larger than 1993 are considered missing since the interview was in 2011 and the participants had to be 18 years old as youngest.
