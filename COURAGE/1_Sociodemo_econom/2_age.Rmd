...
```{r assign_fin, echo=F}
opal.assign.table.tibble(o, 'COURAGE_fin_w1_age','Courage.Courage_Finland_w1', variables=list('q1011_age'), missings = TRUE)
...
COURAGE_ds_pol_w2$age <- comp_age(y_birth=COURAGE_pol_w2_age$ybirth, m_birth=COURAGE_pol_w2_age$mbirth , a_year=COURAGE_pol_w2_age$yintw.w2, a_month=COURAGE_pol_w2_age$mintw.w2, miss=miss_values_vector)
...
COURAGE_spain_w2 <- left_join(COURAGE_spain_w2_id,COURAGE_spain_w2_age,by="id")
...
COURAGE_spain_w2$age <- comp_age(y_birth=COURAGE_spain_w2$ybirth , 
...
COURAGE_ds_spain_w2$age <- COURAGE_spain_w2$age
