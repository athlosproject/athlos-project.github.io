...
* `q1504_reason == 5 into 1`
* `q1504_reason == 1, 2, 3, 4, 6, 7, 8, 9, 10, 11, 12 or 87 or q1503_work_now == 1 into 0`
* `otherwise into 999`
...
COURAGE_ds_fin_w1$sickdis <- car::recode(COURAGE_fin_w1$q1504_reason, "c(5) = 1; c(1,2,3,4,6,7,8,9,10,11,12,87) = 0; c(NA) = 999")
COURAGE_ds_fin_w1$sickdis[which(COURAGE_fin_w1$q1503_work_now==1 & is.na(COURAGE_fin_w1$q1504_reason))] <- 0
...
vbl <- COURAGE_ds_fin_w1$sickdis
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(COURAGE_ds_fin_w1, aes(x=factor(sickdis))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
...
AfterH <- table(COURAGE_ds_fin_w1$sickdis, useNA = "ifany")
X <- table(COURAGE_fin_w1$q1503_work_now,COURAGE_fin_w1$q1504_reason, useNA = "ifany")
BeforeH <- c(sum(X[,c("1","2","3","4","6","7","9","10","11","12","87")],X[1,length(X[1,])]),sum(X[,c("5")]),sum(X[3,length(X[3,])]))
C <- rbind(BeforeH,AfterH)
colnames(C) <- c("1,2,3,4,6,7,8,9,10,11,12->0","5->1","NA->999")
kable(C)
rm(COURAGE_fin_w1)
...
COURAGE_ds_pol_w1$sickdis <- car::recode(COURAGE_pol_w1$q1504_reason, "c(5) = 1; c(1,2,3,4,6,7,8,9,10,11,12,87) = 0; c(NA) = 999")
COURAGE_ds_pol_w1$sickdis[which(COURAGE_pol_w1$q1503_work_now==1 & is.na(COURAGE_pol_w1$q1504_reason))] <- 0
...
vbl <- COURAGE_ds_pol_w1$sickdis
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(COURAGE_ds_pol_w1, aes(x=factor(sickdis))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
...
AfterH <- table(COURAGE_ds_pol_w1$sickdis, useNA = "ifany")
X <- table(COURAGE_pol_w1$q1503_work_now,COURAGE_pol_w1$q1504_reason, useNA = "ifany")
BeforeH <- c(sum(X[,c("1","2","3","4","6","7","8","9","10","11","12","87")],X[1,length(X[1,])]),sum(X[,c("5")]),sum(X[3,length(X[3,])]))
C <- rbind(BeforeH,AfterH)
colnames(C) <- c("1,2,3,4,6,7,8,9,10,11,12->0","5->1","NA->999")
kable(C)
rm(COURAGE_pol_w1)
...
COURAGE_ds_pol_w2$sickdis <- car::recode(COURAGE_pol_w2$q1504_reason_s1, "c(5) = 1; c(1,2,3,4,6,7,8,9,10,11,12,87) = 0; c(NA) = 999")
COURAGE_ds_pol_w2$sickdis[which(COURAGE_pol_w2$q1503_work_now_s1==1 & is.na(COURAGE_pol_w2$q1504_reason_s1))] <- 0
...
vbl <- COURAGE_ds_pol_w2$sickdis
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(COURAGE_ds_pol_w2, aes(x=factor(sickdis))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
...
AfterH <- table(COURAGE_ds_pol_w2$sickdis, useNA = "ifany")
...
COURAGE_ds_spain_w1$sickdis <- car::recode(COURAGE_spain_w1$q1504_reason, "c(5) = 1; c(1,2,3,4,6,7,8,9,10,11,12,87) = 0; c(NA) = 999")
COURAGE_ds_spain_w1$sickdis[which(COURAGE_spain_w1$q1503_work_now==1 & is.na(COURAGE_spain_w1$q1504_reason))] <- 0
...
vbl <- COURAGE_ds_spain_w1$sickdis
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(COURAGE_ds_spain_w1, aes(x=factor(sickdis))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
...
AfterH <- table(COURAGE_ds_spain_w1$sickdis, useNA = "ifany")
...
COURAGE_ds_spain_w2$sickdis <- car::recode(COURAGE_spain_w2$q1504_reason_s1, "c(5) = 1; c(1,2,3,4,6,7,8,9,10,11,12,87) = 0; c(NA) = 999")
COURAGE_ds_spain_w2$sickdis[which(COURAGE_spain_w2$q1503_work_now_s1==1 & is.na(COURAGE_spain_w2$q1504_reason_s1))] <- 0
...
vbl <- COURAGE_ds_spain_w2$sickdis
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[3], caption = ds_label)
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[1], caption = "Category")
kable(Categorical_summary(vbl, missing_values = miss_values_vector)[2], caption = "Type of missing")
ggplot(COURAGE_ds_spain_w2, aes(x=factor(sickdis))) + geom_bar(stat="count", width=0.4, fill="steelblue") + xlab(ds_label) + ylab("Frequency")
...
AfterH <- table(COURAGE_ds_spain_w2$sickdis, useNA = "ifany")
